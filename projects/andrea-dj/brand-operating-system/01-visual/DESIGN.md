...
version: alpha
name: Resonance
description: A daytime, sober dance party in Chicago for people who want to meet a partner — rendered as an editorial broadsheet that has been left in actual sunlight. Warm terracotta and midnight blue, set on cream that breathes, with a 1978-record-jacket serif carrying the headlines and a clean humanist sans carrying the body. Photography is the protagonist; type is the caption. If a photo could have been taken at 11pm, it does not belong here.

colors:
  # Atomic shades — sourced from real Chicago daylight, not stylized warm filters
...
Resonance is a daytime, sober dance party in Chicago for people who want to meet a partner. The visual system is built to honor that mechanic — every choice has to survive the test: *if a photo could have been taken at 11pm, it fails.* Daytime is not a metaphor here. It is the literal physics of every image, every layout, every interaction.

The aesthetic register is **editorial broadsheet left in actual sunlight.** It borrows the structural confidence of a 1978 vinyl record jacket — heavy serif headlines, generous gutters, photo as protagonist — and renders it in the warm color science of Chicago at 2pm. The intended emotional response is *recognition without performance*: the reader feels found by a room that has already seen them, not pitched by a brand that wants them.

The system is photography-led. Type captions photographs; type does not replace them. The single most important rule, taken verbatim from the Brand Bible §8: *every piece of Resonance content should feel like a photograph of a real moment, not a graphic design.* When in doubt: real photo over designed graphic. Real crowd over stock dancers. Real Andrea over AI portrait. The full photography spec lives in `01-visual/photography-rules.md` and is mandatory reading before any image lands.
...
- **Caveat (`hand-script`) —** the rare punctuation. Used **only** for human moments: Andrea's signature, a couple's quote pulled from a story-capture interview, a single line on a thank-you card. Never for navigation, never for body, never for headlines. Hand-script that appears more than once per composition stops feeling human and starts feeling decorative — that is the failure mode to police against.
...
Generous whitespace is the foundation, not an afterthought. Crowded layouts read as event-promoter design. Resonance is a curated room; the design respects the same principle — fewer things, more space.
...
Resonance is **flat by default with tonal layering.** Depth is conveyed through the cream-50 / cream-100 / cream-200 step, not through drop shadows. A card on the page sits on cream-100 background and has a cream-50 fill — the contrast is gentle but legible.
...
- Reserve hand-script for human moments only — Andrea's signature, a couple's quote, a single line on a thank-you card.
...
2. **Natural daylight only.** Window light, sun on a wood floor, an overcast Chicago afternoon. No flash. No club lighting. No neon.
...
Resonance moves slowly. The pace of the brand on screen mirrors the pace of the room — body-warm, considered, never frenetic.
...
- Andrea's anchor §3.1 (Line 1: Daytime), §3.2 (Line 2: Sober) — the mechanic this visual system honors
...
- A1-reconciliation.md §3 conflict #4 — the daytime-as-mechanic ruling that supersedes the legacy "Chicago at golden hour" metaphor
...
- `01-visual/brand-library-entry.md` — entry for `knowledge/design-libraries/brands/resonance/`
