...
4. Save to `projects/re-compliance/04-deliverables/receipts/jen-listing-[NUMBER]-audit.json`
...
1. **Create summary document** (`projects/re-compliance/04-deliverables/summary.md`)
...
- [ ] **Commit to git**
  ```bash
  git add projects/re-compliance/04-deliverables/receipts/jen-listing-*.json
  git add projects/re-compliance/04-deliverables/summary.md
  git add projects/re-compliance/04-deliverables/screenshots/ (if created)
