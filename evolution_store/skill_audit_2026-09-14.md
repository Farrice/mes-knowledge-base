...
**Total skills**: 428
**Tier distribution**: A=54, B=207, C=13, REVIEW=127, UTILITY=27
...
37 skill(s) fail ≥2 checks (0 tier-capped this run):

- `ai-creative-studio`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `andrew-sean-greer-novel-craft`: anti_patterns_sourced, verbatim_exemplars, named_entity_floor
...
- `eli5`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `expert-practice-os`: anti_patterns_sourced, verbatim_exemplars, source_ledger, named_entity_floor
...
- `grace-leung-ai-team-mastery`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `grace-liu`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts, menu_parity
- `heydominik-instagram-growth-os`: anti_patterns_sourced, verbatim_exemplars, recognition_test, named_entity_floor, workflow_contracts
- `higgsfield-content-factory`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `jake-thornhill-interest-stacking`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `jay-sun-films-video-craft`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `jen-engine`: recognition_test, source_ledger, workflow_contracts
- `jen-shortform-carousel-engine`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `jimmy-conover-instagram-mastery`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `kieran-content-domain-arsenal`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `kieran-content-intelligence-system`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `kieran-flanagan-agentic-ops`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `kieran-flanagan-content-intelligence`: anti_patterns_sourced, verbatim_exemplars, recognition_test, named_entity_floor, workflow_contracts, menu_parity
- `mes-3-cowork`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `mickmumpitz`: anti_patterns_sourced, recognition_test, workflow_contracts
- `nate-b-jones-manager-loop`: anti_patterns_sourced, recognition_test
- `nichebend-mastery-v3`: anti_patterns_sourced, verbatim_exemplars, recognition_test, named_entity_floor, workflow_contracts, menu_parity
- `nick-st-pierre`: anti_patterns_sourced, recognition_test
- `nicolas-cole-first-dollar-system`: anti_patterns_sourced, verbatim_exemplars, named_entity_floor
- `nicolas-cole-library-first-writing`: anti_patterns_sourced, verbatim_exemplars, named_entity_floor
- `oren-marketing-mastery`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `prompt-system-architecture`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `reference-led-creative-system`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `robert-mac-comedy-intelligence`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts, menu_parity
- `rory-flynn`: anti_patterns_sourced, recognition_test
- `trigger-event-creative-strategy`: anti_patterns_sourced, verbatim_exemplars, named_entity_floor
- `video-studio`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts

## Craft Standard Flags (`directives/skill-craft-standard.md` — advisory, not tier-affecting)

386 skills have at least one cheap deterministic gap:
...
- `ai-creative-studio`: no genius.md, zero workflows, frontmatter missing domain, frontmatter missing when_to_use
...
- `andrew-sean-greer-novel-craft`: frontmatter missing when_to_use
...
- `benoit-vatere`: frontmatter missing when_to_use
...
- `cody-schneider-signal-outbound`: frontmatter missing when_to_use
...
- `dhar-mann-transformational-storytelling`: frontmatter missing when_to_use
...
- `expert-practice-os`: frontmatter missing when_to_use
...
- `grace-leung-ai-team-mastery`: no genius.md, zero workflows, frontmatter missing when_to_use
...
- `growth-blueprint-os`: frontmatter missing when_to_use
...
- `heydominik-instagram-growth-os`: frontmatter missing when_to_use
- `higgsfield-content-factory`: no genius.md, zero workflows, frontmatter missing domain, frontmatter missing when_to_use
...
- `jake-thornhill-interest-stacking`: no genius.md, zero workflows, frontmatter missing when_to_use
...
- `jay-sun-films-video-craft`: no genius.md, zero workflows, frontmatter missing domain, frontmatter missing when_to_use
- `jen-engine`: frontmatter missing when_to_use
- `jen-shortform-carousel-engine`: no genius.md, zero workflows, frontmatter missing domain, frontmatter missing when_to_use
...
- `jimmy-conover-instagram-mastery`: no genius.md, zero workflows, frontmatter missing domain, frontmatter missing when_to_use
...
- `jun-yuh-creator-vision`: frontmatter missing when_to_use
...
- `kallaway-hook-mastery`: frontmatter missing when_to_use
...
- `kieran-content-domain-arsenal`: no genius.md, zero workflows, frontmatter missing when_to_use
- `kieran-content-intelligence-system`: no genius.md, zero workflows, frontmatter missing when_to_use
- `kieran-flanagan-agentic-ops`: no genius.md, zero workflows, frontmatter missing when_to_use
...
- `kieran-flanagan-content-intelligence`: no genius.md, zero workflows, frontmatter missing when_to_use
...
- `matt-haig-reader-bridge`: frontmatter missing domain, frontmatter missing when_to_use
...
- `mes-3-cowork`: no genius.md, zero workflows, frontmatter missing when_to_use
...
- `nate-b-jones-manager-loop`: frontmatter missing when_to_use
...
- `nichebend-mastery-v3`: no genius.md, zero workflows, frontmatter missing when_to_use
...
- `nicolas-cole-first-dollar-system`: frontmatter missing when_to_use
- `nicolas-cole-library-first-writing`: frontmatter missing domain, frontmatter missing when_to_use
...
- `oren-marketing-mastery`: no genius.md, zero workflows, frontmatter missing when_to_use
- `oren-norton-world-building`: frontmatter missing when_to_use
...
- `oren-slop-era-creative-strategy`: frontmatter missing when_to_use
...
- `prompt-system-architecture`: no genius.md, zero workflows, frontmatter missing when_to_use
...
- `reference-led-creative-system`: no genius.md, zero workflows, frontmatter missing when_to_use
...
- `robert-mac-comedy-intelligence`: no genius.md, zero workflows, frontmatter missing when_to_use
...
- `shaan-puri-storytelling`: frontmatter missing when_to_use
...
- `trigger-event-creative-strategy`: frontmatter missing domain, frontmatter missing when_to_use
...
- `video-studio`: no genius.md, frontmatter missing when_to_use
...
- ⚠️ CLAUDE.md GREW 19,287B → 22,693B (+3,406B). Prune test per addition: would removing it cause mistakes? No → it goes to an on-demand file.
...
| `brock-johnson-shareworthy-content` | 4 | ✓ | 1 (avg 8.3) | ✓ | full structure (4 workflows + genius.md); trace avg 8.3 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `dan-koe-multipassionate-mastery` | 9 | ✓ | 1 (avg 8.3) | ✓ | full structure (9 workflows + genius.md); trace avg 8.3 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `diandra-escobar-linkedin-growth` | 23 | ✓ | 1 (avg 9.0) | ✓ | full structure (23 workflows + genius.md); trace avg 9.0 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `jack-roberts-design-mastery` | 16 | ✓ | 1 (avg 8.7) |  | full structure (16 workflows + genius.md); trace avg 8.7 ≥ 7.5 (1 traces) |
...
| `jason-fladlien-marketing` | 39 | ✓ | 1 (avg 8.0) | ✓ | full structure (39 workflows + genius.md); trace avg 8.0 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `soowei-consulting-leverage` | 12 | ✓ | 1 (avg 8.3) |  | full structure (12 workflows + genius.md); trace avg 8.3 ≥ 7.5 (1 traces) |
...
| `andrew-sean-greer-novel-craft` | 12 | ✓ | - | ✓ | full structure (12 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `caleb-ralston-personal-brand` | 21 | ✓ | - | ✓ | full structure (21 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `david-perell-writing` | 13 | ✓ | - | ✓ | full structure (13 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
| `dhar-mann-transformational-storytelling` | 9 | ✓ | - | ✓ | full structure (9 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `enrico-incarnati-instagram-realestate` | 12 | ✓ | - | ✓ | full structure (12 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `expert-practice-os` | 1 | ✓ | - | ✓ | has genius.md but <3 workflows; cross-referenced (no trace data) |
...
| `fashion-coupids` | 2 | ✓ | - | ✓ | has genius.md but <3 workflows; cross-referenced (no trace data) |
...
| `growth-blueprint-os` | 10 | ✓ | - | ✓ | full structure (10 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `joanna-wiebe-persuasion-mastery` | 15 | ✓ | - | ✓ | full structure (15 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `john-whiting-propaganda-machine` | 20 | ✓ | - | ✓ | full structure (20 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `jun-yuh-creator-vision` | 25 | ✓ | - | ✓ | full structure (25 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `kallaway-content-operating-system` | 2 | ✓ | - | ✓ | has genius.md but <3 workflows; cross-referenced (no trace data) |
...
| `kallaway-hook-mastery` | 10 | ✓ | - | ✓ | full structure (10 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `luke-iha-creative-strategy` | 8 | ✓ | - | ✓ | full structure (8 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `mark-forsyth-rhetoric` | 16 | ✓ | - | ✓ | full structure (16 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `matt-haig-reader-bridge` | 11 | ✓ | - | ✓ | full structure (11 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `nate-b-jones-manager-loop` | 6 | ✓ | - | ✓ | full structure (6 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
| `nate-herk-client-acquisition` | 1 | ✓ | 1 (avg 8.3) | ✓ | has genius.md but <3 workflows; 1 traces, avg 8.3 |
| `nathan-gotch-ai-seo` | 20 | ✓ | - | ✓ | full structure (20 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `nicolas-cole-first-dollar-system` | 5 | ✓ | - | ✓ | full structure (5 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
| `nicolas-cole-library-first-writing` | 2 | ✓ | - | ✓ | has genius.md but <3 workflows; cross-referenced (no trace data) |
...
| `nicolas-cole-niche-positioning` | 11 | ✓ | - | ✓ | full structure (11 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `sam-vander-wielen` | 12 | ✓ | - | ✓ | full structure (12 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `search-content-mastery-os` | 4 | ✓ | - | ✓ | full structure (4 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `seth-godin-philosophy` | 10 | ✓ | - | ✓ | full structure (10 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
| `shaan-puri-storytelling` | 7 | ✓ | - | ✓ | full structure (7 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `trigger-event-creative-strategy` | 3 | ✓ | - | ✓ | full structure (3 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `video-studio` | 6 |  | - | ✓ | 6 workflows but no genius.md; cross-referenced (no trace data) |
...
| `alyssa-stalker-agent-content-playbook` | 7 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
| `benoit-vatere` | 10 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
| `bitbranding-fashion-shopify` | 7 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
| `cody-schneider-signal-outbound` | 11 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
| `dara-denney-meta-ads` | 31 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
| `grace-leung-ai-team-mastery` | 0 |  | - | ✓ | minimal structure but used — enrich with genius.md/workflows |
...
| `heydominik-instagram-growth-os` | 11 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
| `jen-engine` | 1 | ✓ | - |  | partial structure (intentional but unused) — review priority |
| `jen-santulan-listing-content` | 4 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
| `jordan-crawford-gtm-intelligence` | 10 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
| `kyle-milligan-copy-chief` | 8 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
| `mes-3-cowork` | 0 |  | - | ✓ | minimal structure but used — enrich with genius.md/workflows |
| `mickmumpitz` | 3 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
| `mike-sherrard-realtor-branding` | 4 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
| `oren-norton-world-building` | 11 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
| `oren-one-person-ai-marketer` | 13 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
| `oren-operational-systems` | 3 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
| `oren-repositioning` | 6 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
| `oren-slop-era-creative-strategy` | 10 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
| `prompt-system-architecture` | 0 |  | - | ✓ | minimal structure but used — enrich with genius.md/workflows |
...
| `reference-led-creative-system` | 0 |  | - | ✓ | minimal structure but used — enrich with genius.md/workflows |
...
| `robert-mac-comedy-intelligence` | 0 |  | - | ✓ | minimal structure but used — enrich with genius.md/workflows |
...
| `satori-graphics` | 27 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
| `sean-dollwet-kdp-publishing` | 11 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
| `sunny-lenarduzzi-youtube` | 4 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
| Skill | Workflows | Genius | Traces | Cross-ref | Reasoning |
|---|---|---|---|---|---|
| `ai-creative-studio` | 0 |  | - |  | minimal structure (SKILL.md only) AND no traces AND no cross-references |
| `eli5` | 1 |  | - |  | minimal structure (SKILL.md only) AND no traces AND no cross-references |
| `higgsfield-content-factory` | 0 |  | - |  | minimal structure (SKILL.md only) AND no traces AND no cross-references |
| `jake-thornhill-interest-stacking` | 0 |  | - |  | minimal structure (SKILL.md only) AND no traces AND no cross-references |
| `jay-sun-films-video-craft` | 0 |  | - |  | minimal structure (SKILL.md only) AND no traces AND no cross-references |
| `jen-shortform-carousel-engine` | 0 |  | - |  | minimal structure (SKILL.md only) AND no traces AND no cross-references |
| `jimmy-conover-instagram-mastery` | 0 |  | - |  | minimal structure (SKILL.md only) AND no traces AND no cross-references |
| `kieran-content-domain-arsenal` | 0 |  | - |  | minimal structure (SKILL.md only) AND no traces AND no cross-references |
| `kieran-content-intelligence-system` | 0 |  | - |  | minimal structure (SKILL.md only) AND no traces AND no cross-references |
| `kieran-flanagan-agentic-ops` | 0 |  | - |  | minimal structure (SKILL.md only) AND no traces AND no cross-references |
| `kieran-flanagan-content-intelligence` | 0 |  | - |  | minimal structure (SKILL.md only) AND no traces AND no cross-references |
| `nichebend-mastery-v3` | 0 |  | - |  | minimal structure (SKILL.md only) AND no traces AND no cross-references |
| `oren-marketing-mastery` | 0 |  | - |  | minimal structure (SKILL.md only) AND no traces AND no cross-references |
...
Machine-readable records: `evolution_store/skill_audit_2026-09-14.jsonl`
