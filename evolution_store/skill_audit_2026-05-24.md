...
**Total skills**: 235
**Tier distribution**: A=79, B=113, C=1, REVIEW=15, UTILITY=27
...
|---|---|---|---|---|---|
| `alex-m-smith-natural-strategy` | 5 | ✓ | 1 (avg 8.0) | ✓ | full structure (5 workflows + genius.md); trace avg 8.0 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
| `alex-myatt-creative-engine` | 12 | ✓ | 1 (avg 8.7) | ✓ | full structure (12 workflows + genius.md); trace avg 8.7 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
| `andreessen-horowitz-new-media` | 4 | ✓ | 1 (avg 8.3) |  | full structure (4 workflows + genius.md); trace avg 8.3 ≥ 7.5 (1 traces) |
| `andrew-dun-vibe-consulting` | 15 | ✓ | 2 (avg 8.7) | ✓ | full structure (15 workflows + genius.md); trace avg 8.7 ≥ 7.5 (2 traces); cross-referenced from CLAUDE/COUNCIL/router |
| `april-dunford-positioning` | 16 | ✓ | 1 (avg 8.7) | ✓ | full structure (16 workflows + genius.md); trace avg 8.7 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
| `bitbranding-fashion-shopify` | 4 | ✓ | 1 (avg 8.0) |  | full structure (4 workflows + genius.md); trace avg 8.0 ≥ 7.5 (1 traces) |
| `brad-bonanno-explainer-architecture` | 4 | ✓ | 1 (avg 8.7) |  | full structure (4 workflows + genius.md); trace avg 8.7 ≥ 7.5 (1 traces) |
| `brand-operating-system` | 7 | ✓ | 2 (avg 8.85) | ✓ | full structure (7 workflows + genius.md); trace avg 8.85 ≥ 7.5 (2 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `chase-hughes-conversational-influence` | 6 | ✓ | 1 (avg 8.3) |  | full structure (6 workflows + genius.md); trace avg 8.3 ≥ 7.5 (1 traces) |
| `corey-mcclain-persona-engineering` | 20 | ✓ | 1 (avg 8.7) |  | full structure (20 workflows + genius.md); trace avg 8.7 ≥ 7.5 (1 traces) |
| `creative-campaign-strategy` | 17 | ✓ | 2 (avg 8.5) | ✓ | full structure (17 workflows + genius.md); trace avg 8.5 ≥ 7.5 (2 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `dara-denney-meta-ads` | 5 | ✓ | 1 (avg 8.0) |  | full structure (5 workflows + genius.md); trace avg 8.0 ≥ 7.5 (1 traces) |
...
| `diandra-escobar-linkedin-growth` | 19 | ✓ | 2 (avg 8.35) | ✓ | full structure (19 workflows + genius.md); trace avg 8.35 ≥ 7.5 (2 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `evan-spiegel-distribution-architecture` | 13 | ✓ | 1 (avg 8.7) | ✓ | full structure (13 workflows + genius.md); trace avg 8.7 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `jason-fladlien-marketing` | 27 | ✓ | 2 (avg 8.35) | ✓ | full structure (27 workflows + genius.md); trace avg 8.35 ≥ 7.5 (2 traces); cross-referenced from CLAUDE/COUNCIL/router |
| `jen-santulan-listing-content` | 3 | ✓ | 2 (avg 7.65) | ✓ | full structure (3 workflows + genius.md); trace avg 7.65 ≥ 7.5 (2 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `kallaway-addictive-storytelling` | 11 | ✓ | 1 (avg 8.7) | ✓ | full structure (11 workflows + genius.md); trace avg 8.7 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `lamott-craft` | 12 | ✓ | 2 (avg 8.7) |  | full structure (12 workflows + genius.md); trace avg 8.7 ≥ 7.5 (2 traces) |
...
| `lara-acosta-linkedin-mastery` | 9 | ✓ | 3 (avg 8.23) | ✓ | full structure (9 workflows + genius.md); trace avg 8.23 ≥ 7.5 (3 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `omar-eddaoudi-scaling-ops` | 10 | ✓ | 1 (avg 8.7) | ✓ | full structure (10 workflows + genius.md); trace avg 8.7 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `patrick-debois-cdlc` | 4 | ✓ | 1 (avg 8.7) |  | full structure (4 workflows + genius.md); trace avg 8.7 ≥ 7.5 (1 traces) |
...
| `prediction-market-weather-trading` | 3 | ✓ | 1 (avg 9.3) | ✓ | full structure (3 workflows + genius.md); trace avg 9.3 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `satori-graphics` | 14 | ✓ | 2 (avg 8.85) |  | full structure (14 workflows + genius.md); trace avg 8.85 ≥ 7.5 (2 traces) |
| `sean-macintyre-persuasion-philosophy` | 17 | ✓ | 2 (avg 8.7) |  | full structure (17 workflows + genius.md); trace avg 8.7 ≥ 7.5 (2 traces) |
...
| `sharran-srivatsaa-scaling` | 7 | ✓ | 1 (avg 8.7) |  | full structure (7 workflows + genius.md); trace avg 8.7 ≥ 7.5 (1 traces) |
...
| `vince-nijhof-dtc-operator-system` | 14 | ✓ | 2 (avg 7.75) | ✓ | full structure (14 workflows + genius.md); trace avg 7.75 ≥ 7.5 (2 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `greg-hoffman-brand-mastery` | 6 | ✓ | - | ✓ | full structure (6 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `luke-iha-copy-blocks` | 4 | ✓ | - | ✓ | full structure (4 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `prediction-market-ai-event-analysis` | 3 | ✓ | - | ✓ | full structure (3 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
| `prediction-market-making` | 3 | ✓ | - | ✓ | full structure (3 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
| `prediction-market-risk-management` | 3 | ✓ | - | ✓ | full structure (3 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `supercomputer` | 0 | ✓ | 1 (avg 7.7) | ✓ | has genius.md but <3 workflows; 1 traces, avg 7.7 |
...
| `tom-noske-content-creation` | 4 | ✓ | - | ✓ | full structure (4 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `creative-direction` | 0 | ✓ | 2 (avg 9.0) | ✓ | system/Anthropic utility skill — not graded against expert rubric |
...
Machine-readable records: `evolution_store/skill_audit_2026-05-24.jsonl`
