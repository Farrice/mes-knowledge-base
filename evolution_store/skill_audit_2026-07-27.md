...
**Total skills**: 378
**Tier distribution**: A=54, B=193, REVIEW=104, UTILITY=27
...
343 skills have at least one cheap deterministic gap:
...
- ⚠️ CLAUDE.md GREW 18,943B → 19,609B (+666B). Prune test per addition: would removing it cause mistakes? No → it goes to an on-demand file.
...
| `supercomputer` | 4 | ✓ | - | ✓ | full structure (4 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
Machine-readable records: `evolution_store/skill_audit_2026-07-27.jsonl`
