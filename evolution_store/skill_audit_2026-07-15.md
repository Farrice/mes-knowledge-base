# Skill Audit — 2026-07-15

**Total skills**: 364
**Tier distribution**: A=3, B=232, C=4, REVIEW=98, UTILITY=27
...
326 skill(s) fail ≥2 checks (9 tier-capped this run):
...
- `alan-aragon-nutrition`: anti_patterns_sourced, recognition_test, workflow_contracts
...
- `brendan-kane-viral-strategy`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts
...
- `craig-clemens-copywriting`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts
...
- `daniel-thrasher-affiliate`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts
...
- `jeremy-haynes-cold-offer`: anti_patterns_sourced, recognition_test
...
- `joanna-wiebe-writing-careers`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts
...
- `knowledge-architecture-studio`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts
...
- `lara-acosta-content-system`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
...
- `luke-iha-proof-mechanisms`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts
...
- `marisa-murgatroyd-course-design`: anti_patterns_sourced, recognition_test, workflow_contracts
...
- `paul-james-ai-automation`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts
...
- `russell-brunson-funnels`: anti_patterns_sourced, recognition_test, workflow_contracts
...
333 skills have at least one cheap deterministic gap:
...
| `jeremy-haynes-cold-offer` | 13 | ✓ | - | ✓ | full structure (13 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `forge-os` | 0 |  | 2 (avg 8.5) | ✓ | minimal structure but used — enrich with genius.md/workflows |
...
Machine-readable records: `evolution_store/skill_audit_2026-07-15.jsonl`
