...
**Total skills**: 371
**Tier distribution**: A=18, B=232, C=1, REVIEW=93, UTILITY=27
...
| `forge-os` | 5 | ✓ | 4 (avg 8.58) | ✓ | full structure (5 workflows + genius.md); trace avg 8.58 ≥ 7.5 (4 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `deliberate` | 1 | ✓ | 1 (avg 7.08) |  | has genius.md but <3 workflows; 1 traces, avg 7.08 |
...
| `expert-assembly-os` | 2 | ✓ | 4 (avg 8.42) | ✓ | has genius.md but <3 workflows; 4 traces, avg 8.42 |
...
| `supercomputer` | 4 | ✓ | 7 (avg 6.97) | ✓ | 7 traces, avg 6.97 |
...
Machine-readable records: `evolution_store/skill_audit_2026-07-18.jsonl`
