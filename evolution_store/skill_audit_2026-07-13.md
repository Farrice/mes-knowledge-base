# Skill Audit — 2026-07-13

**Total skills**: 357
**Tier distribution**: B=231, C=3, REVIEW=96, UTILITY=27
...
323 skill(s) fail ≥2 checks (53 tier-capped this run):

- `adam-enfroy-affiliate-marketing`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `ai-chris-lee-zero-testimonial-sales`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `alan-aragon-nutrition`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `alen-sultanic-copywriting`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `alex-content-science`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor
- `alex-copper-creative-strategy`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `alex-hormozi-business`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `ali-abdaal-action-bias`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `andreessen-horowitz-new-media`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `andrew-dun-vibe-consulting`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `andrew-lane-design-systems`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `andrew-stanton-audience-engineering`: anti_patterns_sourced, source_ledger
- `andrew-wilkinson-ai-entrepreneurship`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `andy-galpin-training-intelligence`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `andy-lo-premium-websites`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `april-dunford-positioning`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `ash-maurya-founder-systems`: anti_patterns_sourced, verbatim_exemplars, recognition_test, named_entity_floor
- `ash-maurya-lean-metrics`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `authority-hacker-ai-social-media`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `benjamin-hardy-identity`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `bill-browder-high-stakes-narrative`: anti_patterns_sourced, source_ledger
- `bitbranding-fashion-shopify`: anti_patterns_sourced, recognition_test, source_ledger
- `bond-halbert-copywriting`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `boris-claude-code`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts
- `brad-bonanno-explainer-architecture`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor
- `brand-operating-system`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `brandon-jacoby-taste-mastery`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor
- `brendan-kane-viral-strategy`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `brock-johnson-shareworthy-content`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `business-intelligence-audit`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `caleb-ralston-personal-brand`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `cardinal-mason-ai-copywriting`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `chris-do-design-business`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `cinematic-documentary`: recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `claim-safe-health-marketing`: anti_patterns_sourced, named_entity_floor
- `coaching-business-os`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `cognitive-engagement-optimizer`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `context-profile-architect`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `corey-mcclain-persona-engineering`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `craig-clemens-copywriting`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `creative-campaign-strategy`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor
- `dai-media-consumer-posture`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `dakota-content-design`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `damon-cart-nlp`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `dan-bolton-coaching-offers`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `dan-koe-ai-leverage`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `dan-koe-multipassionate-mastery`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `dan-martell-business-scaling`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `dan-wang-literary-analysis`: source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `daniel-pink-writing-structure`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `daniel-priestley-24-assets-os`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor
- `daniel-priestley-oversubscribed`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `daniel-thrasher-affiliate`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `darrel-wilson-ai-monetization`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `david-bayer-elite-communication`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `david-deutsch-copywriting`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `david-mcraney-belief-change`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts
- `david-perell-writing`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `david-placek-naming`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `deliberate`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `deya-business-systems`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `diandra-escobar-linkedin-growth`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
...
- `donald-miller-culture-turnaround`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `dr-k-consciousness`: recognition_test, source_ledger, workflow_contracts
- `dr-kriukow-humanization`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `erica-mallet-brand-magnetism`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `ethan-smith-aeo`: anti_patterns_sourced, recognition_test, workflow_contracts
- `eugene-teo-training`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `evan-spiegel-distribution-architecture`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor
- `extract-mastery`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `fantastic-posters`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, workflow_contracts
- `fareed-zakaria-writing-mastery`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `fraser-cottrell-paid-ads`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `fresh-voice-system`: anti_patterns_sourced, source_ledger, named_entity_floor **[capped A→B]**
...
- `futurepedia-prompt-engineering`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts
- `gabe-novotny-fitness-content-business`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `gary-vaynerchuk-attention`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `ghostwriting-voice-engine`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
...
- `grace-andrews-media-company`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `greg-hickman-service-scaling`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `greg-hoffman-brand-mastery`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `growth-ecosystems`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `harry-dry-copywriting`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts
- `henrik-werdelin-portfolio-entrepreneurship`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `jack-roberts-design-mastery`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `james-i-bond-brain-glue`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor
- `jasmin-alic-linkedin-growth`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `jason-fladlien-marketing`: recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `jay-hiette-coaching-positioning`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `jen-santulan-listing-content`: anti_patterns_sourced, recognition_test, source_ledger
- `jenny-hoyos-shorts`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `jeremy-haynes-mindset-systems`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `jeremy-miner-identity-persuasion`: anti_patterns_sourced, recognition_test, workflow_contracts **[capped A→B]**
- `jessica-jensen-platform-intelligence`: anti_patterns_sourced, recognition_test, source_ledger
- `jiang-xueqin-cognitive-autonomy`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `jim-oshaughnessy-philosopher-financier`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `joanna-wiebe-persuasion-mastery`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `joanna-wiebe-writing-careers`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `john-whiting-propaganda-machine`: anti_patterns_sourced, recognition_test
- `jonah-berger-contagious`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `jonathan-courtney-marketing`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `jonathan-franzen-storytelling`: anti_patterns_sourced, source_ledger, named_entity_floor, workflow_contracts
- `joscha-bach-consciousness`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor
- `josh-kaufman-business-fundamentals`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `josh-sanders-linkedin-growth`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `joshua-smith-real-estate`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `jun-yuh-creator-vision`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `jun-yuh-personal-brand`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `justin-welsh-solopreneur`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `kallaway-addictive-storytelling`: anti_patterns_sourced, source_ledger, named_entity_floor, workflow_contracts
- `kallaway-ai-content-engine`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `kallaway-social-commerce`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `kallaway-word-mastery`: anti_patterns_sourced, recognition_test, source_ledger
- `kieran-flanagan-audience-intelligence`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `kieran-flanagan-content-engine`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `kieran-flanagan-content-ops`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `kittl-graphic-design`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `kj-rainey-copywriting`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `knowledge-architecture-studio`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `kobi-brown-educational-virality`: anti_patterns_sourced, recognition_test, workflow_contracts
- `kunal-shah-consumer-psychology`: anti_patterns_sourced, source_ledger, workflow_contracts
...
- `lamott-craft`: anti_patterns_sourced, source_ledger, workflow_contracts
- `lance-yichao-context-engineering`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `lara-acosta-content-system`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `lara-acosta-linkedin-growth`: recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `lara-acosta-linkedin-mastery`: anti_patterns_sourced, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `liam-mley-ai-brain-builder`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `liam-ottley-linkedin-lead-magnet`: anti_patterns_sourced, verbatim_exemplars, recognition_test, named_entity_floor, workflow_contracts
- `lindsay-ai-consulting`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `linkedin-2026-format-arbitrage`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `logan-kilpatrick-ai-studio`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `lucas-alpay-storytelling`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `luisa-zhou-coaching`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `luke-alexander-ai-business`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `luke-iha-avatar-machine`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `luke-iha-client-mastery`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `luke-iha-copy-blocks`: anti_patterns_sourced, source_ledger, named_entity_floor, workflow_contracts
- `luke-iha-creative-strategy`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `luke-iha-proof-mechanisms`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts **[capped A→B]**
- `luke-iha-unaware-ads`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `luke-iha-vicious-hooks`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `luke-iha-vsl-leads`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `lulu-cheng-meservey-communications`: anti_patterns_sourced, source_ledger, workflow_contracts
- `made-to-stick-messaging`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts **[capped A→B]**
- `manus-ai-consulting`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `marc-andreessen-ai-thesis`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `maria-wendt-digital-products`: recognition_test, source_ledger, workflow_contracts
- `marisa-murgatroyd-course-design`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `mark-forsyth-rhetoric`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `mark-kashef-agent-orchestration`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `mark-kashef-ai-councils`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `mark-kashef-banana-squad`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `mark-kashef-claude-claw`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
...
- `mark-kashef-visual-design`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `mark-manson-values-psychology`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `matt-mcgarry-newsletters`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `matthew-lakajev-linkedin`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `matthew-volkwyn-copywriting`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `meg-heckman-buyer-trigger-os`: anti_patterns_sourced, recognition_test, workflow_contracts
- `michael-bernoff-identity-engineering`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `michael-connelly-vivid-writing`: anti_patterns_sourced, source_ledger, named_entity_floor
- `michael-israetel-hypertrophy`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `michael-margolis-user-research`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `mike-foutia-marketing-tools`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `mike-sherrard-realtor-branding`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `mitch-albom-writing-mastery`: anti_patterns_sourced, source_ledger, named_entity_floor, workflow_contracts
- `monk-ai-offer-architecture`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `nate-b-jones-agent-deployment-strategy`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `nate-b-jones-ai-taste-mastery`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `nate-b-jones-auto-improvement-loops`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor **[capped A→B]**
- `nate-b-jones-context-engineering`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `nate-b-jones-intent-engineering`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `nate-b-jones-orchestration-intelligence`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `nate-b-jones-trust-architecture`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `nate-herk-client-acquisition`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `nathan-gotch-ai-seo`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `nba-betting-edge`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `nick-saraev-agentic-workflows`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `nick-saraev-bottleneck-thinking`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `nicolas-cole-client-acquisition`: anti_patterns_sourced, recognition_test, workflow_contracts
- `nicolas-cole-digital-products`: anti_patterns_sourced, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
...
- `nicolas-cole-sentence-craft`: anti_patterns_sourced, source_ledger, named_entity_floor, workflow_contracts
- `nir-eyal-habit-design`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `omar-eddaoudi`: recognition_test, source_ledger, workflow_contracts
- `omar-eddaoudi-premium-ads`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `oren-brand-archetypes`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `oren-luxury-psychology`: anti_patterns_sourced, source_ledger, named_entity_floor, workflow_contracts
- `oren-one-person-ai-marketer`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `oren-operational-systems`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `oren-repositioning`: anti_patterns_sourced, source_ledger, named_entity_floor, workflow_contracts
- `oren-taste-development`: anti_patterns_sourced, source_ledger, workflow_contracts
- `oscar-hoglund-sound-storytelling`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `packy-mccormick-writing`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `pat-flynn-passive-income`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `patrick-dang-online-business`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `patrick-debois-cdlc`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor
- `paul-james-ai-automation`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts **[capped A→B]**
...
- `pj-accetturo-ai-video`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
...
- `prediction-market-weather-trading`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `product-design-build`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `prosperity-coach-system`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `rachel-woods-ai-operations`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
...
- `reid-hoffman-ai-strategy`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `robert-greene-power-mastery`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `ross-mckay-premium-at-scale`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `ross-minchev-digital-products`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `russell-brunson-funnels`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `sabri-suby-ai-advertising`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `sabrina-ramonov-ai-monetization`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `sam-goddard-media-scaling`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `sam-parr-copywriting`: anti_patterns_sourced, recognition_test, source_ledger
- `sam-parr-copywriting-mechanics`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, workflow_contracts
- `sam-parr-taste-acquisition`: anti_patterns_sourced, recognition_test, source_ledger
- `samuel-thompson-product-launch`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `sarah-levinger-ad-psychology`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `satori-graphics`: anti_patterns_sourced, recognition_test, named_entity_floor
- `sean-dollwet-kdp-publishing`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `sean-kochel-ai-business`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `sean-kochel-design-first-build`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `seena-rez-tiktok-commerce`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
...
- `seth-godin-ideavirus`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `seth-godin-philosophy`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `shaan-puri-storytelling`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `shan-hanif-audience-monetization`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `sharran-srivatsaa-scaling`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor
- `sherwin-wu-ai-engineering`: anti_patterns_sourced, recognition_test, workflow_contracts **[capped A→B]**
- `simon-intellectual-library-os`: anti_patterns_sourced, recognition_test
- `sky-tan-format-engine`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor
- `soowei-consulting-leverage`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `stefan-georgi-dopamine-copy`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `steven-kotler-flow-performance`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `steven-pressfield-narrative-mastery`: anti_patterns_sourced, recognition_test, source_ledger
- `steven-young-consciousness`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `stockton-walbeck-lead-magnets`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `story-compass`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor
- `strength-conditioning-os`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `sunny-lenarduzzi-youtube`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `taki-moore-lifestyle-business`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `tao-prompts-ai-video`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `taylor-welch-wealthy-consultant`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `tess-barclay-social-content`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `thrivecart-digital-products`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
- `tim-danilov-niche-bending`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `tobi-lutke-business-leadership`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `tobias-allen-marketing-mastery`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `tom-noske-content-creation`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `tom-noske-personal-brand`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `tom-segura-comedy-storytelling`: anti_patterns_sourced, recognition_test
- `tommy-clark-linkedin-growth`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `tyler-denk-audience-monetization`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, workflow_contracts
...
- `vince-nijhof-dtc-operator-system`: anti_patterns_sourced, recognition_test
- `voice-os`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `wordsatscale-seo-ranking`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `wright-thompson-mastery`: anti_patterns_sourced, recognition_test, source_ledger **[capped A→B]**
...
- `yuri-elkaim-health-coaching-business`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts

## Craft Standard Flags (`directives/skill-craft-standard.md` — advisory, not tier-affecting)

327 skills have at least one cheap deterministic gap:
...
| `andreessen-horowitz-new-media` | 4 | ✓ | 1 (avg 8.3) |  | full structure (4 workflows + genius.md); trace avg 8.3 ≥ 7.5 (1 traces); HEARTBEAT CAP: failed 5/6 tier-affecting checks (anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, workflow_contracts) — capped at B per directives/skill-craft-standard.md |
...
| `fantastic-posters` | 14 | ✓ | - | ✓ | full structure (14 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `ghostwriting-voice-engine` | 4 | ✓ | 1 (avg 8.3) |  | full structure (4 workflows + genius.md); trace avg 8.3 ≥ 7.5 (1 traces); HEARTBEAT CAP: failed 4/6 tier-affecting checks (anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts) — capped at B per directives/skill-craft-standard.md |
...
| `jack-roberts-design-mastery` | 15 | ✓ | 1 (avg 8.7) |  | full structure (15 workflows + genius.md); trace avg 8.7 ≥ 7.5 (1 traces); HEARTBEAT CAP: failed 5/6 tier-affecting checks (anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts) — capped at B per directives/skill-craft-standard.md |
...
| `jason-fladlien-marketing` | 31 | ✓ | 1 (avg 8.0) | ✓ | full structure (31 workflows + genius.md); trace avg 8.0 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `made-to-stick-messaging` | 4 | ✓ | 1 (avg 8.3) |  | full structure (4 workflows + genius.md); trace avg 8.3 ≥ 7.5 (1 traces); HEARTBEAT CAP: failed 4/6 tier-affecting checks (anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts) — capped at B per directives/skill-craft-standard.md |
...
| `prediction-market-weather-trading` | 3 | ✓ | 1 (avg 9.3) |  | full structure (3 workflows + genius.md); trace avg 9.3 ≥ 7.5 (1 traces); HEARTBEAT CAP: failed 4/6 tier-affecting checks (anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts) — capped at B per directives/skill-craft-standard.md |
...
| `soowei-consulting-leverage` | 4 | ✓ | 1 (avg 8.3) |  | full structure (4 workflows + genius.md); trace avg 8.3 ≥ 7.5 (1 traces); HEARTBEAT CAP: failed 4/6 tier-affecting checks (anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts) — capped at B per directives/skill-craft-standard.md |
...
| `taki-moore-lifestyle-business` | 6 | ✓ | 1 (avg 8.3) |  | full structure (6 workflows + genius.md); trace avg 8.3 ≥ 7.5 (1 traces); HEARTBEAT CAP: failed 4/6 tier-affecting checks (anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts) — capped at B per directives/skill-craft-standard.md |
| `tao-prompts-ai-video` | 2 | ✓ | 1 (avg 8.3) | ✓ | has genius.md but <3 workflows; 1 traces, avg 8.3 |
| `thrivecart-digital-products` | 4 | ✓ | 1 (avg 8.3) |  | full structure (4 workflows + genius.md); trace avg 8.3 ≥ 7.5 (1 traces); HEARTBEAT CAP: failed 5/6 tier-affecting checks (anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts) — capped at B per directives/skill-craft-standard.md |
...
| `voice-os` | 0 |  | - | ✓ | minimal structure but used — enrich with genius.md/workflows |
...
Machine-readable records: `evolution_store/skill_audit_2026-07-13.jsonl`
