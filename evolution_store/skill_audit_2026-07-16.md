# Skill Audit — 2026-07-16

**Total skills**: 367
**Tier distribution**: A=4, B=232, C=4, REVIEW=100, UTILITY=27
...
324 skill(s) fail ≥2 checks (9 tier-capped this run):
...
335 skills have at least one cheap deterministic gap:
...
| `adam-sandler-second-brain-gtm` | 4 | ✓ | - | ✓ | full structure (4 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `tommy-clark-linkedin-growth` | 6 | ✓ | - | ✓ | full structure (6 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `expert-assembly-os` | 0 |  | 3 (avg 8.44) | ✓ | minimal structure but used — enrich with genius.md/workflows |
...
| `jenny-hoyos-shorts` | 13 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
Machine-readable records: `evolution_store/skill_audit_2026-07-16.jsonl`
