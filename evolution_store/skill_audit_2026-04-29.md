# Skill Audit — 2026-04-29

**Total skills**: 212
**Tier distribution**: A=60, B=106, REVIEW=19, UTILITY=27
...
| `diandra-escobar-linkedin-growth` | 19 | ✓ | 1 (avg 9.0) | ✓ | full structure (19 workflows + genius.md); trace avg 9.0 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `kallaway-addictive-storytelling` | 10 | ✓ | 1 (avg 8.7) | ✓ | full structure (10 workflows + genius.md); trace avg 8.7 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
Machine-readable records: `evolution_store/skill_audit_2026-04-29.jsonl`
