# Skill Audit — 2026-07-20

**Total skills**: 373
**Tier distribution**: A=54, B=193, REVIEW=99, UTILITY=27
...
| `meg-heckman-buyer-trigger-os` | 13 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
Machine-readable records: `evolution_store/skill_audit_2026-07-20.jsonl`
