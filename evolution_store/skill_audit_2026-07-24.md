# Skill Audit — 2026-07-24

**Total skills**: 377
**Tier distribution**: A=31, B=223, C=1, REVIEW=95, UTILITY=27
...
1 skill(s) fail ≥2 checks (0 tier-capped this run):
...
342 skills have at least one cheap deterministic gap:
...
- CLAUDE.md: 18,943B (baseline recorded)
- MEMORY.md: 20,111B (baseline recorded)
...
| `alex-hormozi-business` | 3 | ✓ | 3 (avg 7.53) | ✓ | full structure (3 workflows + genius.md); trace avg 7.53 ≥ 7.5 (3 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `april-dunford-positioning` | 17 | ✓ | 2 (avg 8.33) | ✓ | full structure (17 workflows + genius.md); trace avg 8.33 ≥ 7.5 (2 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `business-intelligence-audit` | 3 | ✓ | 3 (avg 8.33) | ✓ | full structure (3 workflows + genius.md); trace avg 8.33 ≥ 7.5 (3 traces); cross-referenced from CLAUDE/COUNCIL/router |
| `chief-of-staff-os` | 4 | ✓ | 6 (avg 7.67) |  | full structure (4 workflows + genius.md); trace avg 7.67 ≥ 7.5 (6 traces) |
| `creative-campaign-strategy` | 23 | ✓ | 5 (avg 8.2) | ✓ | full structure (23 workflows + genius.md); trace avg 8.2 ≥ 7.5 (5 traces); cross-referenced from CLAUDE/COUNCIL/router |
| `david-baldacci-books-that-sell` | 14 | ✓ | 1 (avg 9.33) | ✓ | full structure (14 workflows + genius.md); trace avg 9.33 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `forge-os` | 5 | ✓ | 7 (avg 8.47) | ✓ | full structure (5 workflows + genius.md); trace avg 8.47 ≥ 7.5 (7 traces); cross-referenced from CLAUDE/COUNCIL/router |
| `geoff-woods-ai-thought-partner` | 17 | ✓ | 3 (avg 8.56) | ✓ | full structure (17 workflows + genius.md); trace avg 8.56 ≥ 7.5 (3 traces); cross-referenced from CLAUDE/COUNCIL/router |
| `jason-fladlien-marketing` | 36 | ✓ | 4 (avg 8.31) | ✓ | full structure (36 workflows + genius.md); trace avg 8.31 ≥ 7.5 (4 traces); cross-referenced from CLAUDE/COUNCIL/router |
| `jenny-hoyos-shorts` | 14 | ✓ | 5 (avg 8.67) |  | full structure (14 workflows + genius.md); trace avg 8.67 ≥ 7.5 (5 traces) |
| `jeremy-haynes-cold-offer` | 14 | ✓ | 5 (avg 8.13) | ✓ | full structure (14 workflows + genius.md); trace avg 8.13 ≥ 7.5 (5 traces); cross-referenced from CLAUDE/COUNCIL/router |
| `kallaway-illusion-of-novelty` | 17 | ✓ | 7 (avg 7.7) | ✓ | full structure (17 workflows + genius.md); trace avg 7.7 ≥ 7.5 (7 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `luke-iha-avatar-machine` | 13 | ✓ | 5 (avg 7.75) | ✓ | full structure (13 workflows + genius.md); trace avg 7.75 ≥ 7.5 (5 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `mike-taylor-synthetic-research` | 7 | ✓ | 1 (avg 8.67) |  | full structure (7 workflows + genius.md); trace avg 8.67 ≥ 7.5 (1 traces) |
| `nicolas-cole-niche-positioning` | 3 | ✓ | 1 (avg 8.67) | ✓ | full structure (3 workflows + genius.md); trace avg 8.67 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
| `oren-dara-ad-psychology` | 10 | ✓ | 4 (avg 7.59) |  | full structure (10 workflows + genius.md); trace avg 7.59 ≥ 7.5 (4 traces) |
| `ray-amjad-agentic-ladder` | 9 | ✓ | 4 (avg 8.42) |  | full structure (9 workflows + genius.md); trace avg 8.42 ≥ 7.5 (4 traces) |
| `riley-brown-marketing-automation` | 12 | ✓ | 1 (avg 9.33) |  | full structure (12 workflows + genius.md); trace avg 9.33 ≥ 7.5 (1 traces) |
| `samuel-thompson-product-launch` | 4 | ✓ | 1 (avg 8.33) | ✓ | full structure (4 workflows + genius.md); trace avg 8.33 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
| `seth-godin-marketing-mind` | 16 | ✓ | 2 (avg 8.33) | ✓ | full structure (16 workflows + genius.md); trace avg 8.33 ≥ 7.5 (2 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `brand-operating-system` | 7 | ✓ | 4 (avg 7.25) | ✓ | 4 traces, avg 7.25 |
...
| `claim-safe-health-marketing` | 5 | ✓ | 6 (avg 7.13) | ✓ | 6 traces, avg 7.13 |
...
| `expert-assembly-os` | 2 | ✓ | 5 (avg 8.53) | ✓ | has genius.md but <3 workflows; 5 traces, avg 8.53 |
...
| `jen-santulan-listing-content` | 3 | ✓ | 8 (avg 6.98) |  | 8 traces, avg 6.98 |
...
| `lara-acosta-linkedin-mastery` | 9 | ✓ | 11 (avg 7.26) | ✓ | 11 traces, avg 7.26 |
...
| `meg-heckman-buyer-trigger-os` | 17 | ✓ | 5 (avg 7.25) |  | 5 traces, avg 7.25 |
...
| `nate-b-jones-context-engineering` | 6 | ✓ | - | ✓ | full structure (6 workflows + genius.md); cross-referenced but no trace evidence yet — promote to A on first ≥7.5 trace |
...
| `oren-brand-archetypes` | 8 | ✓ | 1 (avg 7.25) |  | 1 traces, avg 7.25 |
...
| `supercomputer` | 4 | ✓ | 6 (avg 6.85) | ✓ | 6 traces, avg 6.85 |
...
| `voice-os` | 4 | ✓ | 4 (avg 7.14) | ✓ | 4 traces, avg 7.14 |
...
Machine-readable records: `evolution_store/skill_audit_2026-07-24.jsonl`
