...
**Total skills**: 400
**Tier distribution**: A=54, B=199, REVIEW=120, UTILITY=27
...
12 skill(s) fail ≥2 checks (0 tier-capped this run):
...
359 skills have at least one cheap deterministic gap:
...
- ⚠️ CLAUDE.md GREW 15,207B → 19,287B (+4,080B). Prune test per addition: would removing it cause mistakes? No → it goes to an on-demand file.
...
| `jason-fladlien-marketing` | 38 | ✓ | 1 (avg 8.0) | ✓ | full structure (38 workflows + genius.md); trace avg 8.0 ≥ 7.5 (1 traces); cross-referenced from CLAUDE/COUNCIL/router |
...
| `oren-norton-world-building` | 10 | ✓ | - |  | full structure but never used (no traces, no cross-references) |
...
Machine-readable records: `evolution_store/skill_audit_2026-08-10.jsonl`
