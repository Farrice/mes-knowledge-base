# Skill Audit — 2026-07-09

**Total skills**: 357
**Tier distribution**: B=234, C=3, REVIEW=93, UTILITY=27
...
323 skill(s) fail ≥2 checks (8 tier-capped this run):
...
- `brock-johnson-shareworthy-content`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `dan-koe-ai-leverage`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `dan-koe-multipassionate-mastery`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `dan-martell-business-scaling`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `dan-wang-literary-analysis`: source_ledger, named_entity_floor, workflow_contracts
...
- `daniel-priestley-oversubscribed`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `david-mcraney-belief-change`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `diandra-escobar-linkedin-growth`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `erica-mallet-brand-magnetism`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `extract-mastery`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `fantastic-posters`: anti_patterns_sourced, verbatim_exemplars, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
- `fareed-zakaria-writing-mastery`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `ghostwriting-voice-engine`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `harry-dry-copywriting`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `jasmin-alic-linkedin-growth`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `jason-fladlien-marketing`: recognition_test, source_ledger, workflow_contracts
...
- `jeremy-haynes-mindset-systems`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `joshua-smith-real-estate`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `lara-acosta-linkedin-growth`: recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `lara-acosta-linkedin-mastery`: anti_patterns_sourced, source_ledger, named_entity_floor, workflow_contracts
...
- `lindsay-ai-consulting`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `luke-iha-copy-blocks`: anti_patterns_sourced, source_ledger, named_entity_floor, workflow_contracts **[capped A→B]**
...
- `luke-iha-proof-mechanisms`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `luke-iha-unaware-ads`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `luke-iha-vicious-hooks`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts **[capped A→B]**
...
- `made-to-stick-messaging`: anti_patterns_sourced, recognition_test, named_entity_floor, workflow_contracts
...
- `mark-kashef-agent-orchestration`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `mark-kashef-ai-councils`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `mark-kashef-banana-squad`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `mark-kashef-claude-claw`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `mark-kashef-visual-design`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `nate-b-jones-context-engineering`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `nick-saraev-agentic-workflows`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `nicolas-cole-client-acquisition`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
- `nicolas-cole-digital-products`: anti_patterns_sourced, source_ledger, named_entity_floor, workflow_contracts
...
- `oscar-hoglund-sound-storytelling`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `paul-james-ai-automation`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `pj-accetturo-ai-video`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `prediction-market-weather-trading`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `rachel-woods-ai-operations`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `sabrina-ramonov-ai-monetization`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
- `sam-goddard-media-scaling`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `seena-rez-tiktok-commerce`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `sherwin-wu-ai-engineering`: anti_patterns_sourced, recognition_test, workflow_contracts
...
- `soowei-consulting-leverage`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `stockton-walbeck-lead-magnets`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
- `thrivecart-digital-products`: anti_patterns_sourced, recognition_test, source_ledger, named_entity_floor, workflow_contracts
...
- `tobias-allen-marketing-mastery`: anti_patterns_sourced, recognition_test, source_ledger, workflow_contracts
...
| `chief-of-staff-os` | 4 | ✓ | 4 (avg 7.25) |  | 4 traces, avg 7.25 |
...
| `jason-fladlien-marketing` | 30 | ✓ | 1 (avg 7.25) | ✓ | 1 traces, avg 7.25 |
...
| `voice-os` | 0 |  | 1 (avg 7.25) | ✓ | minimal structure but used — enrich with genius.md/workflows |
...
Machine-readable records: `evolution_store/skill_audit_2026-07-09.jsonl`
