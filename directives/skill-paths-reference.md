# Skill File Paths Reference

> **Purpose**: Quick lookup table mapping experts to their skill file paths. Load on-demand when you need to find the right prompt file for an expert.
> **Referenced from**: agent-loading-protocol.md
...
| Jason Fladlien | skills/jason-fladlien-marketing/SKILL.md | .../references/genius-patterns.md | .../prompts/success-by-subtraction.md |
...
| Tyler Denk | skills/tyler-denk-audience-monetization/SKILL.md | .../references/genius-patterns.md | .../prompts/bde-tease-drop-trap-sequence.md |
| Tao Prompts | skills/tao-prompts-ai-video/SKILL.md | .../references/genius-patterns.md | .../prompts/cinematic-scene-architect.md |
| Nate Herk | skills/nate-herk-client-acquisition/SKILL.md | .../references/genius-patterns.md | .../prompts/trojan-horse-pitch-generator.md |
| Lara Acosta | skills/lara-acosta-linkedin-growth/SKILL.md | .../references/genius-patterns.md | .../prompts/slay-post-generator.md |
| Lara Acosta (Tech) | skills/lara-acosta-content-system/SKILL.md | .../references/genius-patterns.md | .../prompts/4-3-2-1-content-matrix.md |
| Jasmin Alic | skills/jasmin-alic-linkedin-growth/SKILL.md | .../references/genius-patterns.md | .../prompts/trapdoor-hook-writer.md |
| April Dunford | skills/april-dunford-positioning/SKILL.md | .../references/genius-patterns.md | .../prompts/positioning-canvas.md |
| Sabrina Ramonov | skills/sabrina-ramonov-ai-monetization/SKILL.md | .../references/genius-patterns.md | Various |
| Jonathan Courtney | skills/jonathan-courtney-marketing/SKILL.md | .../references/genius-patterns.md | Various |
| Sherwin Wu | skills/sherwin-wu-ai-engineering/SKILL.md | .../references/genius-patterns.md | Various |
| Marc Andreessen | skills/marc-andreessen-ai-thesis/SKILL.md | .../references/genius-patterns.md | Various |
