# ARCHIVE — CLAUDE.md pre-diet full text (cut 2026-07-28)

> Replaced by the six-shifts diet (docs/solutions/2026-07-28-claude5-context-rules-six-shifts.md).
> 3,672 words → 1,601. Nothing here is lost: this is the verbatim pre-diet file; git checkpoint 32965d24b.
> Restore any passage by copying it back. Sibling constitutions (GEMINI.md, AGENTS.md) keep their own wording.
