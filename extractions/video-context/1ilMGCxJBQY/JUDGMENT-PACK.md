# Kallaway Micro-Fame Judgment Pack
...
- Full English caption acquisition and clean transcript.
- Timestamped segment file and raw VTT.
- Scene-aware visual pass across 100 selected frames, all inspected.
- Spoken/visual/inferred evidence ledger.
...
1. [`JUDGMENT-CARD.md`](JUDGMENT-CARD.md): the accept/modify/reject surface.
2. [`MASTERY-EXTRACTION.md`](MASTERY-EXTRACTION.md): the complete source mastery report.
3. [`SYSTEM-FIT-AND-DELTA.md`](SYSTEM-FIT-AND-DELTA.md): what is new, duplicate, parked, and promotable.
4. [`BEHAVIOR-PROOF.md`](BEHAVIOR-PROOF.md): whether the extension changes a real decision.
5. [`BORN-V2-PROMPTS.md`](BORN-V2-PROMPTS.md): the proposed reusable command surfaces.
6. [`SKILL-SYSTEM-CONTRACT.md`](SKILL-SYSTEM-CONTRACT.md) and [`CANDIDATE-WORKFLOW.md`](CANDIDATE-WORKFLOW.md): implementation contract after approval.
7. [`video-context-ledger.md`](video-context-ledger.md), [`frame-notes.md`](frame-notes.md), and [`uncertainty-report.md`](uncertainty-report.md): proof and limits.

## Proof states

| State | What it means here |
|---|---|
| Direct source evidence | Directly present in captions or inspected frames |
| SELF-REPORTED | Creator-reported performance or client outcome; not independently verified |
| VISUALLY VERIFIED | The title, card, or interface appeared in the video; efficacy is not established |
| BOUNDED INFERENCE | A synthesis supported by identified source rows but not directly stated as a formal rule |
| UNTESTED | A candidate operating decision awaiting live evidence |
...
**We are wrong if:** the seven-axis scan and separate bucket scorecards fail to change any decision on frozen cases, or the prior Growth Blueprint owner already covers these mechanics at equal depth.
