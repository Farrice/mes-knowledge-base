...
- **Writing Depth Layer — Deepen a Draft** — `skills/writing-depth-layer/references/prompts-v2/deepen-a-draft.md`
- **Depth Audit: [draft name / first line]** — `skills/writing-depth-layer/references/prompts-v2/depth-audit.md`
- **Depth Gate: [draft name / first line]** — `skills/writing-depth-layer/references/prompts-v2/depth-gate.md`
- **Writing Depth Layer — Depth Inject** — `skills/writing-depth-layer/references/prompts-v2/depth-inject.md`
- **Writing Depth Layer — Depth Line** — `skills/writing-depth-layer/references/prompts-v2/depth-line.md`
- **Writing Depth Layer — Depth Stack** — `skills/writing-depth-layer/references/prompts-v2/depth-stack.md`
- **Writing Depth Layer — Depth Voice** — `skills/writing-depth-layer/references/prompts-v2/depth-voice.md`
