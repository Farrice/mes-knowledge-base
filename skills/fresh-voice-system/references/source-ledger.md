...
| `_active/linkedin-launch/04-content-os/arcs/` (Key References, "Active Arcs") | VERIFIED (pointer exists) | same path | Directory exists, contains `00-transition`. |
