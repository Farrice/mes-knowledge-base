...
|---|---|---|---|
| "Here are 5 ways to improve your decision-making..." / "In today's fast-paced business environment..." / "Leadership isn't about having all the answers..." | `_active/linkedin/04-deliverables/content-os/voice-captures/genspark-20-post-serial-arc.md` | Post 3 "The Expensive Mistake" (source lines ~59-61) | VERIFIED |
...
| Primary source commit/date (2026-03-10, `4da54d14e`) | git history | `git log --follow -- _active/linkedin/04-deliverables/content-os/voice-captures/genspark-20-post-serial-arc.md` | VERIFIED |
...
| `_active/linkedin/04-deliverables/content-os/arcs/` exists | filesystem | `ls _active/linkedin/04-deliverables/content-os/arcs/` | VERIFIED |
