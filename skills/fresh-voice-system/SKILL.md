...
| Active Arcs | `_active/linkedin-launch/04-content-os/arcs/` | Current narrative arc plans and chapters |
...
- **Arc: [Arc Name] — Bridge: [Working Title]** — `skills/fresh-voice-system/references/prompts-v2/bridge-post.md`
- **Arc: [Arc Name]** — `skills/fresh-voice-system/references/prompts-v2/narrative-arc-plan.md`
- **Arc: [Arc Name] — Chapter [N]: [Working Title]** — `skills/fresh-voice-system/references/prompts-v2/serial-chapter-posts.md`
