...
| 12 | [Silent Storytelling Production Suite](workflows/silent-storytelling-production-suite.md) | High-Retention Short-Form Script & Storyboard | Creating emotional short-form video without dialogue |
| 13 | [Multi-Format Repurposing Engine](workflows/multi-format-repurposing-engine.md) | 7-Day Content Distribution Plan | Converting one high-effort asset into 7 derivatives |

### Brand System Workflows
| # | Workflow | Produces | Use When |
|---|---------|----------|----------|
| 14 | [Personal Brand Playbook Generator](workflows/personal-brand-playbook.md) | Complete end-to-end brand operating playbook | A creator needs everything in one document |
| 15 | [Brand Book Generator](workflows/brand-book-generator.md) | Visual + verbal brand identity guide | Building a professional brand identity system |
| 16 | [Personal Brand Architecture Roadmap](workflows/personal-brand-architecture-roadmap.md) | Creator Vision Strategy & Content Calendar | Setting up or pivoting a personal brand |
...
8. **Need several foundational origin stories?** → `multi-origin-story-architect`
9. **Need everything in one doc?** → `personal-brand-playbook`
10. **Need visual brand identity?** → `brand-book-generator`
11. **Need full marketing system?** → `content-marketing-playbook`
12. **Making short-form video?** → `silent-storytelling-production-suite`
13. **Repurposing one asset?** → `multi-format-repurposing-engine`
