...
> Source: [google-gemini/gemini-skills](https://github.com/google-gemini/gemini-skills) — Official Google Gemini team
...
## Related
- **Skill**: `logan-kilpatrick-ai-studio` (AI Studio workflows, vibe coding)
- **Execution**: `execution/parallel_swarm.py` (uses Gemini API for agent swarm)
- **Source**: [google-gemini/gemini-skills](https://github.com/google-gemini/gemini-skills)
...
- **Gemini API Engineer — Integration Debug via Discovery Spec** — `skills/gemini-api-dev/references/prompts-v2/api-integration-debug.md`
- **Gemini API Engineer — Feature Integration Build** — `skills/gemini-api-dev/references/prompts-v2/gemini-integration-build.md`
- **Gemini API Engineer — Legacy SDK & Model Migration** — `skills/gemini-api-dev/references/prompts-v2/sdk-model-migration.md`
