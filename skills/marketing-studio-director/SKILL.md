...
- **Marketing Studio Director — Hyper Motion Ad Prompt** — `skills/marketing-studio-director/references/prompts-v2/hyper-motion-ad-prompt.md`
- **Marketing Studio Director — Pro Virtual Try On Prompt** — `skills/marketing-studio-director/references/prompts-v2/pro-virtual-try-on-prompt.md`
- **Marketing Studio Director — Product Review Ad Prompt** — `skills/marketing-studio-director/references/prompts-v2/product-review-ad-prompt.md`
- **Marketing Studio Director — Tutorial Ad Prompt** — `skills/marketing-studio-director/references/prompts-v2/tutorial-ad-prompt.md`
- **Marketing Studio Director — TV Spot Ad Prompt** — `skills/marketing-studio-director/references/prompts-v2/tv-spot-ad-prompt.md`
- **Marketing Studio Director — UGC Ad Prompt** — `skills/marketing-studio-director/references/prompts-v2/ugc-ad-prompt.md`
- **Marketing Studio Director — UGC Virtual Try On Prompt** — `skills/marketing-studio-director/references/prompts-v2/ugc-virtual-try-on-prompt.md`
- **Marketing Studio Director — Unboxing Ad Prompt** — `skills/marketing-studio-director/references/prompts-v2/unboxing-ad-prompt.md`
- **Marketing Studio Director — Wild Card Ad Prompt** — `skills/marketing-studio-director/references/prompts-v2/wild-card-ad-prompt.md`
