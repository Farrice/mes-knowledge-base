...
- **Keyword Intent Audit — [Niche/Entity]** — `skills/market_intelligence/references/prompts-v2/keyword-intent-audit.md`
- **Strategic IQ Brief: [Niche Name]** — `skills/market_intelligence/references/prompts-v2/strategic-iq-brief.md`
- **Trend Hunt Scan — [Niche/Seed Topic]** — `skills/market_intelligence/references/prompts-v2/trend-hunt-scan.md`
