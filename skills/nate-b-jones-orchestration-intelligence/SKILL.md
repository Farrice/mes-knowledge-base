...
- **Bloat-to-Depth Optimization Report — [SYSTEM]** — `skills/nate-b-jones-orchestration-intelligence/references/prompts-v2/bloat-to-depth-optimizer.md`
- **Domain Verifiability Map — [DOMAIN]** — `skills/nate-b-jones-orchestration-intelligence/references/prompts-v2/domain-verifiability-mapper.md`
- **Harness Design Audit — [AGENT(S)]** — `skills/nate-b-jones-orchestration-intelligence/references/prompts-v2/harness-design-audit.md`
- **Orchestration Architecture Blueprint — [OBJECTIVE]** — `skills/nate-b-jones-orchestration-intelligence/references/prompts-v2/orchestration-architecture-blueprint.md`
- **Orchestration Telemetry Feedback Design — [SYSTEM]** — `skills/nate-b-jones-orchestration-intelligence/references/prompts-v2/orchestration-telemetry-feedback.md`
- **Sniff-Check Protocol — [DOMAIN / WORK TYPE]** — `skills/nate-b-jones-orchestration-intelligence/references/prompts-v2/sniff-check-protocol-builder.md`
- **Worker Isolation + Merge Infrastructure Design — [SYSTEM]** — `skills/nate-b-jones-orchestration-intelligence/references/prompts-v2/worker-isolation-merge-design.md`
