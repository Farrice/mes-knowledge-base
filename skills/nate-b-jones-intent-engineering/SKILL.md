...
- **Agent Reliability Architect** — `skills/nate-b-jones-intent-engineering/references/prompts-v2/agent-reliability-architect.md`
- **Context Transfer Protocol** — `skills/nate-b-jones-intent-engineering/references/prompts-v2/context-transfer-protocol.md`
- **Disambiguation Protocol** — `skills/nate-b-jones-intent-engineering/references/prompts-v2/disambiguation-protocol.md`
- **Guardrails Extractor** — `skills/nate-b-jones-intent-engineering/references/prompts-v2/guardrails-extractor.md`
- **Intent Document Generator** — `skills/nate-b-jones-intent-engineering/references/prompts-v2/intent-document-generator.md`
- **Intent Gap Analyzer** — `skills/nate-b-jones-intent-engineering/references/prompts-v2/intent-gap-analyzer.md`
- **Prompt Surgery Protocol** — `skills/nate-b-jones-intent-engineering/references/prompts-v2/prompt-surgery-protocol.md`
