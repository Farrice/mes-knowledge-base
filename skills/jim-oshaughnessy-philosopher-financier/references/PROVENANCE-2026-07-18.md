...
| "codex-harvest... downstream copies, not an independent source" | `_active/harness/codex-harvest-2026-06-11/agents/jim-oshaughnessy/`, `_active/harness/codex-harvest-2026-06-11/research_outputs/ai_authority_architect_agents/jim_oshaughnessy.md` | `grep -rli oshaughnessy _active/harness/codex-harvest-2026-06-11/`; files inspected are duplicates/mirrors of this repo's own existing agent+skill content, not an independently sourced transcript |
