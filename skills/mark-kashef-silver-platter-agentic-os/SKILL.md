...
- **Mark Kashef Silver Platter — 30-Day Build Plan** — `skills/mark-kashef-silver-platter-agentic-os/references/prompts-v2/build-plan.md`
- **Business** — `skills/mark-kashef-silver-platter-agentic-os/references/prompts-v2/builder-handoff.md`
- **Mark Kashef Silver Platter — Business Data Map Assembly** — `skills/mark-kashef-silver-platter-agentic-os/references/prompts-v2/data-map-assembly.md`
- **Mark Kashef Silver Platter — Existing Setup Gap Audit** — `skills/mark-kashef-silver-platter-agentic-os/references/prompts-v2/existing-setup-audit.md`
- **Opportunities — [business name]** — `skills/mark-kashef-silver-platter-agentic-os/references/prompts-v2/opportunities-brief.md`
- **Mark Kashef Silver Platter — Recipe Card Design** — `skills/mark-kashef-silver-platter-agentic-os/references/prompts-v2/recipe-card-design.md`
