# Provenance — daniel-priestley-24-assets-os repair

| Anchor in genius.md | Source file + location | Status |
|---|---|---|
| "$1,500 per hour, 24 hours a day, 365 days a year..." | `extractions/daniel-priestley-sll-engine/transcript.txt` lines 44-46, [00:02] | VERIFIED — read and matched verbatim |
| "seven startups that have gone zero to a million..." | `extractions/daniel-priestley-sll-engine/transcript.txt` lines 57-60, [00:28]-[00:33] | VERIFIED |
...
No claim in the repaired `genius.md` cites a quote that could not be located in an actual file. Where the primary book text was unavailable, the claim is labeled LIKELY in the ledger rather than presented as verified.
