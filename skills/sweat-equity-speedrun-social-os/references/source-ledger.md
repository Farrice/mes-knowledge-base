...
| A brand named "Malbon" ran a house/golf activation using a payphone, cold plunge, bird watching, cigars, and Masters-tradition references | VERIFIED (source-attributed) | CORRECTED 2026-07-18 by Opus adversarial verify: source EXISTS at `_active/codex-harvest-2026-06-11/extractions/sweat-equity-speedrun-social-os/` (result-claims.md 1,515 bytes + extraction-brief.md 2,373 bytes naming "the Sweat Equity Malbon Home case study" and the "Letters From Augusta" payphone setup). Original repair pass searched only the archive tarball + root extractions/ — a false absence, carded as shape 3. |
