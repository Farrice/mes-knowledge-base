...
- **Prediction Market Risk Manager — Kill Switch Incident Response & Post-Mortem** — `skills/prediction-market-risk-management/references/prompts-v2/kill-switch-incident-response.md`
- **Prediction Market Risk Manager — Kill Switch System Design** — `skills/prediction-market-risk-management/references/prompts-v2/kill-switch-system-design.md`
- **Prediction Market Risk Manager — Kill Switch Test & Threshold Audit** — `skills/prediction-market-risk-management/references/prompts-v2/kill-switch-test-audit.md`
- **Prediction Market Risk Manager — Portfolio Risk Audit** — `skills/prediction-market-risk-management/references/prompts-v2/portfolio-risk-audit.md`
- **Prediction Market Risk Manager — Position Sizing Calculator** — `skills/prediction-market-risk-management/references/prompts-v2/position-sizing-calculator.md`
