...
name: "Personal Brand Blueprint"
produces: "90-Day Authority Growth Strategy"
...
**Before executing**: Internalize the 17 Genius Patterns. Every output must pass the "Position Before Content" and "Dual-Persona" filters.
...
*Objective: Unearth the "Authority Triggers" that make your positioning undeniable.*

1.  **Excavate Hidden Proof**: Scan the input for the six categories of proof:
    - **Outcome Proof**: Specific numbers ($ revenue, % growth, time saved).
...
*Objective: Define the "Identity Statement" that makes you the only logical choice.*

1.  **The Identity Layer**: Create a one-sentence descriptor: "I am the [Specific Descriptor] who [Unique Approach]."
2.  **The ICP/IFP Elevator Pitch**: Write a pitch that serves both the **Ideal Customer Profile** (who pays) and the **Ideal Friend Profile** (who shares): "I help [WHO] achieve [WHAT] through [HOW] so they can [OUTCOME]."
3.  **The Unfair Advantage Map**: Identify 3-5 traits/experiences that no competitor can replicate.
4.  **The Authority Bio**: Draft a 3-5 sentence bio using the **Authority Trigger Stack** (specific numbers and named logos only).

### Phase 3: Content Pillar Excavation (The 3-Territory Framework)
*Objective: Map out 45+ topics using the "Do/Believe/Enable" methodology.*

1.  **Pillar 1: What You DO (Methodology)**: The tactical "how-to." Focus on frameworks and processes. (15 Topics)
2.  **Pillar 2: What You BELIEVE (Philosophy)**: Contrarian takes and industry critiques. This builds the "IFP" (amplifier) audience. (15 Topics)
3.  **Pillar 3: What You ENABLE (Transformation)**: Success stories and "before/after" narratives using the **SLAY Framework** (Story, Lesson, Application, Your Turn). (15 Topics)
4.  **The 4-3-2-1 Ratio Application**: Assign each topic a type: Educational (4), Story (3), Opinion (2), or Promotional (1).

### Phase 4: The 90-Day Zero-to-Authority Roadmap
*Objective: A week-by-week execution plan to move from obscurity to authority.*

1.  **Days 1-30: Foundation**: Profile optimization, building the 30-post buffer, and "First-Principle Hook Testing."
2.  **Days 31-60: Momentum**: Implementing the daily engagement strategy, launching the first "Viral Lead Magnet" (designed to be shared, not just gated), and connection building.
...
2.  **Proof Inventory**: Categorized table of credibility markers with strength ratings.
