...
- **Mark Kashef — Agent SDK Bridge Architect** — `skills/mark-kashef-claude-claw/references/prompts-v2/bridge-architect.md`
- **Mark Kashef — 3-Layer Memory System Designer** — `skills/mark-kashef-claude-claw/references/prompts-v2/memory-system-designer.md`
