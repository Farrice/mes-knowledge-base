...
- **Dr. Kriukow — AI Humanization Pass** — `skills/dr-kriukow-humanization/references/prompts-v2/ai-humanization-pass.md`
- **Dr. Kriukow — Meaning Extraction Rewriter** — `skills/dr-kriukow-humanization/references/prompts-v2/meaning-extraction-rewriter.md`
- **Dr. Kriukow — Structural Predictability Audit** — `skills/dr-kriukow-humanization/references/prompts-v2/structural-predictability-audit.md`
- **Dr. Kriukow — Writing Style Humanizer Config** — `skills/dr-kriukow-humanization/references/prompts-v2/writing-style-humanizer-config.md`
