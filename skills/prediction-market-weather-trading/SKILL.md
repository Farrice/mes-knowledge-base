...
- **Weatherbot System — Market Scan & Edge Detection** — `skills/prediction-market-weather-trading/references/prompts-v2/market-scan-edge-detection.md`
- **Weatherbot System — Self-Calibration Review** — `skills/prediction-market-weather-trading/references/prompts-v2/self-calibration-review.md`
- **Weatherbot System — Trade Execution Blueprint** — `skills/prediction-market-weather-trading/references/prompts-v2/trade-execution-blueprint.md`
