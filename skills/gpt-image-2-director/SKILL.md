...
- **GPT Image 2.0 Director — Cinematic Prose Scene Prompt** — `skills/gpt-image-2-director/references/prompts-v2/cinematic-prose-scene-prompt.md`
- **GPT Image 2.0 Director — Auto-Derive Meta-Prompt** — `skills/gpt-image-2-director/references/prompts-v2/meta-prompt-concept-poster.md`
- **GPT Image 2.0 Director — Structured JSON Layout Prompt** — `skills/gpt-image-2-director/references/prompts-v2/structured-json-layout-prompt.md`
