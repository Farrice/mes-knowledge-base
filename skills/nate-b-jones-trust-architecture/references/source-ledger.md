...
| 8 | `_active/harness/claude-export/harvest/*.json` (census/plan files) | Harvest metadata | — | Grepped for "nate b jones" / "trust architecture" — 4 filename hits, all generic census/plan JSON with no conversation content — not a content source |
