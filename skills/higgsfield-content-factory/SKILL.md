...
> **Routing (added on import).** Higgsfield is RETIRED for people-generation in this
> system (standing decision — people work routes to fal-people via skills/video-studio).
> This skill is kept for its 5-format UGC pipeline patterns and prompt structures;
> port execution to the fal stack rather than reviving Higgsfield MCP spend.
