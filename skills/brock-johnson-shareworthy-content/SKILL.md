...
**Unique Value**: A systematic share-trigger framework plus a primary-source Say–Do–Need bridge that turns audience desire into honest, useful content without bait-and-switch delivery. Performance ratios and biographical authority claims remain source-labeled in `references/source-ledger.md`.
...
| bridge | [Say–Do–Need Message Bridge](workflows/say-do-need-message-bridge.md) | An evidence-tagged message map plus content or offer concepts that attract with stated desire and deliver the deeper needed result | People say they want one thing, their behavior selects another, and your best judgment says they need something less immediately attractive. |

## Quick Reference
- **Genius Context**: [genius.md](genius.md) — load before any workflow
- **Primary Source Package**: `extractions/video-context/MX-Emk6vkE4/` — 2026-08-27 transcript-backed video; frames/OCR unavailable
