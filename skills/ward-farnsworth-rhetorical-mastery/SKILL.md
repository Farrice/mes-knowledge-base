...
- **Prompt Library**: [references/prompts/](references/prompts/) — 4 crown-jewel practitioner prompts (mirrored in [references/_legacy-prompts/](references/_legacy-prompts/); searchable via `python3 execution/prompt_library.py search "<topic>"`).
...
- **Ward Farnsworth — The Chiasmus Reversal** — `skills/ward-farnsworth-rhetorical-mastery/references/prompts-v2/chiasmus-reversal-engine.md`
- **Ward Farnsworth — The Epistrophe Echo** — `skills/ward-farnsworth-rhetorical-mastery/references/prompts-v2/epistrophe-echo-generator.md`
- **Ward Farnsworth — The Saxon Punch Closer** — `skills/ward-farnsworth-rhetorical-mastery/references/prompts-v2/saxon-punch-closer.md`
- **Ward Farnsworth — The \** — `skills/ward-farnsworth-rhetorical-mastery/references/prompts-v2/two-languages-transmitter.md`
