# Dan Koe - Multipassionate Mastery — Genius Context
...
### Pattern 1: The Inversion Principle
...
### Tacit Expertise Made Explicit

1. **Translation beats creation**: Great content restructures existing ideas rather than inventing new ones

2. **Energy reveals truth**: Pay attention to what energizes you in consumption—that's your creation direction

3. **Authenticity requires identity work**: "Be yourself" is useless advice without knowing who that self is

4. **Audience ownership through participation**: Involve them in building your ideas (IKEA effect)

5. **Cringe phases are progress markers**: Embarrassment at past work proves evolution

6. **Systems beat goals for creators**: Process orientation prevents creative burnout
...
## LinkedIn source extension — September 2026

For reference-to-post production, load [the bounded source method](references/linkedin-source-method.md). The new delta is angle-before-caption, caption adds rather than repeats, small taste-selected swipe files, relative breakout caution, saved guide plus fresh context, and substantive manual distribution. Do not re-load the entire historical prompt collection. Evidence, observed demos and source-specific limitations live in [the extraction](../../extractions/video-context/MqjmPknAvuw/deep-extraction.md). No new beginner-growth or revenue guarantee is implied.
