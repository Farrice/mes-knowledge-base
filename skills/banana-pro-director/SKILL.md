...
See the Mode 0 section below. Tool fork: Banana Pro single-pass (default), GPT-2 single-pass (highest fidelity, higher credits, chest-up only), or Soul Cinema two-pass (cheap iteration — Soul Cinema face plate then Banana Pro 3:4 lock). All paths use mid-gray seamless (the locked default backdrop — white only on explicit request), flat shadowless lighting (the locked grade), and a locked baseline wardrobe (plain black camisole for women, plain black ribbed tank for men). Produces the canonical reference image. Run once per new character.
...
**Goal:** Produce the canonical face reference for the character. Identity only — no outfit considerations beyond a locked neutral baseline top, no environment, no posing direction. Just: a clean, locked face on the locked 18% gray seamless with flat shadowless lighting that makes the skin read matte and cinema-placement-ready.
...
- **Backdrop:** mid-gray seamless studio (locked default)
- **Lighting:** flat shadowless (locked grade — matched fill, no key side)
...
- **Backdrop:** mid-gray seamless studio (locked default)
- **Lighting:** flat shadowless (locked grade — matching Step 0.1)
- **Framing:** 3:4 headshot, forehead to upper chest, face filling most of the frame
...
- **Backdrop:** mid-gray seamless studio (locked default)
- **Lighting:** flat shadowless studio lighting (locked grade)
