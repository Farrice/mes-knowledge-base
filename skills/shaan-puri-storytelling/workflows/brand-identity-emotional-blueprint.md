...
- **[CORE OFFERING]**: What you actually sell/do (the "boring" version).
...
1.  **Voice Profile**: Define the tone, vocabulary, and "Taboos" (words/topics this brand would never touch).
2.  **Signature Phrases**: Generate 5-10 "ownable" phrases that embody the Tiger Reframe.
3.  **The Consistency Audit**: Create a 7-item "Yes/No" checklist to gate all future content. (e.g., "Does this give the reader 'Opinion Ammunition' they can use at dinner tonight?")
4.  **Touchpoint Mapping**: Briefly explain how the Signature Feeling manifests in:
