---
name: "Shaan Puri - Email Sequence Story Architect"
source_prompt: "skills/shaan-puri-storytelling/references/prompts/11-email-sequence-architect.md"
skill: shaan-puri-storytelling
standard: structure-pure-v2
refactored: 2026-07-11
---

# SHAAN PURI - EMAIL SEQUENCE STORY ARCHITECT
## Structure Email Campaigns with Nested Story Persuasion
...
- **[OFFER/PRODUCT]**: What's being sold at the end
...
**Objection Mapping**
| Objection | Handled In |
|---|---|
| [objection 1] | Email [#] |
| [objection 2] | Email [#] |

**Subject Lines (full list)**
1. [Email 1 subject]
2. [Email 2 subject]
...
```
...
*Prompt #11 of 16 | Shaan Puri Storytelling Mastery*
