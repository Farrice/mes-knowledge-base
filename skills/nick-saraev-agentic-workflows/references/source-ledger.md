...
| `_active/harness/codex-harvest-2026-06-11/agents/nick-saraev/AGENT.md` | — | Codex-harvested persona description; no citations of its own |
| `_active/claude-export/` | — | Harvest index/state files present (`index.json`, `triage/*.json`, `INDEX.md`); no file matching "saraev" by name; no content match for the claimed 2026-07-01 export |
