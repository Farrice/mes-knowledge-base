...
- **Mark Kashef — Wargame Portfolio Batch** — `skills/mark-kashef-wargame-os/references/prompts-v2/wargame-batch.md`
- **Mark Kashef — Mission Brief** — `skills/mark-kashef-wargame-os/references/prompts-v2/wargame-brief.md`
- **Client Wargame — [client] — [deliverable-slug]** — `skills/mark-kashef-wargame-os/references/prompts-v2/wargame-client.md`
- **Execution Closure — [mission] — NN-[name]** — `skills/mark-kashef-wargame-os/references/prompts-v2/wargame-execute.md`
- **Wargame — [mission] — NN-[slug] — tailored for [NAMED EXECUTOR]** — `skills/mark-kashef-wargame-os/references/prompts-v2/wargame-executor-fit.md`
- **Wargame Grade — [mission] — cycle [N]** — `skills/mark-kashef-wargame-os/references/prompts-v2/wargame-grade.md`
- **Mark Kashef — Mission Pre-Flight Offer** — `skills/mark-kashef-wargame-os/references/prompts-v2/wargame-mission.md`
- **Mark Kashef — Wargame Order** — `skills/mark-kashef-wargame-os/references/prompts-v2/wargame-order.md`
- **Recon Dossier — [mission name]** — `skills/mark-kashef-wargame-os/references/prompts-v2/wargame-recon.md`
- **Wargame — [mission name] — NN-[slug]** — `skills/mark-kashef-wargame-os/references/prompts-v2/wargame-run.md`
