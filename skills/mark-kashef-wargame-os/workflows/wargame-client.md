...
- The client's own CLAUDE.md (e.g. `_active/jen-listings/CLAUDE.md`, `projects/andrea-dj/CLAUDE.md`) — the frozen-choice source: voice rules and format contracts, read in full before any freeze decision
...
6. **Store the DONE wargame under the client project**, not `.agent/missions/` — e.g. `_active/jen-listings/wargames/<deliverable-slug>.md`, `projects/andrea-dj/wargames/<deliverable-slug>.md`. Client-owned artifacts live with client context, since they outlive any single mission session.
...
| **Event/ops route** (Andrea/Resonance) | Client CLAUDE.md + Ticket Tailor/venue constraints | `projects/andrea-dj/wargames/` |
