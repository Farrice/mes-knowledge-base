...
- `skills/mike-taylor-synthetic-research/`: the deep source behind TRIAGE mode — research design, the grounding ladder (now four rungs: cold-generated, social-grounded, transcript-grounded, calibrated), distribution-vs-individual accuracy discipline, and the multi-question research-budget triage this front door doesn't attempt. Optional depth, not a required step: reach for it when TRIAGE needs grounding-tier discipline (real transcripts exist — `/mt-persona-grounding`; no transcripts but a live-market read is worth more than cold generation — same workflow's Tier 2.5 social-listening gap-fill), latent-demand discovery (`/mt-latent-demand-mining`), or a full research-budget routing decision (`/mt-synthetic-vs-real-decision`) rather than a 5-minute artifact check.

## Lineage

COUNCIL mode combines Pattern 6 (Woods) and the Haynes×Woods stakeholder handshake, the dissent-preserving machinery. TRIAGE mode is Mike Taylor's synthetic-customer process (co-author, O'Reilly *Prompt Engineering for Generative AI*; Marketing Against the Grain, "This AI Prompt Gets You Customer Insights in 5 Minutes," YouTube `2f7pUdn1miE`; Recall `ce789f0b-9c63-4775-b0b7-c44edad29e23`, saved 2025-09-03), one of Farrice's highest-return processes. Deep source, forged 2026-07-19: `skills/mike-taylor-synthetic-research/` (17 genius patterns, 7 workflows) — this front door stays the fast operational mechanic; that skill is where the research-design theory underneath it lives.
