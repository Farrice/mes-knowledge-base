...
- **Omar Eltakrori — Belief-Shift Map** — `skills/omar-eltakrori/references/prompts-v2/belief-shift-map.md`
- **Omar Eltakrori — 5-Day Challenge Launch Plan** — `skills/omar-eltakrori/references/prompts-v2/challenge-launch-plan.md`
- **Omar Eltakrori — Client Rolodex to Named Framework** — `skills/omar-eltakrori/references/prompts-v2/client-rolodex-framework.md`
- **Omar Eltakrori — 8-Buyables Offer Audit** — `skills/omar-eltakrori/references/prompts-v2/eight-buyables-audit.md`
- **Omar Eltakrori — Felt-Need Title Bank** — `skills/omar-eltakrori/references/prompts-v2/felt-need-title-bank.md`
- **Omar Eltakrori — Long-Form Authority + Ascension Ladder** — `skills/omar-eltakrori/references/prompts-v2/long-form-authority-ladder.md`
- **Omar Eltakrori — Micro-Famous KLT Plan** — `skills/omar-eltakrori/references/prompts-v2/micro-famous-klt-plan.md`
- **Omar Eltakrori — Mindset-Over-Tactics Wrap** — `skills/omar-eltakrori/references/prompts-v2/mindset-over-tactics-wrap.md`
- **Omar Eltakrori — Objective-by-Context Matrix** — `skills/omar-eltakrori/references/prompts-v2/objective-by-context-matrix.md`
- **Omar Eltakrori — Offer Packaging Pass** — `skills/omar-eltakrori/references/prompts-v2/offer-packaging-pass.md`
- **Omar Eltakrori — Over-Teaching Audit & Rewrite** — `skills/omar-eltakrori/references/prompts-v2/over-teaching-audit.md`
- **Omar Eltakrori — Personal Brand Business Blueprint** — `skills/omar-eltakrori/references/prompts-v2/personal-brand-business-blueprint.md`
- **Omar Eltakrori — Receptive-Soil Filter** — `skills/omar-eltakrori/references/prompts-v2/receptive-soil-filter.md`
- **Omar Eltakrori — Teach-to-Sell Asset** — `skills/omar-eltakrori/references/prompts-v2/teach-to-sell-asset.md`
- **Omar Eltakrori — Teaching Business Roadmap** — `skills/omar-eltakrori/references/prompts-v2/teaching-business-roadmap.md`
- **Omar Eltakrori — Uncopyable Content Bank** — `skills/omar-eltakrori/references/prompts-v2/uncopyable-content-bank.md`
- **Omar Eltakrori — What-Not-How Reframe** — `skills/omar-eltakrori/references/prompts-v2/what-not-how-reframe.md`
