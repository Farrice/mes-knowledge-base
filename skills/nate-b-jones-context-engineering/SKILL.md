...
- **Context Bloat Diagnostic — [TARGET SYSTEM]** — `skills/nate-b-jones-context-engineering/references/prompts-v2/context-bloat-diagnostic.md`
- **Context Compression Sprint — [TARGET SYSTEM]** — `skills/nate-b-jones-context-engineering/references/prompts-v2/context-compression-sprint.md`
- **Memory Crisis Strategic Intelligence Brief — [TARGET SYSTEM]** — `skills/nate-b-jones-context-engineering/references/prompts-v2/memory-crisis-strategic-intelligence.md`
- **Semantic Context Retrieval System — [TARGET SYSTEM]** — `skills/nate-b-jones-context-engineering/references/prompts-v2/semantic-context-retrieval-system.md`
- **Sovereign Memory Architecture Blueprint — [TARGET SYSTEM]** — `skills/nate-b-jones-context-engineering/references/prompts-v2/sovereign-memory-architecture-blueprint.md`
- **Tool Router Agent Blueprint — [TARGET SYSTEM]** — `skills/nate-b-jones-context-engineering/references/prompts-v2/tool-router-agent-blueprint.md`
