---
name: "Adam Enfroy — AI Content Production System (Scaled Workflow)"
source_prompt: "skills/adam-enfroy-affiliate-marketing/references/prompts/10-ai-content-system.md"
skill: adam-enfroy-affiliate-marketing
standard: structure-pure-v2
refactored: 2026-07-11
---

# Adam Enfroy — AI Content Production System (Scaled Workflow)
...
## Output Contract
- **Format**: Complete AI content production system — workflows, templates, and schedules, not a single article
- **Scope**: End-to-end system from setup through ongoing quality monitoring, deployable without further design work
- **Required elements**: AI workspace configuration with custom instructions and knowledge-base list; 5-step production workflow with exact reusable prompts; content-type templates (comparison, tutorial, informational at minimum); weekly production calendar matched to the stated volume target; quality-gate checklists with human-required steps explicitly marked; monthly quality-monitoring system with named red-flag triggers

## Output Skeleton
```
## AI Workspace Configuration
- Custom instructions block: [voice/credential frame, style rules, banned phrases, sentence/paragraph limits]
- Knowledge base uploads: [best existing articles, spec sheets, testing notes, competitor gap material, glossary]

## Production Workflow
Step 1 — Keyword → Brief: [reusable prompt template]
Step 2 — Brief → Draft: [reusable prompt template]
Step 3 — Humanization Pass (HUMAN REQUIRED): [checklist]
Step 4 — SEO & Formatting Pass: [reusable prompt template]
Step 5 — Final Quality Gate (HUMAN REQUIRED): [checklist table]

## Content Type Templates
- [Comparison post template]
- [How-to/tutorial template]
- [Informational/ideas template]

## Production Calendar
| Day | Activity | Output |
|-----|----------|--------|
[rows sized to the stated monthly volume target]

## Quality Monitoring
- Monthly audit checklist: [traffic check, bounce-rate comparison, voice-drift spot check, Search Console signal check, RPM comparison]
- Red flags: [named thresholds that trigger investigation, not a vague "watch quality"]
```

## Quality Gate
1. Custom-instructions block bans specific AI clichés/phrases by name — not a vague "sound human" instruction
2. Each of the 5 workflow steps includes either an exact reusable prompt or an explicit human-required checklist — no step is left undefined
3. Humanization Pass and Final Quality Gate are both marked HUMAN REQUIRED and cannot be delegated to AI
4. The production calendar's weekly output total matches the stated monthly volume target
5. Quality-monitoring red flags are named with a specific trigger condition, not a vague "watch quality"
