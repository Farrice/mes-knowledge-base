...
- **Full Assembly Orchestrator** — `skills/creative-assembly/references/prompts-v2/01-full-assembly-orchestrator.md`
- **Selection Assembly Orchestrator** — `skills/creative-assembly/references/prompts-v2/02-selection-assembly-orchestrator.md`
- **Editor Pass** — `skills/creative-assembly/references/prompts-v2/03-editor-pass.md`
