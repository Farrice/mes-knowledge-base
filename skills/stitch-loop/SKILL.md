...
- **Stitch Build Loop — Baton File Authoring** — `skills/stitch-loop/references/prompts-v2/baton-file-authoring.md`
- **Stitch Build Loop — Loop Iteration Execution** — `skills/stitch-loop/references/prompts-v2/loop-iteration-execution.md`
- **Project Vision & Constitution** — `skills/stitch-loop/references/prompts-v2/site-constitution-setup.md`
