...
- **Mark Kashef — Human Tollbooth Developer** — `skills/mark-kashef-agent-orchestration/references/prompts-v2/human-tollbooth-developer.md`
- **Mark Kashef — Hybrid Architect Pipeline** — `skills/mark-kashef-agent-orchestration/references/prompts-v2/hybrid-architect.md`
- **Mark Kashef — Parallel Synthesis Advisor** — `skills/mark-kashef-agent-orchestration/references/prompts-v2/parallel-synthesis-advisor.md`
- **Mark Kashef — Sequential Assembly Orchestrator** — `skills/mark-kashef-agent-orchestration/references/prompts-v2/sequential-assembly-orchestrator.md`
