...
- Pure agent coordination problems (use `nate-b-jones-orchestration-intelligence` instead)
- Agent specification / containment (use `nate-b-jones-agent-deployment-strategy`)
- Intent capture and disambiguation (use `nate-b-jones-intent-engineering`)
...
1. **Constraints over intelligence** — minimalism is the mechanism, not a limitation
2. **Traces over scores** — you cannot optimize what you cannot interpret
3. **Prerequisites before loops** — context, traces, eval, sandbox, governance or nothing
4. **Earn the right** — cheap-failure domains first, customer-facing last
5. **Human judgment concentrates** — framework design and program.md are higher-leverage than experiment execution
6. **Same-model pairing** — cross-model meta/task underperforms structurally
7. **Iteration rate, not hit rate** — 100 overnight beats 10 per day

## Load Order

1. Load `genius.md` (required — all patterns, hidden knowledge, exemplars, signature moves, quality rubric, anti-patterns)
2. Load specific workflow for task
3. Reference files in `references/` as needed per workflow
4. Cross-reference `nate-b-jones-orchestration-intelligence/genius.md` if designing self-optimizing orchestration
...
- **Auto-Improvement Readiness Audit — [System Name]** — `skills/nate-b-jones-auto-improvement-loops/references/prompts-v2/auto-improvement-readiness-audit.md`
- **Emergent Behavior Playbook — [System Name]** — `skills/nate-b-jones-auto-improvement-loops/references/prompts-v2/emergent-behavior-playbook.md`
- **4-Mode Safety Audit — [System Name]** — `skills/nate-b-jones-auto-improvement-loops/references/prompts-v2/four-mode-safety-audit.md`
- **Auto-Improvement Triplet — [System Name]** — `skills/nate-b-jones-auto-improvement-loops/references/prompts-v2/karpathy-triplet-design.md`
- **Local Hard Takeoff Deployment Plan — [System Name]** — `skills/nate-b-jones-auto-improvement-loops/references/prompts-v2/local-hard-takeoff-deployment-plan.md`
- **Auto-Improvement Architecture — [System Name]** — `skills/nate-b-jones-auto-improvement-loops/references/prompts-v2/meta-task-architecture-design.md`
- **Antigravity Phase 2 Karpathy Audit — [Date]** — `skills/nate-b-jones-auto-improvement-loops/references/prompts-v2/phase2-karpathy-audit.md`
- **Trace Infrastructure Blueprint — [System Name]** — `skills/nate-b-jones-auto-improvement-loops/references/prompts-v2/trace-infrastructure-blueprint.md`
