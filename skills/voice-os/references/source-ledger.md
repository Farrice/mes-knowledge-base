...
| `_active/farrice-brand/voice/REGISTER-ATLAS.md` | VERIFIED | Added 2026-08-04. Derived from 30,606 of Farrice's own sent messages (his side only, explicit grant), four relationship registers. The only voice source sampled off the clock — corrects the work-corpus sampling bias (4 humor markers in 50,825 work messages vs 4.9% at home). Raw corpora never committed. The v1.3 recompile must ingest it. |
