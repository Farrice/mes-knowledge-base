...
- **Nicolas Cole — Action Weight Test** — `skills/nicolas-cole-edan-writing-mechanics/references/prompts-v2/action-weight-test.md`
- **Nicolas Cole — Deliberate Practice Loop** — `skills/nicolas-cole-edan-writing-mechanics/references/prompts-v2/deliberate-practice-loop.md`
- **Nicolas Cole — Description Upgrade** — `skills/nicolas-cole-edan-writing-mechanics/references/prompts-v2/description-upgrade.md`
- **Nicolas Cole — EDAN Balance Audit** — `skills/nicolas-cole-edan-writing-mechanics/references/prompts-v2/edan-balance-audit.md`
- **Nicolas Cole — EDAN Block Map** — `skills/nicolas-cole-edan-writing-mechanics/references/prompts-v2/edan-block-map.md`
- **Nicolas Cole — EDAN Opener Builder** — `skills/nicolas-cole-edan-writing-mechanics/references/prompts-v2/edan-opener-builder.md`
- **Nicolas Cole — Narration POV Forge** — `skills/nicolas-cole-edan-writing-mechanics/references/prompts-v2/narration-pov-forge.md`
- **Nicolas Cole — Source Study Deconstruction** — `skills/nicolas-cole-edan-writing-mechanics/references/prompts-v2/source-study-deconstruction.md`
