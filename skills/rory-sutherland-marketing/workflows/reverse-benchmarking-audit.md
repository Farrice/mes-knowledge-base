...
### Phase 1: The Standard Benchmarking Inversion
Systematically identify what you've been copying and why it guarantees mediocrity.

- **Benchmark Inventory**: List every metric, feature, or capability you currently benchmark against competitors. Mark each as "matching" or "chasing."
- **Scale Effects Diagnosis**: For each benchmark, assess: "Do competitors have structural advantages (scale, history, budget) that make matching them a losing game?" Apply the Jaguar Test — "Are we trying to out-BMW BMW?"
- **Procurement Trap Check**: Determine whether your current positioning makes you easily comparable on procurement spreadsheets. If yes → you're in commodity territory and procurement will select on price.

**Output**: A ranked list of every benchmark you're currently chasing that you should STOP chasing, with the structural reason each is unwinnable.

### Phase 2: The Blind Spot Hunt
...
### Phase 3: Signature Obsession Engineering
Transform 2-3 blind spots into your defining competitive advantage.

- **Sommelier Appointment**: For each selected blind spot, define who in your organization becomes the internal "sommelier" — the person obsessed with making this neglected area world-class. (cf. Guidara's beer sommelier and coffee sommelier)
- **Disproportionate Investment Design**: Calculate the minimum investment required to go from "meh" to "remarkable" in each selected area. Apply Tacit Knowledge 7 (Disproportionate Response Principle) — small investments in neglected areas create outsized loyalty.
- **The Procurement Escape**: Ensure your signature obsessions make you incomparable. If procurement can't put you in the same column as competitors → they can't strip your margin. Design the differentiation so it breaks spreadsheet comparison.

### Phase 4: The Reverse Benchmarking Scorecard
Package findings into actionable implementation plan.

| Competitor | Blind Spot | Emotional Impact (1-10) | Investment Required | Your Signature Play |
|---|---|---|---|---|
| [Comp 1] | [Gap identified] | [Score] | [Budget] | [How you'll own this] |
| [Comp 2] | [Gap identified] | [Score] | [Budget] | [How you'll own this] |
| [Comp 3] | [Gap identified] | [Score] | [Budget] | [How you'll own this] |
...
- [ ] Are the selected signature obsessions genuinely neglected (not just "less good")?
...
- **→ Oren** (`/design-taste-gate`): Ensure the signature obsession areas pass the taste test — are they genuinely remarkable or just "different for different's sake"?
- **→ Kallaway** (`/obsession-level-architect`): Engineer content around each signature obsession that ascends viewers from Signal → Belief → Action.
