---
name: "10-resonant-story"
source_prompt: "skills/david-deutsch-copywriting/references/prompts/10-resonant-story.md"
...
- **[STORY]**: Core narrative
- **[INSIGHT]**: What they learn
...
1. **OPEN** with entertainment hook
2. **BUILD** engaging narrative
3. **EMBED** insight in story
4. **CREATE** transformation moment
5. **CLOSE** with identity shift
