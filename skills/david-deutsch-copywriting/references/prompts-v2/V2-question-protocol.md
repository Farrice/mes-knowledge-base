---
name: "V2-question-protocol"
source_prompt: "skills/david-deutsch-copywriting/references/prompts/V2-question-protocol.md"
...
- **[GOALS]**: What insights you need
- **[CONTEXT]**: Client/market situation

---

## Execution Protocol

1. **PREPARE** non-threatening questions
2. **ASK** to clients, markets, AI, yourself
3. **LISTEN** for hidden information
4. **FOLLOW** surprising answers deeper
5. **EXTRACT** 10+ insights per conversation
