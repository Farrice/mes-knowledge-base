...
- **[EFFECT]**: Desired feel (punchy, flowing, etc.)
...
1. **VARY** sentence length 5-25 words
2. **OPEN** paragraphs with shorter sentences
3. **FOLLOW** long with punchy
4. **CREATE** deliberate rhythm
5. **CHECK** no 3 consecutive same-length
