---
name: "02-universal-resonance"
source_prompt: "skills/david-deutsch-copywriting/references/prompts/02-universal-resonance.md"
...
- **[CONTENT]**: What to make universal
- **[AUDIENCE]**: Broad target
- **[EMOTION]**: Core feeling

---

## Execution Protocol

1. **IDENTIFY** universal drives (fear, desire, belonging)
2. **CONNECT** to fundamental human experiences
3. **USE** archetypal patterns
4. **REMOVE** niche-specific barriers
5. **DEPLOY** broad appeal hooks
