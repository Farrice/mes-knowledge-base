---
name: "04-viral-sharing"
source_prompt: "skills/david-deutsch-copywriting/references/prompts/04-viral-sharing.md"
...
- **[CONTENT]**: What to make shareable
- **[TRIGGERS]**: Share motivations
- **[AUDIENCE]**: Who shares
...
1. **ACTIVATE** social currency (makes sharer look smart)
2. **TRIGGER** emotional arousal
3. **PROVIDE** practical value
4. **TELL** shareable stories
5. **CREATE** public visibility
