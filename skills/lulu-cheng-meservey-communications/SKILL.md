...
- **Prompt Library**: [references/prompts/](references/prompts/) — 14 crown-jewel practitioner prompts (mirrored in [references/_legacy-prompts/](references/_legacy-prompts/); searchable via `python3 execution/prompt_library.py search "<topic>"`).
...
- **Go Direct Founder Communication** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p01-go-direct-communications.md`
- **Cultural Erogenous Zone Detection** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p02-cultural-erogenous-zones.md`
- **Message-Medium-Messenger Architecture** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p03-message-medium-messenger.md`
- **Attention-to-Value Conversion Engine** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p04-attention-to-value.md`
- **Crisis Communications & Emotional Altitude** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p05-crisis-emotional-altitude.md`
- **Line-in-the-Sand Positioning** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p06-line-in-sand-positioning.md`
- **Reality Architect System** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p07-reality-architect.md`
- **Conviction Copy Transmutation Engine** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p08-conviction-copy-transmutation.md`
- **Strategic Wrongness Navigator** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p09-strategic-wrongness.md`
- **Cultural Zeitgeist Ideation System** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p10-zeitgeist-ideation.md`
- **Authenticity Engineering System** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p11-authenticity-engineering.md`
- **Viral Trajectory Predictor** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p12-viral-trajectory-predictor.md`
- **Belief Architecture Engine** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p13-belief-architecture-engine.md`
- **Signature Voice Crystallizer** — `skills/lulu-cheng-meservey-communications/references/prompts-v2/p14-signature-voice-crystallizer.md`
