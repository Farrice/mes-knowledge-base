---
slug: "awareness-ladder-converter"
name: "Awareness Ladder Converter"
produces: "Ads for all 5 awareness levels from a single product brief"
expert: "Luke Iha: Unaware Ads & Awareness-Level Conversion"
load_context: "genius.md"
---

# Luke Iha: Unaware Ads — Awareness Ladder Converter
...
**Before executing**: Read genius.md for the full hook archetype system and awareness level structures.
...
- **Length**: Long — you need space for worldview transformation
...
Diagram how these 5 ads feed into each other:
...
2. **5 Complete Ads** — One per awareness level, fully written and annotated
...
5. **Testing Priority** — Which ad to test FIRST based on available proof and budget

## Quality Gate
1. **Level Accuracy**: Does each ad match the correct awareness level's requirements?
2. **Hook Calibration**: Do unaware ads use curiosity hooks while product-aware ads use proof hooks?
