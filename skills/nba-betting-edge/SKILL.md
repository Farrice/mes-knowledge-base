...
- **Bankroll Strategy — [Date]** — `skills/nba-betting-edge/references/prompts-v2/bankroll-strategy-document.md`
- **Game Day Pick Slate — [Date]** — `skills/nba-betting-edge/references/prompts-v2/game-day-pick-slate.md`
- **Performance Review — [Date Range]** — `skills/nba-betting-edge/references/prompts-v2/performance-review-report.md`
