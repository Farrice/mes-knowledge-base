...
- **DESIGN.md <Diff Summary | Merge Proposal> — <before> → <after>** — `skills/design-md/references/prompts-v2/evolve-design-diff-and-merge.md`
- **Design Systems Lead — Export DESIGN.md and Hand Off to Agents/Teams** — `skills/design-md/references/prompts-v2/export-and-handoff-design-md.md`
- **Design Systems Lead — Extract DESIGN.md from a Live Source** — `skills/design-md/references/prompts-v2/extract-design-md-from-source.md`
- **Design Systems Lead — Import and Customize a Brand from the Library** — `skills/design-md/references/prompts-v2/import-brand-from-library.md`
- **Design Systems Lead — Synthesize DESIGN.md from a Creative Brief** — `skills/design-md/references/prompts-v2/synthesize-design-md-from-brief.md`
- **Design Systems Lead — Validate and Refine a DESIGN.md** — `skills/design-md/references/prompts-v2/validate-and-refine-design-md.md`
