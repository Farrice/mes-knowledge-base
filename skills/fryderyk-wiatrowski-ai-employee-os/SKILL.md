...
- **Fryderyk Wiatrowski — AI Employee System Audit** — `skills/fryderyk-wiatrowski-ai-employee-os/references/prompts-v2/ai-employee-system-audit.md`
- **Fryderyk Wiatrowski — AI Employee System Design** — `skills/fryderyk-wiatrowski-ai-employee-os/references/prompts-v2/ai-employee-system-design.md`
- **Fryderyk Wiatrowski — AI Employee System Upgrade** — `skills/fryderyk-wiatrowski-ai-employee-os/references/prompts-v2/ai-employee-system-upgrade.md`
- **Fryderyk Wiatrowski — Integration & Permission Map** — `skills/fryderyk-wiatrowski-ai-employee-os/references/prompts-v2/integration-permission-map.md`
- **Fryderyk Wiatrowski — Model/Personality Regression Canary** — `skills/fryderyk-wiatrowski-ai-employee-os/references/prompts-v2/model-personality-regression-canary.md`
