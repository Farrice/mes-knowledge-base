...
- **Agent-Ready Knowledge System Offer** — `skills/semantic-document-library-os/references/prompts-v2/agent-ready-knowledge-system-offer.md`
- **Semantic Document Library OS — Operator Steering Compass** — `skills/semantic-document-library-os/references/prompts-v2/operator-steering-compass.md`
- **Semantic Document Audit: [Document]** — `skills/semantic-document-library-os/references/prompts-v2/semantic-document-audit.md`
- **[Work Primitive Name]** — `skills/semantic-document-library-os/references/prompts-v2/semantic-document-generator.md`
- **Semantic Document Library Blueprint: [Name]** — `skills/semantic-document-library-os/references/prompts-v2/semantic-document-library-blueprint.md`
- **Semantic Document Validation: [Document]** — `skills/semantic-document-library-os/references/prompts-v2/semantic-document-validation-report.md`
