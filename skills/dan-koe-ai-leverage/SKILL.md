...
- **Leverage Audit (if applicable)** — `skills/dan-koe-ai-leverage/references/prompts-v2/4c-session-architecture.md`
- **Structural Analysis** — `skills/dan-koe-ai-leverage/references/prompts-v2/adversarial-refinement-report.md`
- **[Target Format] Production Prompt** — `skills/dan-koe-ai-leverage/references/prompts-v2/gap-teaching-production-prompt.md`
- **[Expert Name] — [Domain] Coach** — `skills/dan-koe-ai-leverage/references/prompts-v2/knowledge-alchemy-coaching-prompt.md`
