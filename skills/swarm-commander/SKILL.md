...
- **Agent Constellation** — `skills/swarm-commander/references/prompts-v2/agent-constellation.md`
- **Batch Execution** — `skills/swarm-commander/references/prompts-v2/batch-execution.md`
- **Swarm Planning** — `skills/swarm-commander/references/prompts-v2/swarm-planning.md`
- **Swarm Synthesis** — `skills/swarm-commander/references/prompts-v2/swarm-synthesis.md`
