---
description: "/how-i-write (front door; alias /how-i-write-os) — the How-I-Write OS master writing conductor: intent to smallest-sufficient altitude stack (3-6 of 14 experts), ONE body-voice owner, mandatory truth/clamp/prose gate close, finished piece + Output Receipt. Relocated from references/prompts-v2/composed-writing-piece-and-receipt.md into workflows/ 2026-07-17 (Wave 3 Lane 3 repair) so the skill_auditor workflow_contracts check can find it; content is unchanged born-v2 structure-pure-v2, not rewritten."
source_prompt: born-v2
skill: how-i-write-os
standard: structure-pure-v2
forged: born-v2
refactored: 2026-07-13
relocated: 2026-07-17
---
