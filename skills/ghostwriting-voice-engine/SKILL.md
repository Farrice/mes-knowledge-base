...
- **advantage-and-icp.md** — `skills/ghostwriting-voice-engine/references/prompts-v2/client-acquisition-package.md`
- **Ghostwriting Voice Engine — LinkedIn Content Batch** — `skills/ghostwriting-voice-engine/references/prompts-v2/linkedin-content-batch.md`
- **voice-profile-abbreviated.md** — `skills/ghostwriting-voice-engine/references/prompts-v2/unsolicited-demo-package.md`
- **Voice Profile: [Client Name]** — `skills/ghostwriting-voice-engine/references/prompts-v2/voice-profile.md`
