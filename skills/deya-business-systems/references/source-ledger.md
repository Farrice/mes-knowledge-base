...
| 4 | "~200k YouTube" subscriber count | UNCONFIRMED | No Deya-specific subscriber-count statement located in the 4 read files. The only "subscribers" references in Deya-tagged files describe a third party (Emma Chamberlain, "millions and millions of subscribers," in a819015f) |
