...
- **Antigravity Supercomputer — Anchor Propagation Verification** — `skills/supercomputer/references/prompts-v2/anchor-propagation-verification.md`
- **Antigravity Supercomputer — Mission Completion Summary** — `skills/supercomputer/references/prompts-v2/mission-completion-summary.md`
- **Antigravity Supercomputer — Mission Pivot / Re-Plan** — `skills/supercomputer/references/prompts-v2/mission-pivot-replan.md`
- **Antigravity Supercomputer — Mission Plan & Kickoff** — `skills/supercomputer/references/prompts-v2/mission-plan-kickoff.md`
