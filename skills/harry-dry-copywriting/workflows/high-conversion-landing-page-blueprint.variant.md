...
## Input Required
- **[PRODUCT]**: What are you selling? (Technical name and category)
- **[AUDIENCE]**: Who is the specific user? (Not "everyone," but a specific person in a specific moment)
- **[CORE_FEATURES]**: List 3-5 technical capabilities.
...
1. **Generate 25 Variations (Pattern 13)**: Do not stop until you hit 25. Use these categories:
   *   **The Transformation**: Focus on the "After" state.
...
1. **Headline**: Select the winner from Phase 3.
2. **Subheadline**: Clarify the mechanism. How does it work? (Pattern 16: Use metonymy—visual terms over technical ones).
3. **Visual-Verbal Synthesis (Pattern 8)**: Describe the visual that MUST accompany this copy (Screenshot, specific illustration, or data point).
4. **Social Proof Snippet**: Create a "Fastest Proof" element (e.g., "Used by 400+ developers at Stripe").

### Phase 5: CTA Optimization (The "Get" vs. "Do" Filter)
The button is the moment of truth.
1. **Outcome > Action**: Rewrite the CTA to describe what they GET, not what they have to DO.
   *   *Bad: "Sign Up." Good: "Get my first lesson."*
2. **Friction Reduction**: Identify the "High Friction" thought (e.g., "This will take forever") and kill it with a micro-copy "Friction Reducer" next to the button (e.g., "No credit card required. 2-minute setup.").

### Phase 6: The Kaplan's Law Scrub (Final Polish)
1. **Two-Line Maximum (Pattern 12)**: Break every paragraph longer than two lines.
2. **Parallel Structure (Pattern 10)**: Ensure all bullet points and lists start with the same grammatical form (Verb-Verb-Verb).
3. **The One Mississippi Test (Pattern 6)**: Read the Hero section. If the core value isn't clear in 2 seconds, simplify.
