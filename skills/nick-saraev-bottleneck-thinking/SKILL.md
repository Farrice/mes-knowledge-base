...
- **Bottleneck Diagnostic: [Business Name/Type]** — `skills/nick-saraev-bottleneck-thinking/references/prompts-v2/business-bottleneck-diagnostic.md`
- **Diagnostic: [Client/Business]** — `skills/nick-saraev-bottleneck-thinking/references/prompts-v2/consulting-diagnostic-frameworks.md`
- **Flywheel Sprint: Widen [Constraint Name]** — `skills/nick-saraev-bottleneck-thinking/references/prompts-v2/flywheel-sprint-planner.md`
- **Revenue-Tier Growth Playbook: [Business Name]** — `skills/nick-saraev-bottleneck-thinking/references/prompts-v2/revenue-tier-growth-playbook.md`
