...
| `_archive/claude-export-2026-07-01.tar.gz` | 332,779,255 (confirmed via `ls -la`) | Referenced by `_active/harness/claude-export/index.json` as the likely home of the "Four Key AI Consulting Basics" conversation, but NOT expanded on disk anywhere in the live repo tree. Not extracted for this repair (out of scope/time-boxed) — see gap note. |
