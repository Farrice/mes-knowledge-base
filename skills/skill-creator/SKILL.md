...
- **Skill Creator — Evaluation Baseline-Gap Report** — `skills/skill-creator/references/prompts-v2/evaluation-baseline-gap-report.md`
- **Skill Creator — New Skill Build** — `skills/skill-creator/references/prompts-v2/new-skill-build.md`
- **Skill Creator — Skill Iteration Update** — `skills/skill-creator/references/prompts-v2/skill-iteration-update.md`
- **Skill Creator — Token-Optimization & Security Pass** — `skills/skill-creator/references/prompts-v2/token-optimization-security-pass.md`
