...
| `projects/unbottlenecked_blueprint/06_icp_intelligence_report.md` | "5-Agent VoC Swarm," ZERO URLs, ZERO verbatims; modeled language drives $15k + $99/mo offer decisions. | Re-ground via `/avatar-machine`; re-validate offer assumptions. |
