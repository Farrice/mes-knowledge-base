...
| `projects/Kens_Fasting_Digital_Product/landing_page_copy.md` | **Shipped sales copy**, unsourced health claims + results guarantee that its own synthesis demanded removing. **Medical-claim liability.** | Pull guarantee/"exact formula" language now; re-ground before relaunch. |
