---
name: "source-command-matthew-volkwyn"
description: "matthew-volkwyn — full expert front door: Copywriting critique, full-stack copy positioning, voice engineering. Skills: matthew-volkwyn-copywriting."
---

# source-command-matthew-volkwyn

Use this skill when the user asks to run the migrated source command `matthew-volkwyn`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/matthew-volkwyn/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY matthew-volkwyn for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| matthew-volkwyn-copywriting | `skills/matthew-volkwyn-copywriting/SKILL.md` | `skills/matthew-volkwyn-copywriting/genius.md` | `skills/matthew-volkwyn-copywriting/workflows/01-audit-copy.md` |
