---
name: "source-command-kj-rainey"
description: "kj-rainey — full expert front door: Copywriting offers, pain-driven direct response, freelance client acquisition. Skills: kj-rainey-copywriting."
---

# source-command-kj-rainey

Use this skill when the user asks to run the migrated source command `kj-rainey`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/kj-rainey/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY kj-rainey for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| kj-rainey-copywriting | `skills/kj-rainey-copywriting/SKILL.md` | `skills/kj-rainey-copywriting/genius.md` | `skills/kj-rainey-copywriting/workflows/01-forge-irresistible-offer.md` |
