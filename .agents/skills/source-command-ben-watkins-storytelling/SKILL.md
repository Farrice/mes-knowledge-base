---
name: "source-command-ben-watkins-storytelling"
...
# source-command-ben-watkins-storytelling

Use this skill when the user asks to run the migrated source command `ben-watkins-storytelling`.
