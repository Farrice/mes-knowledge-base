---
name: "source-command-eugene-teo"
description: "eugene-teo — full expert front door: minimalist strength training, exercise selection & execution quality, mind-muscle connection, mobility integration, sustainable physique building. Skills: eugene-teo-training."
---

# source-command-eugene-teo

Use this skill when the user asks to run the migrated source command `eugene-teo`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/eugene-teo/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY eugene-teo for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| eugene-teo-training | `skills/eugene-teo-training/SKILL.md` | `skills/eugene-teo-training/genius.md` | `skills/eugene-teo-training/workflows/01-design-minimalist-program.md` |
