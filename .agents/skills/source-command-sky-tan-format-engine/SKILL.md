---
name: "source-command-sky-tan-format-engine"
...
# source-command-sky-tan-format-engine

Use this skill when the user asks to run the migrated source command `sky-tan-format-engine`.
