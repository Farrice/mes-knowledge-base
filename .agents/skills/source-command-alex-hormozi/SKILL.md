---
name: "source-command-alex-hormozi"
description: "alex-hormozi — full expert front door: Business scaling, money models, offer architecture, monetization strategy. Skills: alex-hormozi-business."
---

# source-command-alex-hormozi

Use this skill when the user asks to run the migrated source command `alex-hormozi`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/alex-hormozi/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY alex-hormozi for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| alex-hormozi-business | `skills/alex-hormozi-business/SKILL.md` | `skills/alex-hormozi-business/genius.md` | `skills/alex-hormozi-business/workflows/01-engineer-money-model.md` |
