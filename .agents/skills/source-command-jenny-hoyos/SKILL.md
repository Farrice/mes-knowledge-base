---
name: "source-command-jenny-hoyos"
description: "jenny-hoyos — full expert front door: Short-form viral storytelling (YouTube Shorts / vertical video). Skills: jenny-hoyos-shorts."
---

# source-command-jenny-hoyos

Use this skill when the user asks to run the migrated source command `jenny-hoyos`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/jenny-hoyos/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY jenny-hoyos for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| jenny-hoyos-shorts | `skills/jenny-hoyos-shorts/SKILL.md` | `skills/jenny-hoyos-shorts/genius.md` | `skills/jenny-hoyos-shorts/workflows/01-script-viral-short.md` |
