---
name: "source-command-boris"
description: "Boris — full expert front door: expert persona for Boris. Skills: boris-Codex."
---

# source-command-boris

Use this skill when the user asks to run the migrated source command `boris`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/boris/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY Boris for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| boris-Codex | `skills/boris-Codex/SKILL.md` | `skills/boris-Codex/genius.md` | `skills/boris-Codex/workflows/ai-workforce-orchestration-system.md` |
