---
name: "source-command-riley-brown"
description: "Riley Brown — full expert front door: expert persona for Riley Brown. Skills: riley-brown-marketing-automation."
---

# source-command-riley-brown

Use this skill when the user asks to run the migrated source command `riley-brown`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/riley-brown/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY Riley Brown for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| riley-brown-marketing-automation | `skills/riley-brown-marketing-automation/SKILL.md` | `skills/riley-brown-marketing-automation/genius.md` | `skills/riley-brown-marketing-automation/workflows/riley-scrape-to-skill.md` |
