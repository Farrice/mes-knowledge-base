---
name: "source-command-story-bible"
description: "Interview-driven skill that helps AI filmmakers, worldbuilders, and storytellers turn their story into a single dense canon document — the story's bible. Output is a ready-to-install SKILL.md the user drops into Codex as their own custom skill, so every future prompt (image,..."
---

# source-command-story-bible

Use this skill when the user asks to run the migrated source command `story-bible`.
