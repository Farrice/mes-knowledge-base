---
name: "source-command-nate-b-jones"
...
# source-command-nate-b-jones

Use this skill when the user asks to run the migrated source command `nate-b-jones`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/nate-b-jones/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY Nate B Jones: AI Agent Architecture Specialist for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| nate-b-jones-agent-deployment-strategy | `skills/nate-b-jones-agent-deployment-strategy/SKILL.md` | `skills/nate-b-jones-agent-deployment-strategy/genius.md` | `skills/nate-b-jones-agent-deployment-strategy/workflows/agent-implementation-master-blueprint.md` |
| nate-b-jones-ai-taste-mastery | `skills/nate-b-jones-ai-taste-mastery/SKILL.md` | `skills/nate-b-jones-ai-taste-mastery/genius.md` | `skills/nate-b-jones-ai-taste-mastery/workflows/taste-monetization-blueprint.md` |
