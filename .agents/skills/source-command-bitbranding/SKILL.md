---
name: "source-command-bitbranding"
description: "bitbranding — full expert front door: Fashion E-Commerce / Shopify Theme Execution / DTC Clothing-Brand Conversion. Skills: bitbranding-fashion-shopify."
---

# source-command-bitbranding

Use this skill when the user asks to run the migrated source command `bitbranding`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/bitbranding/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY bitbranding for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| bitbranding-fashion-shopify | `skills/bitbranding-fashion-shopify/SKILL.md` | `skills/bitbranding-fashion-shopify/genius.md` | `skills/bitbranding-fashion-shopify/workflows/01-premium-reference-collection-audit.md` |
