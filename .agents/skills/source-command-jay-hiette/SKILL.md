---
name: "source-command-jay-hiette"
description: "jay-hiette — full expert front door: Online coaching positioning, belief-shifting messaging, coaching-business deal flow. Skills: jay-hiette-coaching-positioning."
---

# source-command-jay-hiette

Use this skill when the user asks to run the migrated source command `jay-hiette`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/jay-hiette/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY jay-hiette for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| jay-hiette-coaching-positioning | `skills/jay-hiette-coaching-positioning/SKILL.md` | `skills/jay-hiette-coaching-positioning/genius.md` | `skills/jay-hiette-coaching-positioning/workflows/01-architect-reality-matrix.md` |
