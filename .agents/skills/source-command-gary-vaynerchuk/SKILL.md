---
name: "source-command-gary-vaynerchuk"
description: "gary-vaynerchuk — full expert front door: Attention strategy, organic social, personal branding, paid amplification. Skills: gary-vaynerchuk-attention."
---

# source-command-gary-vaynerchuk

Use this skill when the user asks to run the migrated source command `gary-vaynerchuk`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/gary-vaynerchuk/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY gary-vaynerchuk for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| gary-vaynerchuk-attention | `skills/gary-vaynerchuk-attention/SKILL.md` | `skills/gary-vaynerchuk-attention/genius.md` | `skills/gary-vaynerchuk-attention/workflows/01-scout-underpriced-attention.md` |
