---
name: "source-command-russell-brunson"
description: "russell-brunson — full expert front door: Direct-response funnels, Hook-Story-Offer, identity-driven movement marketing. Skills: russell-brunson-funnels."
---

# source-command-russell-brunson

Use this skill when the user asks to run the migrated source command `russell-brunson`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/russell-brunson/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY russell-brunson for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| russell-brunson-funnels | `skills/russell-brunson-funnels/SKILL.md` | `skills/russell-brunson-funnels/genius.md` | `skills/russell-brunson-funnels/workflows/01-architect-hook-story-offer.md` |
