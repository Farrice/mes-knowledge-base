---
name: "source-command-pat-flynn"
description: "pat-flynn — full expert front door: Passive income architecture, ethical affiliate marketing, audience-first online business. Skills: pat-flynn-passive-income."
---

# source-command-pat-flynn

Use this skill when the user asks to run the migrated source command `pat-flynn`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/pat-flynn/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY pat-flynn for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| pat-flynn-passive-income | `skills/pat-flynn-passive-income/SKILL.md` | `skills/pat-flynn-passive-income/genius.md` | `skills/pat-flynn-passive-income/workflows/01-architect-income-stream.md` |
