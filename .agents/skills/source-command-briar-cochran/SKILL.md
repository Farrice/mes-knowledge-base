---
name: "source-command-briar-cochran"
description: "Briar Cochran — full expert front door: expert persona for Briar Cochran. Skills: briar-cochran-content-science."
---

# source-command-briar-cochran

Use this skill when the user asks to run the migrated source command `briar-cochran`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/briar-cochran/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY Briar Cochran for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| briar-cochran-content-science | `skills/briar-cochran-content-science/SKILL.md` | `skills/briar-cochran-content-science/genius.md` | `skills/briar-cochran-content-science/workflows/01-idea-venn-gate.md` |
