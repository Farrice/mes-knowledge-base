---
name: "source-command-matt-mcgarry"
description: "matt-mcgarry — full expert front door: Newsletter Growth & Email Monetization. Skills: matt-mcgarry-newsletters."
---

# source-command-matt-mcgarry

Use this skill when the user asks to run the migrated source command `matt-mcgarry`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/matt-mcgarry/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY matt-mcgarry for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| matt-mcgarry-newsletters | `skills/matt-mcgarry-newsletters/SKILL.md` | `skills/matt-mcgarry-newsletters/genius.md` | `skills/matt-mcgarry-newsletters/workflows/01-launch-newsletter.md` |
