---
name: "source-command-thrivecart"
description: "thrivecart — full expert front door: Digital product business building and scaling. Skills: thrivecart-digital-products."
---

# source-command-thrivecart

Use this skill when the user asks to run the migrated source command `thrivecart`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/thrivecart/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY thrivecart for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| thrivecart-digital-products | `skills/thrivecart-digital-products/SKILL.md` | `skills/thrivecart-digital-products/genius.md` | `skills/thrivecart-digital-products/workflows/weekend-launch-blueprint.md` |
