---
name: "source-command-michael-margolis"
description: "michael-margolis — full expert front door: User research, customer discovery, bullseye customer definition. Skills: michael-margolis-user-research."
---

# source-command-michael-margolis

Use this skill when the user asks to run the migrated source command `michael-margolis`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/michael-margolis/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY michael-margolis for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| michael-margolis-user-research | `skills/michael-margolis-user-research/SKILL.md` | `skills/michael-margolis-user-research/genius.md` | `skills/michael-margolis-user-research/workflows/01-define-bullseye-customer.md` |
