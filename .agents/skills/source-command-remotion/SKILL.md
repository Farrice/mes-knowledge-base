---
name: "source-command-remotion"
description: "Remotion — full expert front door: expert persona for Remotion. Skills: remotion-video-creation."
---

# source-command-remotion

Use this skill when the user asks to run the migrated source command `remotion`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/remotion/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY Remotion for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| remotion-video-creation | `skills/remotion-video-creation/SKILL.md` | (none) | (none) |
