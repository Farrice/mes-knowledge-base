---
name: "source-command-luisa-zhou"
description: "luisa-zhou — full expert front door: Coaching business launch, client onboarding & delivery, sustainable practice systems. Skills: luisa-zhou-coaching."
---

# source-command-luisa-zhou

Use this skill when the user asks to run the migrated source command `luisa-zhou`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/luisa-zhou/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY luisa-zhou for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| luisa-zhou-coaching | `skills/luisa-zhou-coaching/SKILL.md` | `skills/luisa-zhou-coaching/genius.md` | `skills/luisa-zhou-coaching/workflows/01-launch-coaching-offer.md` |
