---
name: "source-command-design-md"
description: "Author, extract, validate, and operate on DESIGN.md files (Google Labs spec, April 2026) — the universal brand-system-as-code format that any AI agent (Codex, Cursor, Stitch, Copilot, v0) consumes to produce on-brand UI without re-explaining the design system every prompt"
---

# source-command-design-md

Use this skill when the user asks to run the migrated source command `design-md`.
