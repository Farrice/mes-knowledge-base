---
name: "source-command-deya"
description: "deya — full expert front door: Business validation, 1-page business planning, freelance/service business operations. Skills: deya-business-systems."
---

# source-command-deya

Use this skill when the user asks to run the migrated source command `deya`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/deya/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY deya for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| deya-business-systems | `skills/deya-business-systems/SKILL.md` | `skills/deya-business-systems/genius.md` | `skills/deya-business-systems/workflows/01-validate-business-idea.md` |
