---
name: "source-command-brad-bonanno-explainer-architecture"
...
# source-command-brad-bonanno-explainer-architecture

Use this skill when the user asks to run the migrated source command `brad-bonanno-explainer-architecture`.
