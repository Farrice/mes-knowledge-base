---
name: "source-command-kittl"
description: "Kittl: Design Mastery Virtuoso — full expert front door: expert persona for Kittl: Design Mastery Virtuoso. Skills: kittl-graphic-design."
---

# source-command-kittl

Use this skill when the user asks to run the migrated source command `kittl`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/kittl/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY Kittl: Design Mastery Virtuoso for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| kittl-graphic-design | `skills/kittl-graphic-design/SKILL.md` | `skills/kittl-graphic-design/genius.md` | `skills/kittl-graphic-design/workflows/typography-identity-blueprint.md` |
