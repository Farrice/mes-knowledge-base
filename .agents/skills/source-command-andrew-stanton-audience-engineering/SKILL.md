---
name: "source-command-andrew-stanton-audience-engineering"
...
# source-command-andrew-stanton-audience-engineering

Use this skill when the user asks to run the migrated source command `andrew-stanton-audience-engineering`.
