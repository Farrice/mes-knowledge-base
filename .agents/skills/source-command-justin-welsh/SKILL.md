---
name: "source-command-justin-welsh"
description: "justin-welsh — full expert front door: Solopreneurship / One-Person Business Systems / Creator Monetization. Skills: justin-welsh-solopreneur."
---

# source-command-justin-welsh

Use this skill when the user asks to run the migrated source command `justin-welsh`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/justin-welsh/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY justin-welsh for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| justin-welsh-solopreneur | `skills/justin-welsh-solopreneur/SKILL.md` | `skills/justin-welsh-solopreneur/genius.md` | `skills/justin-welsh-solopreneur/workflows/01-multiply-content.md` |
