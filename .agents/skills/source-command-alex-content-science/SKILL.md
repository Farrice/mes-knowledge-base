---
name: "source-command-alex-content-science"
description: "Alex — full expert front door: Content Science, Reverse Engineering, Viral Mechanics, Forensic Content Analysis. Skills: alex-content-science."
---

# source-command-alex-content-science

Use this skill when the user asks to run the migrated source command `alex-content-science`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/alex-content-science/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY Alex for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| alex-content-science | `skills/alex-content-science/SKILL.md` | `skills/alex-content-science/genius.md` | `skills/alex-content-science/workflows/01-detail-stack-breakdown.md` |
