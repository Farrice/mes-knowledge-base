---
name: "source-command-wordsatscale"
description: "wordsatscale — full expert front door: SEO Rapid Ranking. Skills: wordsatscale-seo-ranking."
---

# source-command-wordsatscale

Use this skill when the user asks to run the migrated source command `wordsatscale`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/wordsatscale/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY wordsatscale for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| wordsatscale-seo-ranking | `skills/wordsatscale-seo-ranking/SKILL.md` | `skills/wordsatscale-seo-ranking/genius.md` | `skills/wordsatscale-seo-ranking/workflows/search-gap-discovery-engine.md` |
