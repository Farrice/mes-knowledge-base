---
name: "source-command-andy-galpin"
description: "andy-galpin — full expert front door: exercise physiology, energy-system training, metabolic optimization, injury rehab. Skills: andy-galpin-training-intelligence."
---

# source-command-andy-galpin

Use this skill when the user asks to run the migrated source command `andy-galpin`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/andy-galpin/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY andy-galpin for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| andy-galpin-training-intelligence | `skills/andy-galpin-training-intelligence/SKILL.md` | `skills/andy-galpin-training-intelligence/genius.md` | `skills/andy-galpin-training-intelligence/workflows/01-diagnose-limiter-program.md` |
