---
name: "source-command-manus-ai-consulting"
...
# source-command-manus-ai-consulting

Use this skill when the user asks to run the migrated source command `manus-ai-consulting`.
