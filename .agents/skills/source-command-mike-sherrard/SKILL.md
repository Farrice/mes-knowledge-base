---
name: "source-command-mike-sherrard"
description: "mike-sherrard — full expert front door: Real estate personal branding & social media lead conversion. Skills: mike-sherrard-realtor-branding."
---

# source-command-mike-sherrard

Use this skill when the user asks to run the migrated source command `mike-sherrard`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/mike-sherrard/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY mike-sherrard for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| mike-sherrard-realtor-branding | `skills/mike-sherrard-realtor-branding/SKILL.md` | `skills/mike-sherrard-realtor-branding/genius.md` | `skills/mike-sherrard-realtor-branding/workflows/01-position-niche-brand.md` |
