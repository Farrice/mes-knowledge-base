---
name: "source-command-prediction-market-weather-trading"
...
# source-command-prediction-market-weather-trading

Use this skill when the user asks to run the migrated source command `prediction-market-weather-trading`.
