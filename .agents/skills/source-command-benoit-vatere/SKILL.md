---
name: "source-command-benoit-vatere"
description: "benoit-vatere — full expert front door: full-funnel media systems / incrementality measurement / channel selection / CPG retail media. Skills: benoit-vatere."
---

# source-command-benoit-vatere

Use this skill when the user asks to run the migrated source command `benoit-vatere`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/benoit-vatere/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY benoit-vatere for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| benoit-vatere | `skills/benoit-vatere/SKILL.md` | `skills/benoit-vatere/genius.md` | `skills/benoit-vatere/workflows/spend-map.md` |
