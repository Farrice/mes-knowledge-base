---
name: "source-command-matt-haig"
description: "Matt Haig Reader Bridge — full expert front door: expert persona for Matt Haig Reader Bridge. Skills: matt-haig-reader-bridge."
---

# source-command-matt-haig

Use this skill when the user asks to run the migrated source command `matt-haig`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/matt-haig/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY Matt Haig Reader Bridge for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| matt-haig-reader-bridge | `skills/matt-haig-reader-bridge/SKILL.md` | `skills/matt-haig-reader-bridge/genius.md` | `skills/matt-haig-reader-bridge/workflows/haig-authentic-optimism.md` |
