---
name: "source-command-meg-heckman-buyer-trigger-os"
...
# source-command-meg-heckman-buyer-trigger-os

Use this skill when the user asks to run the migrated source command `meg-heckman-buyer-trigger-os`.
