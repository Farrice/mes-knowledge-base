---
name: pg-launch-experiment
description: "Paddy Galloway: Decide what success should look like. Produces expectations and a release-test plan. Use the existing source-grounded Paddy methods directly."
---
# pg-launch-experiment

Read and execute `.agent/workflows/pg-launch-experiment.md`. Preserve the user's supplied task and context.
