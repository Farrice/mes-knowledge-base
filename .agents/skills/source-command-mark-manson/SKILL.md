---
name: "source-command-mark-manson"
description: "mark-manson — full expert front door: Values psychology, behavior change, durable wellbeing (mindset layer for transformation coaching). Skills: mark-manson-values-psychology."
---

# source-command-mark-manson

Use this skill when the user asks to run the migrated source command `mark-manson`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/mark-manson/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY mark-manson for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| mark-manson-values-psychology | `skills/mark-manson-values-psychology/SKILL.md` | `skills/mark-manson-values-psychology/genius.md` | `skills/mark-manson-values-psychology/workflows/01-discover-core-values.md` |
