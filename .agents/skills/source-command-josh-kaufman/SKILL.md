---
name: "source-command-josh-kaufman"
description: "josh-kaufman — full expert front door: Business fundamentals, idea validation, rapid skill acquisition. Skills: josh-kaufman-business-fundamentals."
---

# source-command-josh-kaufman

Use this skill when the user asks to run the migrated source command `josh-kaufman`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/josh-kaufman/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY josh-kaufman for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| josh-kaufman-business-fundamentals | `skills/josh-kaufman-business-fundamentals/SKILL.md` | `skills/josh-kaufman-business-fundamentals/genius.md` | `skills/josh-kaufman-business-fundamentals/workflows/01-deconstruct-business.md` |
