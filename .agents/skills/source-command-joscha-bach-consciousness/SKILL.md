---
name: "source-command-joscha-bach-consciousness"
...
# source-command-joscha-bach-consciousness

Use this skill when the user asks to run the migrated source command `joscha-bach-consciousness`.
