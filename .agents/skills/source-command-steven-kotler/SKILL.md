---
name: "source-command-steven-kotler"
description: "steven-kotler — full expert front door: Flow states, peak performance & creativity science (coaching transformation layer). Skills: steven-kotler-flow-performance."
---

# source-command-steven-kotler

Use this skill when the user asks to run the migrated source command `steven-kotler`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/steven-kotler/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY steven-kotler for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| steven-kotler-flow-performance | `skills/steven-kotler-flow-performance/SKILL.md` | `skills/steven-kotler-flow-performance/genius.md` | `skills/steven-kotler-flow-performance/workflows/01-design-flow-protocol.md` |
