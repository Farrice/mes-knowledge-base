---
name: "source-command-mark-kashef-wargame-os"
...
# source-command-mark-kashef-wargame-os

Use this skill when the user asks to run the migrated source command `mark-kashef-wargame-os`.
