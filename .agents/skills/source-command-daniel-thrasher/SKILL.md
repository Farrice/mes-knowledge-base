---
name: "source-command-daniel-thrasher"
description: "daniel-thrasher — full expert front door: Affiliate marketing — direct-response campaign architecture (ClickBank model). Skills: daniel-thrasher-affiliate."
---

# source-command-daniel-thrasher

Use this skill when the user asks to run the migrated source command `daniel-thrasher`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/daniel-thrasher/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY daniel-thrasher for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| daniel-thrasher-affiliate | `skills/daniel-thrasher-affiliate/SKILL.md` | `skills/daniel-thrasher-affiliate/genius.md` | `skills/daniel-thrasher-affiliate/workflows/01-select-offer.md` |
