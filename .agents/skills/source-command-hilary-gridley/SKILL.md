---
name: "source-command-hilary-gridley"
description: "Hilary Gridley — full expert front door: expert persona for Hilary Gridley. Skills: hilary-gridley."
---

# source-command-hilary-gridley

Use this skill when the user asks to run the migrated source command `hilary-gridley`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/hilary-gridley/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY Hilary Gridley for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| hilary-gridley | `skills/hilary-gridley/SKILL.md` | `skills/hilary-gridley/genius.md` | `skills/hilary-gridley/workflows/hg-judgment-encode.md` |
