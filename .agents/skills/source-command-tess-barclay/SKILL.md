---
name: "source-command-tess-barclay"
description: "tess-barclay — full expert front door: Social media content strategy, creator positioning, niche-audience architecture. Skills: tess-barclay-social-content."
---

# source-command-tess-barclay

Use this skill when the user asks to run the migrated source command `tess-barclay`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/tess-barclay/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY tess-barclay for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| tess-barclay-social-content | `skills/tess-barclay-social-content/SKILL.md` | `skills/tess-barclay-social-content/genius.md` | `skills/tess-barclay-social-content/workflows/01-architect-niche-audience.md` |
