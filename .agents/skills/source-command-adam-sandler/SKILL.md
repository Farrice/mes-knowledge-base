---
name: "source-command-adam-sandler"
description: "adam-sandler — full expert front door: Go-to-market and delivery packaging for AI second-brain / knowledge-base services (sell-side). Skills: adam-sandler-second-brain-gtm."
---

# source-command-adam-sandler

Use this skill when the user asks to run the migrated source command `adam-sandler`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/adam-sandler/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY adam-sandler for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| adam-sandler-second-brain-gtm | `skills/adam-sandler-second-brain-gtm/SKILL.md` | `skills/adam-sandler-second-brain-gtm/genius.md` | `skills/adam-sandler-second-brain-gtm/workflows/01-ve-audit-offer.md` |
