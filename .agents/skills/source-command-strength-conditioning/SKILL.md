---
name: "source-command-strength-conditioning"
...
# source-command-strength-conditioning

Use this skill when the user asks to run the migrated source command `strength-conditioning`.
