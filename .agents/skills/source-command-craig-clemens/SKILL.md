---
name: "source-command-craig-clemens"
description: "craig-clemens — full expert front door: Education-first direct-response copywriting & persuasion. Skills: craig-clemens-copywriting."
---

# source-command-craig-clemens

Use this skill when the user asks to run the migrated source command `craig-clemens`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/craig-clemens/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY craig-clemens for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| craig-clemens-copywriting | `skills/craig-clemens-copywriting/SKILL.md` | `skills/craig-clemens-copywriting/genius.md` | `skills/craig-clemens-copywriting/workflows/01-write-education-first-sales-copy.md` |
