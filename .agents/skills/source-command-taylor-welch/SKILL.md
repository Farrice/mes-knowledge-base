---
name: "source-command-taylor-welch"
description: "taylor-welch — full expert front door: Wealth psychology + consulting-business mechanics for coaches/consultants. Skills: taylor-welch-wealthy-consultant."
---

# source-command-taylor-welch

Use this skill when the user asks to run the migrated source command `taylor-welch`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/taylor-welch/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY taylor-welch for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| taylor-welch-wealthy-consultant | `skills/taylor-welch-wealthy-consultant/SKILL.md` | `skills/taylor-welch-wealthy-consultant/genius.md` | `skills/taylor-welch-wealthy-consultant/workflows/01-rewire-wealth-identity.md` |
