---
name: "source-command-nir-eyal"
description: "nir-eyal — full expert front door: Habit design, distraction engineering, behavior-change architecture for coaching offers. Skills: nir-eyal-habit-design."
---

# source-command-nir-eyal

Use this skill when the user asks to run the migrated source command `nir-eyal`.

## Command Template

<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/nir-eyal/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY nir-eyal for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| nir-eyal-habit-design | `skills/nir-eyal-habit-design/SKILL.md` | `skills/nir-eyal-habit-design/genius.md` | `skills/nir-eyal-habit-design/workflows/01-design-client-habit-system.md` |
