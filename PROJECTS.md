...
| `health-performance-ip-library` | _active/ | `_active/health-performance-ip-library/INDEX.md` | 2026-08-07 | active* |
| `linkedin-launch` | _active/ | `_active/linkedin-launch/CAMPAIGN.md` | 2026-08-07 | active* |
...
| `dwa-affiliate-battle-test` | _active/ | `_active/dwa-affiliate-battle-test/00-start-here/DEPLOY.md` | 2026-07-07 | parked* |
...
- **missing_index** — `_active/youtube-notion-replication`: no INDEX.md — project has no entry point
