...
- **[contradiction_zone]** `domain:seo` — 11 files contain strong assertions — review for consistency
...
- **[contradiction_zone]** `domain:strategy` — 29 files contain strong assertions — review for consistency
- **[contradiction_zone]** `domain:screenwriting` — 18 files contain strong assertions — review for consistency
