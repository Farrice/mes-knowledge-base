---
description: Turn messy client context into audits, SOPs, playbooks, implementation maps, delivery briefs, and client-ready assets
---
...
```bash
/client-delivery-agent [goal/context/source]
/client-delivery-agent --deep [high-stakes or complex goal]
/client-delivery-agent --council [multi-perspective goal]
```
...
1. `agents/client-delivery-agent/AGENT.md`
2. `agents/client-delivery-agent/memory/context.md`
3. `.agent/client-delivery-agent-state.md` if present
...
```markdown
# Client Delivery Agent Output: [Goal]
