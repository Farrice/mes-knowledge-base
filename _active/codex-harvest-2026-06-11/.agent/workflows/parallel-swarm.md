...
```bash
python /Users/farricecain/Codex\ Antigravity/execution/parallel_swarm.py "YOUR OBJECTIVE HERE"
```

2. Run with specific agents:
```bash
python /Users/farricecain/Codex\ Antigravity/execution/parallel_swarm.py --agents "cardinal-mason,harry-dry,shaan-puri" "YOUR OBJECTIVE HERE"
```

3. Run with more agents (up to 10):
```bash
python /Users/farricecain/Codex\ Antigravity/execution/parallel_swarm.py --max-agents 8 "YOUR OBJECTIVE HERE"
```

4. Preview the plan without executing:
```bash
python /Users/farricecain/Codex\ Antigravity/execution/parallel_swarm.py --plan-only "YOUR OBJECTIVE HERE"
```

5. **Grounded mode** — agents self-search Google during generation:
```bash
python /Users/farricecain/Codex\ Antigravity/execution/parallel_swarm.py --grounded "YOUR OBJECTIVE HERE"
```
...
All outputs are saved to `/Users/farricecain/Codex Antigravity/swarm_outputs/`:
