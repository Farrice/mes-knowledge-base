---
description: Apply excellence, taste, anti-slop, originality, depth, craft, and usefulness standards before final output
---

# /quality-judge - Quality Judge Agent
...
```bash
/quality-judge [goal/context/source]
/quality-judge --deep [high-stakes or complex goal]
/quality-judge --council [multi-perspective goal]
```
...
1. `agents/quality-judge/AGENT.md`
2. `agents/quality-judge/memory/context.md`
3. `.agent/quality-judge-state.md` if present
...
```markdown
# Quality Judge Agent Output: [Goal]
