---
description: Clarify positioning, category, core message, audience belief, value proposition, story, and market contrast
---

# /messaging-positioning-agent - Messaging & Positioning Agent
...
```bash
/messaging-positioning-agent [goal/context/source]
/messaging-positioning-agent --deep [high-stakes or complex goal]
/messaging-positioning-agent --council [multi-perspective goal]
```
...
1. `agents/messaging-positioning-agent/AGENT.md`
2. `agents/messaging-positioning-agent/memory/context.md`
3. `.agent/messaging-positioning-agent-state.md` if present
...
- /message-audit
- /storybrand
- /brain-glue-core-message
- /offer-positioning-north-star
- /fladlien-offer
- /positioning
...
```markdown
# Messaging & Positioning Agent Output: [Goal]
