...
```bash
cd "/Users/farricecain/Codex Antigravity" && python execution/discover_notebooks.py --add
```
...
```bash
cd "/Users/farricecain/Codex Antigravity" && python execution/discover_notebooks.py --list
```
