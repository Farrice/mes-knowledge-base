...
This runs the full Codex chain from `CODEX.md`: intent, routing, loading, production, verification, quality gate, steering, and lesson. It's the system at maximum power — multiple experts, writers' room treatment, scored quality gate, complete logging. Use this for pieces where quality matters more than speed.
