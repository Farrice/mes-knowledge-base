---
description: Generate remarkable ideas, concepts, angles, frameworks, creative territories, and cross-domain synthesis without generic brainstorming
---
...
```bash
/ideation-agent [goal/context/source]
/ideation-agent --deep [high-stakes or complex goal]
/ideation-agent --council [multi-perspective goal]
```
...
1. `agents/ideation-agent/AGENT.md`
2. `agents/ideation-agent/memory/context.md`
3. `.agent/ideation-agent-state.md` if present
...
- /creative-prompt
- /non-obvious-frame-forge
- /conceptual-estrangement
