# 🚀 Antigravity Workflows — Complete Index (413 Commands)
...
| `/deep-research` | Research Grounding System V1 — Gemini-first deep research router with Perplexity/web fallback, source ledger, QA gate, and optional Google Docs export |
...
## 🎯 ICP & Consumer Research — Dai Media (8)
| Command | What It Does |
|---------|-------------|
| `/avatar-content-elevation` | Build an ICP-led, emotionally resonant, platform-native content launch package with avatar, belief map, content strategy, LinkedIn posts, platform cascade, and voice-memo prompts |
...
| `/first-10k` | Build a service-first path to the first $5K-$10K with buyer belief intelligence, offer construction, acquisition, proof, delivery, and outcome loop |
| `/lifestyle-business` | Design a 6-figure business around your ideal life |
| `/offer-positioning-north-star` | Build truth-grounded mission, positioning, offer architecture, service delivery, triage conversion, and proof map |
| `/offer-cycle` | Detect hot offers, design entry offers, plan cycle rotation |
| `/service-first-productization` | Choose and run an evidence-grounded paid-proof service path with market reality checks, buyer-pathway positioning, 14-day execution, proof capture, and productization gates |
...
| `/impeccable` | Namespaced Impeccable bridge for frontend taste, critique, polish, anti-slop QA, and design craft |
...
| Command | What It Does |
|---------|-------------|
| `/goal` | Codex native goal mode bridge - set, inspect, pause, resume, or clear long-running measurable work |
