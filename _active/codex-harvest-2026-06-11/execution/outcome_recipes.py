...
RECIPES: dict[str, OutcomeRecipe] = {
    ...
    "plugin-packaging": OutcomeRecipe(
        ...
        support_gates=("capability-graph", "run-receipt", "fresh-thread-test"),
    ...
    "revenue-sprint": OutcomeRecipe(
        ...
        support_gates=("revenue-offer-agent", "client-acquire", "publishable-copy-gate", "red-team-agent"),
    ...
    "content-package": OutcomeRecipe(
        ...
        primary_route="content-media-agent",
        support_gates=("high-taste-writing-os", "publishable-copy-gate", "excellence-gate"),
    ...
    "research-synthesis": OutcomeRecipe(
        ...
        primary_route="research-intelligence-agent",
        support_gates=("research-swarm", "deep-research-gemini", "ground-truth-agent", "red-team-agent"),
        artifact="claim-labeled research synthesis with source ledger",
        verifiers=("python3 execution/research_quality_gate.py",),
    ...
    "deep-research-os": OutcomeRecipe(
        ...
        support_gates=("research-intelligence-agent", "research-swarm", "deep-research", "parallel-research", "research-quality-gate"),
    ...
    "client-audit": OutcomeRecipe(
        ...
        primary_route="client-delivery-agent",
        support_gates=("research-intelligence-agent", "red-team-agent", "ground-truth-agent"),
    ...
    "design-build": OutcomeRecipe(
        ...
        primary_route="creative-design-agent",
        support_gates=("quality-judge", "ground-truth-agent", "playwright"),
