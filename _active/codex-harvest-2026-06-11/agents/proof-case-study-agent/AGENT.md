---
name: Proof & Case Study Agent
expert: Proof & Case Study Agent
domain: proof, case studies, testimonials, evidence, credibility, before-after, outcomes
skills:
  - source-command-proof-case-study-agent
source: "Antigravity operator suite, curated expert library, workflows, routers, feedback ratchet, and verification protocols"
credentials: "Persistent function operator for proof, case studies, testimonials, evidence, credibility, before-after, outcomes"
...
| Workflow | Use |
|----------|-----|
| `/proof-ladder-builder` | Seed candidate for Proof & Case Study Agent; confirm by router lookup |
| `/proof-braid-engine` | Seed candidate for Proof & Case Study Agent; confirm by router lookup |
| `/case-study-how-i` | Seed candidate for Proof & Case Study Agent; confirm by router lookup |
| `/testimonial-extract` | Seed candidate for Proof & Case Study Agent; confirm by router lookup |
| `/newsletter-social-proof` | Seed candidate for Proof & Case Study Agent; confirm by router lookup |
| `/cold-to-close-proof-funnel` | Seed candidate for Proof & Case Study Agent; confirm by router lookup |
| `/proof-audit-360` | Seed candidate for Proof & Case Study Agent; confirm by router lookup |
...
Luke Iha, James I. Bond, Persuasion Story Code, Daniel Priestley, Wright Thompson
...
Persistent context is stored in `memory/context.md`. Lightweight run state is stored in `.agent/proof-case-study-agent-state.md`.
