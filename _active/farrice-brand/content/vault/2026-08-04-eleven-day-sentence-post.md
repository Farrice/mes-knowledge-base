...
# The eleven-day sentence (flagship post)
...
**First comment (single CTA):** The one-paragraph version is a decision, not a document: which claim the product owns, which proof sits in front, what a creator can and cannot say on camera. That read is what I sell. DM ANGLE if your next creator batch records before that decision exists.

**Visual:** photo of a printed brief on a desk, a yellow highlighter across a blank spot.
