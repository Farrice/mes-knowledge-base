...
| Required files loaded | `.agent/workflows/high-taste-writing-os.md`, `.agents/skills/source-command-high-taste-writing-os/SKILL.md`, `_active/codex-repeatability/v4-high-taste-output-os.md` |
