...
Output: _active/system-audit/06-system/full-dependency-report-2026-05-05.md
"""
import re
...
OUT = ROOT / "_active/system-audit/06-system/full-dependency-report-2026-05-05.md"
OUT.write_text("\n".join(lines))
print(f"Report: {OUT}")
