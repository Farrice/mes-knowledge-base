...
## Purpose
LIVE INFRASTRUCTURE — the render environment `/create-video` drives (`cd _active/video-studio/remotion-studio && npm start`). Compositions go in `src/`. Do not archive; the workflow shells into this path.
