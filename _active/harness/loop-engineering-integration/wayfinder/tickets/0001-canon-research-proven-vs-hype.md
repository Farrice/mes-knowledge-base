...
AFK — deep-research agent + `execution/research.py`, Recall grounding pass first. Deliverable: markdown summary saved as a linked asset in `_active/harness/loop-engineering-integration/`, Receipt-carrying. Do NOT map onto our system yet — that is ticket 0003's job.
