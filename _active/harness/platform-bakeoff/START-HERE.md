...
- `04-deliverables/capability-matrix.md` — touched 2026-08-07
- `04-deliverables/PROTOCOL.md` — touched 2026-08-07

**tasks**

- `tasks/task-02-copy-block-cold-start.md` — touched 2026-08-07
- `tasks/task-06-python-build.md` — touched 2026-08-07
- `tasks/task-05-extraction-pass.md` — touched 2026-08-07
- `tasks/task-04-brand-os-section.md` — touched 2026-08-07
- `tasks/task-03-research-receipts.md` — touched 2026-08-07
- `tasks/task-01-linkedin-from-transcript.md` — touched 2026-08-07
