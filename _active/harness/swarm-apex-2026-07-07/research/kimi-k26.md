...
## Sources
Primary: HF Kimi-K2-Thinking model card. Secondary: MarkTechPost (Kimi Work), SCMP (OK Computer), Nate's Newsletter (firsthand), BenchLM/GMI Cloud/Kili aggregators (flagged UNCONFIRMED where untraceable to a Moonshot primary). Internal: Recall funding/architecture cards, `_active/harness/codex-harvest-2026-06-11/execution/kimi_swarm.py` (prior internal modeling).
