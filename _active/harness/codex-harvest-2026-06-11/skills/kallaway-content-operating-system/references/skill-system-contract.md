...
| Human checkpoint | Skip for local reversible Codex Antigravity use. Ask before external publishing, paid/private tooling, broad deletion, or any action outside this workspace. |
