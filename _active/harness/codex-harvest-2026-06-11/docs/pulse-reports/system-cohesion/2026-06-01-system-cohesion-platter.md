# Weekly System Cohesion Platter, 2026-06-01
...
**Generated**: 2026-06-01 15:35 UTC
...
|--------|-------------|----------|----------|-------|
| antigravity-orchestrator | 2 | 0 | 0 | 0 |
| evolution-agent | 2 | 0 | 0 | 0 |
...
| Registrar inbox drafts | 53 | session_log_registrar |
| Registrar skipped candidates | 380 | session_log_registrar |
...
| Routing decisions | 2 | routing_intelligence |
...
|--------|--------|-------------|---------|--------|
| Performance Log (Phase 1) | ACTIVE | 20 days ago | 20 | Growing |
...
| Session State | STALE | 8 days ago (2026-05-23 20:29) | — | Stale |
| Routing Intelligence | ACTIVE | — | 2 | Healthy |
...
| `ag_098e70e9e1b2` | MEDIUM | already-queued | Refresh session state capture | Last updated: 8 days ago (2026-05-23 20:29) | Use the next real closeout to refresh session state and verify the registrar sees it. |
| `ag_b6b055c2be2f` | MEDIUM | already-queued | Review registrar inbox before new automation | Uncertain performance candidates are waiting in .agent/performance-log-inbox.jsonl. | Approve, revise, or discard inbox drafts one by one. Keep ambiguous candidates out of committed performance evidence. |
...
| `ag_48b1085848a8` | LOW | already-queued | Queue gap detection
