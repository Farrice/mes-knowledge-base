...
```bash
# Single file
mv ~/Downloads/[extraction-file].md ~/Codex\ Antigravity/knowledge/extractions/inbox/

# Multiple files (same expert, multiple parts)
mv ~/Downloads/Claude-*[expert-name]*.md ~/Codex\ Antigravity/knowledge/extractions/inbox/
```
...
```bash
mkdir -p ~/Codex\ Antigravity/agents/[expert-name]/memory
```
...
```bash
cd ~/Codex\ Antigravity/agents/[expert-name]
...
```bash
mv ~/Codex\ Antigravity/knowledge/extractions/inbox/[expert-name]*.md \
   ~/Codex\ Antigravity/knowledge/extractions/processed/
```
...
```bash
# 1. Move to inbox
mv ~/Downloads/Claude-*[EXPERT]*.md ~/Codex\ Antigravity/knowledge/extractions/inbox/

# 2. Rename files
cd ~/Codex\ Antigravity/knowledge/extractions/inbox/
