...
This project wrapper follows `.agent/workflows/expert-composition-governor.md`
as the canonical behavior source. It must stay a thin compatibility wrapper and
preserve:
