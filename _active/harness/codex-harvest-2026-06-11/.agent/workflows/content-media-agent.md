---
description: Turn insight and source material into high-retention posts, newsletters, scripts, media assets, atomization plans, and content systems
---
...
Own the transformation of insight into publishable media that builds authority, demand, proof, and audience memory.

## Usage

```bash
/content-media-agent [goal/context/source]
/content-media-agent --deep [high-stakes or complex goal]
/content-media-agent --council [multi-perspective goal]
```
...
1. `agents/content-media-agent/AGENT.md`
2. `agents/content-media-agent/memory/context.md`
3. `.agent/content-media-agent-state.md` if present
...
- /atomize
- /newsletter-value-draft
- /high-dwell
- /voice-first-content
- /content-bundle
- /content-series-plan
- /fourth-wall-content-engine
...
```markdown
# Content & Media Agent Output: [Goal]
...
- **Needs offer or funnel tie-in** -> Marketing Agent or Revenue & Offer Agent
- **Needs stronger copy** -> Copywriting Agent
- **Needs factual grounding** -> Research Intelligence Agent
