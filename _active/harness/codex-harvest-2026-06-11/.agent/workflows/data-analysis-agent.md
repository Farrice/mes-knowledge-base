---
description: Interpret metrics, experiments, routing patterns, revenue outcomes, false proxies, and performance data
---
...
```bash
/data-analysis-agent [goal/context/source]
/data-analysis-agent --deep [high-stakes or complex goal]
/data-analysis-agent --council [multi-perspective goal]
```
...
1. `agents/data-analysis-agent/AGENT.md`
2. `agents/data-analysis-agent/memory/context.md`
3. `.agent/data-analysis-agent-state.md` if present
...
```markdown
# Data & Analysis Agent Output: [Goal]
