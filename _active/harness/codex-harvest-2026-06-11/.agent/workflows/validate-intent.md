...
Start by producing the Co-Creative Launchpad Packet: predicted need, center,
edges, what good looks like, missing inputs, questions that change execution,
route bias, pause/run decision, and handoff. Then run the 4-stage intent
pipeline:
