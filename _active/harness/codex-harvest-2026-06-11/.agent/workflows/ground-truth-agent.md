---
description: Manage expert benchmarks, blind comparisons, proof calibration, expert-gap reports, and world-class quality evidence
---

# /ground-truth-agent - Ground Truth Agent
...
```bash
/ground-truth-agent [goal/context/source]
/ground-truth-agent --deep [high-stakes or complex goal]
/ground-truth-agent --council [multi-perspective goal]
```
...
1. `agents/ground-truth-agent/AGENT.md`
2. `agents/ground-truth-agent/memory/context.md`
3. `.agent/ground-truth-agent-state.md` if present
...
```markdown
# Ground Truth Agent Output: [Goal]
