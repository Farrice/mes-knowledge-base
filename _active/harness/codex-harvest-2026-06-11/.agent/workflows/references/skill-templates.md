...
Frontmatter in this file applies to system surfaces such as `SKILL.md`, workflow files, command bridges, and agent specs. Do not copy this pattern into human-facing written deliverables; those must open with readable content and put metadata in a sidecar `.metadata.json`.
