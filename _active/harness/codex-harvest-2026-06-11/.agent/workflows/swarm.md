...
```
/Users/farricecain/Codex Antigravity/skills/swarm-commander/SKILL.md
```
...
```
/Users/farricecain/Codex Antigravity/skills/swarm-commander/references/genius-patterns.md
```
...
Read and apply:
```
/Users/farricecain/Codex Antigravity/skills/swarm-commander/references/prompts/swarm-planning.md
```
...
Read and apply:
```
/Users/farricecain/Codex Antigravity/skills/swarm-commander/references/prompts/agent-constellation.md
```
...
Read and apply:
```
/Users/farricecain/Codex Antigravity/skills/swarm-commander/references/prompts/batch-execution.md
```
...
Read and apply:
```
/Users/farricecain/Codex Antigravity/skills/swarm-commander/references/prompts/swarm-synthesis.md
```
