---
description: Find blind spots, false confidence, weak evidence, generic thinking, failure modes, and audience objections before shipping
---
...
```bash
/red-team-agent [goal/context/source]
/red-team-agent --deep [high-stakes or complex goal]
/red-team-agent --council [multi-perspective goal]
```
...
1. `agents/red-team-agent/AGENT.md`
2. `agents/red-team-agent/memory/context.md`
3. `.agent/red-team-agent-state.md` if present
