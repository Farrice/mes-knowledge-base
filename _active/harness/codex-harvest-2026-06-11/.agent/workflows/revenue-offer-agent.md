---
description: Design paid audits, productized services, pricing, offer stacks, revenue paths, and monetization systems
---
...
```bash
/revenue-offer-agent [goal/context/source]
/revenue-offer-agent --deep [high-stakes or complex goal]
/revenue-offer-agent --council [multi-perspective goal]
```
...
1. `agents/revenue-offer-agent/AGENT.md`
2. `agents/revenue-offer-agent/memory/context.md`
3. `.agent/revenue-offer-agent-state.md` if present
...
```markdown
# Revenue & Offer Agent Output: [Goal]
