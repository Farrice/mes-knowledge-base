...
This workflow is a companion layer. It does not replace `/farrice-content-os`, `/diandra-linkedin-system`, `/kallaway-trend-hook-engine`, `/high-taste-writing-os`, or `/publishable-copy-gate`.
...
7. `.agent/workflows/farrice-content-os.md` when the hook should become a Farrice content package
8. `.agent/workflows/diandra-linkedin-system.md` when the hook work is part of the full LinkedIn OS
...
| Reuse hook | Use inside `/farrice-content-os` Hook Room and `/diandra-linkedin-system` hook bottlenecks |
...
- Farrice content package -> `/farrice-content-os`
- LinkedIn post -> `/diandra-content-engine`
- LinkedIn system -> `/diandra-linkedin-system`
...
/attention-hijack-hooks content "selected hook: ..." --route farrice-content-os
```
