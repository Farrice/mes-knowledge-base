...
Wait for explicit user approval. When this workflow is recommended by
Autopilot, show the deployment plan and approval prompt, but do not spawn agents
or run external/budgeted research until Farrice approves execution after the
checkpoint.
