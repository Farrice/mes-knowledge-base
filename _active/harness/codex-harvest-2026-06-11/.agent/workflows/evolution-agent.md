---
description: Detect recurring gaps, queue supervised improvements, benchmark variants, and evolve workflows without uncontrolled auto-deployment
---
...
```bash
/evolution-agent [goal/context/source]
/evolution-agent --deep [high-stakes or complex goal]
/evolution-agent --council [multi-perspective goal]
```
...
1. `agents/evolution-agent/AGENT.md`
2. `agents/evolution-agent/memory/context.md`
3. `.agent/evolution-agent-state.md` if present
