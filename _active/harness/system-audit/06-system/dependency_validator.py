...
Output: _active/harness/system-audit/06-system/dependency-report-2026-05-05.md
"""
import re, os
...
OUT = ROOT / "_active/harness/system-audit/06-system/dependency-report-2026-05-05.md"
OUT.write_text("\n".join(lines))
print(f"Report: {OUT}")
