...
"""One-off inventory: classify each .agent/workflows/*.md as substantive / router-functional / router-broken / empty,
   ...
   Output: _active/harness/system-audit/06-system/workflow-coverage-2026-05-05.md
"""
import os, re, sys
...
OUT = ROOT / "_active/harness/system-audit/06-system/workflow-coverage-2026-05-05.md"
