...
- `_active/harness/system-audit/06-system/inventory_pass.py` — workflow file classifier (substantive vs router vs broken)
- `_active/harness/system-audit/06-system/dependency_validator.py` — perception path dependency checker (22 workflows)
- `_active/harness/system-audit/06-system/dependency_validator_full.py` — full-system dependency checker (1,294 workflows)

**Audit reports:**
- `_active/harness/system-audit/06-system/audit-2026-05-05.md` — system_audit.py output
- `_active/harness/system-audit/06-system/routing-2026-05-05.md` — routing_audit.py output
- `_active/harness/system-audit/06-system/workflow-coverage-2026-05-05.md` — custom inventory report
- `_active/harness/system-audit/06-system/broken-workflow-resolution-2026-05-05.md` — fix log
- `_active/harness/system-audit/06-system/dependency-report-2026-05-05.md` — perception path detail
- `_active/harness/system-audit/06-system/full-dependency-report-2026-05-05.md` — system-wide dependency status (zero issues)
- `_active/harness/system-audit/06-system/READINESS-FINAL-2026-05-05.md` — this file
