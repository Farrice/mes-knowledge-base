...
**Moved to its own marked folder: [`_active/offer-strategy/path-decision-2026-07-01/`](../../path-decision-2026-07-01/README.md)** — open its README for the ruling, reading order, binding rules, and all 7 artifacts (final verdict, council synthesis + adversary + raw debate, 3 sourced research reports).
