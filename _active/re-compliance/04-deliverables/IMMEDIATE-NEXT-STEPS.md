...
4. Save to `_active/re-compliance/04-deliverables/receipts/jen-listing-[NUMBER]-audit.json`
...
1. **Create summary document** (`_active/re-compliance/04-deliverables/summary.md`)
...
- [ ] **Commit to git**
  ```bash
  git add _active/re-compliance/04-deliverables/receipts/jen-listing-*.json
  git add _active/re-compliance/04-deliverables/summary.md
  git add _active/re-compliance/04-deliverables/screenshots/ (if created)
