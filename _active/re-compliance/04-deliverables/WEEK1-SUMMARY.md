...
**Documents** (in `_active/re-compliance/04-deliverables/`):
...
| Coordination Docs | `_active/re-compliance/04-deliverables/` |
| Email Template | `_active/re-compliance/04-deliverables/JEN-EMAIL-TEMPLATE.md` |
| Intake Template | `_active/re-compliance/04-deliverables/JEN-LISTING-INTAKE-TEMPLATE.md` |
| QA Checklist | `_active/re-compliance/04-deliverables/RECEIPT-VALIDATION-CHECKLIST.md` |
