...
> **Target:** founders of sub-$15M supplement / performance / sports-science brands, the people for whom the walkthrough is a personal yes. Not Head-of-Brand at Create/GNC/Noom scale (they get the comment-orbit nurture, not week-1 DMs).
> **Motion:** 10 DMs/week. Warm first where you can (comment on their occasion two or three times), but these run cold-capable.
> **Voice:** Farrice BLEND. Statement hooks, I-narrative on the proof beats, no generic-question signoffs.
> **Price in copy:** shown as `$350`, and it flexes `$250–500` by brand size and scope. Personalize every `[bracket]`, and verify the occasion on LinkedIn first. Don't fabricate one.
> **Claim-safe:** the AI-search screenshot is a PRIVATE value-drop to that founder only. Not a public named-brand claim-risk assertion (doc teardown rule, 2026-07-18).

---

## FIRST-TOUCH VARIANTS (pick by signal, each ≤ ~60 words)

### V1: Proof-led
> Best when you can run their category question live. The screenshot is free value before any ask.
...
### V2: Observation-led
> Needs a real, verified occasion: a raise, a retail rollout, a rebrand, a launch date.

Saw the `[Target rollout / Series B / rebrand]`. The product's clearly ready. The sentence underneath it, the one your retail buyer repeats back to their boss, usually isn't this close to a launch.

I pressure-test that sentence live, 60 minutes against 12 questions, before you spend into the launch. $350. Two slots open this week if you want one.

---

### V3: Mutual-context
> Only run this with a genuine mutual. If you don't have one, fall back to V1.

`[Mutual]` mentioned you're heading into `[occasion]`. Reason I'm reaching out: I coached bodies for 18 years before I wrote a word of supplement copy, so I read what the ingredient actually does, not just how it sounds on a slide.

I do that live in an hour on your launch message and hand you a one-page readout. $350. Happy to send times if it's the right week.

---

### V4: Contrarian
> Good for founders already chasing AI visibility. It flips the order most founders work in.

Most founders fix their visibility before they fix their message. Backwards. The machine can't repeat a sentence you haven't finished writing, so you end up paying to stay invisible in higher resolution.

I settle the sentence first: one live hour, 12 questions, a page of findings you keep. $350. If you're pre-launch, I'll send a couple of times this week.
...
## FOLLOW-UP SEQUENCE (non-responders: value first, no pestering)

### FU1: Value drop, no ask (send ~3–4 days after first touch)
...
## TRANSITION SCRIPT: Walkthrough Delivered to Sprint Pitch (2 lines)
