...
## POST 1 — "The Magnesium Answer ChatGPT Keeps Getting Wrong"

**Pillar:** P2 AI & Future of Wellness · **Blend:** Physiology × Misconception Correction on an AI answer · **Template:** Signature (Physiology Misconception Correction, evergreen mode) · **Hook format:** Anomaly-in-a-scene (someone did everything right and the body didn't cooperate) · **GET:** A 10-second test to tell whether an AI supplement answer is grounded in absorption physiology or just repeating a label · **Surprise (what model breaks):** "AI is wrong about supplements when it lies about what works" → the model breaks: AI is most wrong precisely when it's technically *correct* — it names the right compound and skips the only variable that decides whether your body sees it.
...
## POST 2 — "I Asked ChatGPT to Defend Five Supplement Claims. Three Folded."

**Pillar:** P2 AI & Future of Wellness · **Blend:** Red-Team My Claim (physiology × investigative due-diligence; Thesis / stress-test / Verdict / Receipt) · **Template:** Investigative teardown with a Misconception-Correction turn · **Hook format:** Public scarce-capability demonstration (I ran the test you can't, live) · **GET:** The exact 3-part interrogation Farrice runs on any AI supplement claim — a repeatable script the reader can run themselves tonight · **Surprise (what model breaks):** "AI is unreliable, so I should trust experts instead" → breaks: AI isn't randomly unreliable — it fails on a *predictable seam* (efficacy/mechanism), and once you see the seam you can interrogate any AI claim yourself instead of outsourcing trust again.
...
**Banned-move check:** 0 negate-then-reveal aphorisms · 0 triple anaphora (the numbered script is a labeled procedure handed to the reader, not rhetorical anaphora) · 0 "Here's what/why" reveal openers · em dashes: 0 (QA pass; the only "—" remaining is inside the [LIKELY — PMC 2026] citation tag, not prose) · close is a tangible instruction (run it tonight), not a cheap question · only labeled fact used (57% PMC marked LIKELY); FTC standard stated as the named legal standard, not a stat · hook (to "Three of the five folded inside two follow-up questions.") ≈ 205 chars.

---

## POST 3 — "A Wellness Brand Just Got Cited by AI for a Claim It Can't Legally Make" *(NEWSJACK)*

**Pillar:** P2 AI & Future of Wellness · **Blend:** Newsjack × Misconception Correction on an AI answer + the Claim-Safety read (the two-gate seam, made public) · **Template:** Signature (Physiology Misconception Correction, newsjack mode) · **Hook format:** Entity-named tension in first 2 lines (the borrowed-attention mechanism) · **GET:** The one question that tells a brand whether an AI citation is an asset or a liability — and the rule that the FTC gate and the AI-trust gate are now the same gate · **Surprise (what model breaks):** "Getting named by ChatGPT is the win" → breaks: a citation can be the *exposure* — the machine just published your most regulator-exposed sentence to every buyer, in your name, with your authority on it.

> **Newsjack note:** the specific brand + AI answer below is a representative pattern, marked **[VERIFY LIVE]** — before posting, swap in a real, currently-circulating example you've screenshotted from ChatGPT/AI Overviews this week. The physiology and the FTC standard are real. The mechanism transfers to any "[brand] + treats/prevents/balances" AI citation.
...
**[--cta example] (post as the first comment, soft discussion-CTA, clearly labeled):**
...
**Banned-move check:** 0 "It's not X, it's Y." · 0 triple anaphora · 0 "Here's what/why/how" reveal openers (the "Here's the seam" is a single handoff line, not a stacked reveal pattern) · em dashes: 0 in prose (QA pass; remaining "—" are inside the [VERIFY LIVE] and [VERIFIED] tags only) · close is an image/recognition beat (read the verb), not a cheap question; the question lives only in the labeled first-comment CTA, where a discussion-CTA belongs · facts: FTC $53,088 + 21 CFR 101.93 both VERIFIED; brand/AI-answer example marked [VERIFY LIVE] · entity named in first 2 lines (borrowed-attention) · hook (to "I'd treat it as a notice.") ≈ 188 chars.

---

## Build notes (why these clear the 8/10 bar, not a recap)
...
**FLAG:** Post 3's brand + AI-answer example is a representative pattern marked **[VERIFY LIVE]** — it MUST be replaced with a real, screenshotted, currently-circulating citation before posting (the physiology and the FTC facts are real and verified; the specific named instance is not). Posting the pattern as if it's a confirmed live event would violate factual grounding.
