...
| 11 | Non-About profile copy (Experience ×3, Featured ×3, Services) to the Take A bar | 🔴 BLOCKED ON FARRICE — v3 rejected; v4–v7 drafts exist but have no approval or felt verdict. **Spiral brake remains armed: do not generate another rendition.** | `../03-launch/2026-07-29-profile-copy-v3-PENDING-VERDICT.md` (negative reference) · v4–v7 drafts (unapproved) |
