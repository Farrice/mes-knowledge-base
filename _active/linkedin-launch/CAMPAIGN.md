...
| 2b | External activation: send first 5 verified one-gap DMs and log them; add real $750 payment rail before second touch/quote | 🔴 OPEN — starts Day 1 | cash-first activation + one-gap DM system + Angle Map packet |
