...
- **Voice profile**: `_active/coach-cooz/15-final-package/03-cooz-voice-profile.md`
- **Content pillars + psychographic map**: `_active/coach-cooz/15-final-package/02-man-in-the-valley-playbook.md`
- **The Ignition Plan** (Section 5 for content rules): `_active/coach-cooz/15-final-package/01-THE-IGNITION-PLAN.md`
- **Voice guide** (signature phrases + ban list): `_active/coach-cooz/05-offers-and-frameworks/VOICE-GUIDE.md`
- **8 Tenets curriculum** (Lane A educational content): `_active/coach-cooz/05-offers-and-frameworks/8-TENETS-FRAMEWORK.md`
- **WS1.6 voice rule** (Sheedy 6-step template): `_active/coach-cooz/03-research/WS1.6-voice-validation-and-data-recovery.md`
