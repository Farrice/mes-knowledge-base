...
- `_active/clients/andrea-dj/launch/03-visual-variants/variant-a-hero-shots-v3/` — 8 Editorial Broadsheet shots
- `_active/clients/andrea-dj/launch/03-visual-variants/variant-b-hero-shots-v3/` — 7 Latin-American Modernism shots
- `_active/clients/andrea-dj/launch/03-visual-variants/variant-c-hero-shots-v3/` — 8 Restrained Marble + Sage shots
