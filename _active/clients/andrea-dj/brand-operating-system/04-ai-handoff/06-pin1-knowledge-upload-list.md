...
1. **_active/clients/andrea-dj/brand-operating-system/04-ai-handoff/03-constitution-core.md**
...
2. **_active/clients/andrea-dj/brand-operating-system/00-foundation/05-non-negotiables.md**
...
3. **_active/clients/andrea-dj/brand-operating-system/05-ops/03-drift-signals.md**
...
4. **_active/clients/andrea-dj/brand-operating-system/00-foundation/03-voice-document.md**
...
5. **_active/clients/andrea-dj/brand-operating-system/00-foundation/04-positioning-one-pager.md**
...
6. **_active/clients/andrea-dj/brand-operating-system/02-briefs/press-one-sheeter.md**
   - Press reply template + key talking points
   - *Why*: If Andrea gets a media inquiry, PIN 1 can draft a response

7. **_active/clients/andrea-dj/brand-operating-system/02-briefs/venue-pitch.md**
...
8. **_active/clients/andrea-dj/brand-operating-system/01-visual/DESIGN.md**
...
1. **Format**: Copy the absolute file path (e.g., `/Users/farricecain/Google Antigravity/_active/clients/andrea-dj/brand-operating-system/...`)
