...
| 4 | AMPLIFY | ONE pen (Alyssa hook-reframe + Luke Iha hooks, nothing else) makes one sharpening pass; ONE check (Jen-as-herself from the voice profile + calibration log) reverts any line she would not say. No expert room in Phase 1 (`PHASES.md`; Farrice 2026-09-02 second pass: "expert soup") | `AMPLIFY: one pen · N lines sharpened · Jen check reverted N` |
