...
<p style="margin: 0; font-size: 30px; line-height: 1.55; color: {GREY};">everything for september is on this canvas. pages are in the menu at the top. here's the order.</p>
<div style="display: flex; flex-direction: column; gap: 26px;">
  <div style="display: flex; gap: 26px;"><span style="{SERIF} font-style: italic; font-size: 60px; color: {STEEL}; width: 70px; flex: none; line-height: 1;">1</span><div><div style="font-size: 34px; font-weight: 600; color: {NAVY};">the three reels (this page)</div><div style="font-size: 28px; line-height: 1.5; color: {GREY};">each one is a card: the hook, the script, what goes on screen, and the caption. pick the one you'd actually say first. the condo one is my top pick.</div></div></div>
  <div style="display: flex; gap: 26px;"><span style="{SERIF} font-style: italic; font-size: 60px; color: {STEEL}; width: 70px; flex: none; line-height: 1;">2</span><div><div style="font-size: 34px; font-weight: 600; color: {NAVY};">the look: valley native (page 2)</div><div style="font-size: 28px; line-height: 1.5; color: {GREY};">the condo carousel built in a new look for your grid. your colors, your line drawings, real valley places, you in the frame. the rulebook and the photo bank sit next to it.</div></div></div>
  <div style="display: flex; gap: 26px;"><span style="{SERIF} font-style: italic; font-size: 60px; color: {STEEL}; width: 70px; flex: none; line-height: 1;">3</span><div><div style="font-size: 34px; font-weight: 600; color: {NAVY};">all three carousels, copy approved (page 3)</div><div style="font-size: 28px; line-height: 1.5; color: {GREY};">the words are final and sourced. once you pick the look, all three get rebuilt in it.</div></div></div>
  <div style="display: flex; gap: 26px;"><span style="{SERIF} font-style: italic; font-size: 60px; color: {STEEL}; width: 70px; flex: none; line-height: 1;">4</span><div><div style="font-size: 34px; font-weight: 600; color: {NAVY};">two earlier sketches (page 4)</div><div style="font-size: 28px; line-height: 1.5; color: {GREY};">shown so you can see what got left behind and why.</div></div></div>
</div>
