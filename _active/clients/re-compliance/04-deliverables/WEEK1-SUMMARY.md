...
**Documents** (in `_active/clients/re-compliance/04-deliverables/`):
...
| Coordination Docs | `_active/clients/re-compliance/04-deliverables/` |
| Email Template | `_active/clients/re-compliance/04-deliverables/JEN-EMAIL-TEMPLATE.md` |
| Intake Template | `_active/clients/re-compliance/04-deliverables/JEN-LISTING-INTAKE-TEMPLATE.md` |
| QA Checklist | `_active/clients/re-compliance/04-deliverables/RECEIPT-VALIDATION-CHECKLIST.md` |
