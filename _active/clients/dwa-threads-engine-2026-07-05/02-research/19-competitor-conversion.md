...
## Files
- `_active/clients/dwa-threads-engine-2026-07-05/intel/v2/ig-callmekevy.json` — no_items (empty/private)
- `_active/clients/dwa-threads-engine-2026-07-05/intel/v2/ig-abbyxconway.json` — 12 real posts, full captions/engagement
- `_active/clients/dwa-threads-engine-2026-07-05/intel/v2/digests/competitor-candidates-v2.txt`
- `_active/clients/dwa-threads-engine-2026-07-05/intel/v2/digests/tiktok-affiliate.txt`
- `_active/clients/dwa-threads-engine-2026-07-05/intel/v2/digests/tiktok-makemoney.txt`
- `_active/clients/dwa-threads-engine-2026-07-05/02-research/11-competitor-inventory.md` (prior session, referenced not re-derived)
