...
| Document | Path |
|----------|------|
| This cost analysis | `_active/prediction-market-arb/02-research/prediction-market-full-cost-analysis.md` |
| Proposal + talking points + objection handling | `_active/prediction-market-arb/02-research/prediction-market-proposal-package.md` |
| Original business briefing (sent to him) | `_active/prediction-market-arb/02-research/prediction-market-business-briefing.md` |
| Feasibility assessment v2.1 | `_active/prediction-market-arb/02-research/polymarket-kalshi-arbitrage-feasibility.md` |
