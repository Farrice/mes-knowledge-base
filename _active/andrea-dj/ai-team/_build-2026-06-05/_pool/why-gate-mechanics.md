...
The "why-gate" is the application Resonance asks every public-tier attendee to fill out. Not a ticket form. Not a survey. A **single-question filter** that does three things at once:
...
2. **Surfaces the hell-yes** — The right person writes a sentence Andrea reads and immediately knows.
3. **Becomes content** — Anonymous, permission-cleared answers become the most powerful proof Resonance has of who shows up.
...
Read 50 of these and you'll know the pattern within 10. Andrea's gut is the final filter; the question makes the gut's job easy.

### Filter 3: Content Capture

Every answer (with permission) becomes content:

- IG carousel: "Why people are coming to Resonance" — verbatim quotes, anonymous
...
Andrea posts the application link in IG bio + post copy. The link goes to a Google Form (or Tally / Typeform — keep it minimal). Form fields:

1. **Name** (first + last)
2. **Instagram handle** (so Andrea can verify a real human + check vibe in 30 seconds)
3. **Email** (for ticket delivery + follow-up)
4. **Age** (numeric)
5. **Why do you want to be in this room?** (1-2 sentences, ~280 character limit if possible)
6. **How did you hear about Resonance?** (single dropdown: Friend / IG / Press / Other)
...
- Hell-yes (Andrea's read of the why-answer + IG check)
- Soft-yes (might be right; needs follow-up DM)
- Decline (clear filter trip — Hunter, Tourist, generic, etc.)
- Pending (need more info)

Andrea reviews 10-20 applications/day in a 15-min batch. Each gets a 2-second decision based on the why-answer + handle.
...
**48 hours max.** Anything longer kills momentum. Hell-yes applicants who wait 5 days lose 30% to "I forgot." Build the reply ritual into Andrea's daily 15-min Resonance window.

### Hell-Yes Reply Template

> *"Hey [Name] — your answer made me smile. Here's the ticket link for Event #1 on July 18. We've held a spot for you. A few notes you'll want before:*
...
2. **Weekly**: Andrea (or Farrice) reviews permission-cleared answers, pulls 5-10 strongest verbatim.
...
### Failure 2: Andrea Over-Rejects

If decline rate >70%, the bar is too high or Andrea's tired. Mitigation:
...
### Failure 3: Andrea Under-Rejects (Room Contamination)

If the next event has 2-3 contaminants, the bar was too low. Mitigation:

- Post-event: identify which applications produced the contaminants. Flag the patterns Andrea missed.
...
If applications start to feel like a chore for Andrea, the spirit drifts and rejections become rote. Mitigation:
...
- **Phase 1 of Event #1** (25 hand-picked seats): no why-gate, Andrea invites by name.
- **Phase 2 of Event #1** (15 referral seats): no why-gate, but invites flow through Andrea's gut filter.
- **Phase 3 of Event #1** (10 public seats): why-gate runs.

By Event #4-5, as the room scales beyond Andrea's network, the why-gate handles a larger share of inflow and the decision flow above kicks in.
