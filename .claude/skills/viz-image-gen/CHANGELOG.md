...
Image rendering is more faithful and predictable.

### Improved
- Hero and logo images fill their frames correctly instead of leaving gaps or stretching.
- AI-generated backgrounds stay consistent with the post you're building.
- Text in rendered images shrinks to fit cleanly instead of overflowing.
