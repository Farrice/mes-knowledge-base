...
### Added
- **LinkedIn first comment** — after publishing, optionally add a first comment. Useful for keeping links out of the post body to avoid the reach penalty.
- **Draft mode** — publish a post as a draft instead of going live immediately.

### Improved
- More reliable publishing, with clear messages instead of raw errors when the network hiccups.
