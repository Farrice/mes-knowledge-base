---
description: "Manus.ai — full expert front door: expert persona for Manus.ai. Skills: manus-ai-consulting."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/manus-ai/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY Manus.ai for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| manus-ai-consulting | `skills/manus-ai-consulting/SKILL.md` | `skills/manus-ai-consulting/genius.md` | `skills/manus-ai-consulting/workflows/strategic-market-intelligence-report.md` |
