---
description: "Boris — full expert front door: expert persona for Boris. Skills: boris-claude-code."
---
...
|-------|------------------------|-------------------------|-------------------|
| boris-claude-code | `skills/boris-claude-code/SKILL.md` | `skills/boris-claude-code/genius.md` | `skills/boris-claude-code/workflows/ai-workforce-orchestration-system.md` |
