---
description: "PJ Accetturo — full expert front door: expert persona for PJ Accetturo. Skills: pj-accetturo-ai-video."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/pj-accetturo/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY PJ Accetturo for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| pj-accetturo-ai-video | `skills/pj-accetturo-ai-video/SKILL.md` | `skills/pj-accetturo-ai-video/genius.md` | `skills/pj-accetturo-ai-video/workflows/strategic-creative-direction.md` |
