---
description: "lindsay — full expert front door: AI Consulting Sales + Client Acquisition + Multi-Channel Outreach. Skills: lindsay-ai-consulting."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/lindsay/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY lindsay for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| lindsay-ai-consulting | `skills/lindsay-ai-consulting/SKILL.md` | `skills/lindsay-ai-consulting/genius.md` | `skills/lindsay-ai-consulting/workflows/01-ai-offer-strategy-blueprint.md` |
