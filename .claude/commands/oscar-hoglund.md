---
description: "oscar-hoglund — full expert front door: Sound storytelling and emotional umami. Skills: oscar-hoglund-sound-storytelling."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/oscar-hoglund/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY oscar-hoglund for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| oscar-hoglund-sound-storytelling | `skills/oscar-hoglund-sound-storytelling/SKILL.md` | `skills/oscar-hoglund-sound-storytelling/genius.md` | `skills/oscar-hoglund-sound-storytelling/workflows/emotional-umami-content-engine.md` |
