---
description: "alen-sultanic — full expert front door: Advanced copywriting psychology and offer economics. Skills: alen-sultanic-copywriting."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/alen-sultanic/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY alen-sultanic for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| alen-sultanic-copywriting | `skills/alen-sultanic-copywriting/SKILL.md` | `skills/alen-sultanic-copywriting/genius.md` | `skills/alen-sultanic-copywriting/workflows/01-strategic-profit-architecture.md` |
