---
description: "AGENT: Michael Connelly — full expert front door: Vivid fiction writing, detail economy, character craft, momentum prose, dialogue, place-as-character. Skills: michael-connelly-vivid-writing."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/michael-connelly/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY AGENT: Michael Connelly for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| michael-connelly-vivid-writing | `skills/michael-connelly-vivid-writing/SKILL.md` | `skills/michael-connelly-vivid-writing/genius.md` | `skills/michael-connelly-vivid-writing/workflows/telling-detail-engine.md` |
