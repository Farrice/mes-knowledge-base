---
description: "dan-bolton — full expert front door: Coaching offer design, co-creation delivery models, AI-proof expertise businesses, VSL client acquisition. Skills: dan-bolton-coaching-offers."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/dan-bolton/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY dan-bolton for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| dan-bolton-coaching-offers | `skills/dan-bolton-coaching-offers/SKILL.md` | `skills/dan-bolton-coaching-offers/genius.md` | `skills/dan-bolton-coaching-offers/workflows/01-redesign-coaching-offer.md` |
