---
description: "nathan-gotch — full expert front door: AI SEO and retrieval layer optimization. Skills: nathan-gotch-ai-seo."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/nathan-gotch/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY nathan-gotch for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| nathan-gotch-ai-seo | `skills/nathan-gotch-ai-seo/SKILL.md` | `skills/nathan-gotch-ai-seo/genius.md` | `skills/nathan-gotch-ai-seo/workflows/01-ai-seo-infrastructure-blueprint.md` |
