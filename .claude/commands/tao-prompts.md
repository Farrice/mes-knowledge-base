---
description: "Tao Prompts — full expert front door: AI Video Production & Prompt Architecture Expert. Skills: tao-prompts-ai-video."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/tao-prompts/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY Tao Prompts for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| tao-prompts-ai-video | `skills/tao-prompts-ai-video/SKILL.md` | `skills/tao-prompts-ai-video/genius.md` | `skills/tao-prompts-ai-video/workflows/pipeline-engineering-and-storyboarding.md` |
