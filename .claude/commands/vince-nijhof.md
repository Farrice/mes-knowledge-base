---
description: "vince-nijhof — full expert front door: dtc-operator-system. Skills: vince-nijhof-dtc-operator-system."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/vince-nijhof/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY vince-nijhof for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| vince-nijhof-dtc-operator-system | `skills/vince-nijhof-dtc-operator-system/SKILL.md` | `skills/vince-nijhof-dtc-operator-system/genius.md` | `skills/vince-nijhof-dtc-operator-system/workflows/01-data-bank-build.md` |
