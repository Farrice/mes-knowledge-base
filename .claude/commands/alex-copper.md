---
description: "alex-copper — full expert front door: Creative Strategy & Brand Positioning. Skills: alex-copper-creative-strategy."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/alex-copper/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY alex-copper for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| alex-copper-creative-strategy | `skills/alex-copper-creative-strategy/SKILL.md` | `skills/alex-copper-creative-strategy/genius.md` | `skills/alex-copper-creative-strategy/workflows/01-strategic-intelligence-roadmap.md` |
