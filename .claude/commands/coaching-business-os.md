---
description: "coaching-business-os — full expert front door: Business of coaching — offer design, positioning, monetization, client acquisition, transformation delivery. Skills: coaching-business-os."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/coaching-business-os/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY coaching-business-os for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| coaching-business-os | `skills/coaching-business-os/SKILL.md` | `skills/coaching-business-os/genius.md` | `skills/coaching-business-os/workflows/01-diagnose-and-route-business-need.md` |
