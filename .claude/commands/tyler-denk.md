---
description: "tyler-denk — full expert front door: Audience Monetization & Founder-Led Growth. Skills: tyler-denk-audience-monetization."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/tyler-denk/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY tyler-denk for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| tyler-denk-audience-monetization | `skills/tyler-denk-audience-monetization/SKILL.md` | `skills/tyler-denk-audience-monetization/genius.md` | `skills/tyler-denk-audience-monetization/workflows/compounding-growth-distribution-engine.md` |
