---
description: "brendan-kane — full expert front door: Viral content strategy, hook points, social media format research. Skills: brendan-kane-viral-strategy."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/brendan-kane/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY brendan-kane for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| brendan-kane-viral-strategy | `skills/brendan-kane-viral-strategy/SKILL.md` | `skills/brendan-kane-viral-strategy/genius.md` | `skills/brendan-kane-viral-strategy/workflows/01-research-viral-formats.md` |
