---
description: "daniel-pink — full expert front door: Non-fiction writing, book structure, idea validation. Skills: daniel-pink-writing-structure."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/daniel-pink/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY daniel-pink for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| daniel-pink-writing-structure | `skills/daniel-pink-writing-structure/SKILL.md` | `skills/daniel-pink-writing-structure/genius.md` | `skills/daniel-pink-writing-structure/workflows/01-discover-structure.md` |
