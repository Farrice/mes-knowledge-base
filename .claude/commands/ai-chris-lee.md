---
description: "ai-chris-lee — full expert front door: Zero Testimonial Sales + Proof Building + AI Services Positioning. Skills: ai-chris-lee-zero-testimonial-sales."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/ai-chris-lee/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY ai-chris-lee for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| ai-chris-lee-zero-testimonial-sales | `skills/ai-chris-lee-zero-testimonial-sales/SKILL.md` | `skills/ai-chris-lee-zero-testimonial-sales/genius.md` | `skills/ai-chris-lee-zero-testimonial-sales/workflows/zero-to-one-proof-asset-system.md` |
