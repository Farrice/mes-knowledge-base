---
description: "seena-rez — full expert front door: TikTok viral commerce. Skills: seena-rez-tiktok-commerce."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/seena-rez/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY seena-rez for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| seena-rez-tiktok-commerce | `skills/seena-rez-tiktok-commerce/SKILL.md` | `skills/seena-rez-tiktok-commerce/genius.md` | `skills/seena-rez-tiktok-commerce/workflows/market-opportunity-blueprint.md` |
