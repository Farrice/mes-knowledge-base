---
description: "samuel-thompson — full expert front door: AI Info Products & Rapid Launch Methodology. Skills: samuel-thompson-product-launch."
---
<!-- auto-generated: expert front door (sync_registries.py) — safe to delete; regenerated on sync -->

Load `agents/samuel-thompson/AGENT.md` — identity, voice, beliefs, anti-patterns — and EMBODY samuel-thompson for this conversation.
...
|-------|------------------------|-------------------------|-------------------|
| samuel-thompson-product-launch | `skills/samuel-thompson-product-launch/SKILL.md` | `skills/samuel-thompson-product-launch/genius.md` | `skills/samuel-thompson-product-launch/workflows/pre-commitment-demand-thermometer.md` |
