# 🚀 Antigravity Workflows — Complete Index (3227 Commands)
...
## 📚 Complete Command Index — Everything Else (2436)
...
| — **dave-clark** | 3 | `/dave-clark-flat-to-cinematic-audit`, `/dave-clark-hybrid-pipeline-plan`, `/dave-clark-shot-list-to-generation-brief` | `/arsenal --family dave-clark` |
...
| — **rory-flynn** | 3 | `/moodboard-sweep`, `/photorealism-language`, `/style-code-library` | `/arsenal --family rory-flynn` |
...
### 🗂️ Standalone Workflows — A–Z (850)
...
**N** · `/nate-b-jones` · `/nate-b-jones-agent-deployment-strategy` · `/nate-b-jones-ai-taste-mastery` · `/nate-b-jones-auto-improvement-loops` · `/nate-b-jones-context-engineering` · `/nate-b-jones-intent-engineering` · `/nate-b-jones-orchestration-intelligence` · `/nate-b-jones-trust-architecture` · `/nate-herk` · `/nate-herk-client-acquisition` · `/nathan-gotch` · `/nathan-gotch-ai-seo` · `/nba-betting` · `/new-media-kingmaker` · `/nick-saraev` · `/nick-saraev-agentic-workflows` · `/nick-saraev-bottleneck-thinking` · `/nicolas-cole` · `/nicolas-cole-client-acquisition` · `/nicolas-cole-digital-products` · `/nicolas-cole-edan-writing-mechanics` · `/nicolas-cole-newsletter-flywheel` · `/nicolas-cole-niche-positioning` · `/nicolas-cole-nonfiction-value-architecture` · `/nicolas-cole-sales-education-messaging` · `/nicolas-cole-sentence-craft` · `/nir-eyal` · `/nir-eyal-habit-design` · `/noah-hawley` · `/noah-hawley-storytelling-mastery`
