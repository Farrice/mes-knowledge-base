# 🚀 Antigravity Workflows — Complete Index (3555 Commands)
...
| `/quality-content` | Seed (trend or insight) → ship-ready multi-format content via the proven quality stack: parallel research + expert-genius lens + voice rules + dual QA (prose-doctor + fact-verifier). A strong default to reach for, never a hard rule. Benchmark: `_active/linkedin/04-deliverables/content-os/ai-boom-content-package.md` |
...
## 🔄 Content Engine — Kieran Flanagan (11)
| Command | What It Does |
|---------|-------------|
...
| `/content-ideas` | Generate Proven, Trending, and Convergence idea cards from audience, owned patterns, and dated signals |
| `/content-orchestrate` | Complete content production session with all Kieran Flanagan skills chained |
| `/content-queue` | Add selected ideas, prune stale inventory, and promote queue items through explicit state changes |
...
| `/content-winning-profile` | Build a versioned platform-specific profile from creator-owned content evidence |
...
| "content ideas" / "never run out of ideas" / "evidence-backed ideas" / "fresh content angles" | `content-ideas` |
| "content queue" / "show my ideas" / "prune my idea backlog" / "promote this idea" | `content-queue` |
...
| "winning content profile" / "my best-performing patterns" / "what structures work for me" | `content-winning-profile` |
...
## 📚 Complete Command Index — Everything Else (2763)

Every command on disk that isn't already described in a curated section above. Auto-generated by `execution/generate_slash_commands.py`.

**All of these fire right now** — the `/` typeahead in Claude Code reads `.claude/commands/`, which is complete. This page is a map, not the menu. Expert-skill commands are rolled up by family so the file stays cheap to read; for descriptions, run **`/arsenal <what you're trying to do>`** or `python3 execution/arsenal.py --family <skill>`.

### 🎓 Expert Skill Families (1837 commands across 326 families)

| Family | Commands | Examples | See all |
|--------|----------|----------|---------|
| `/adam-enfroy-affiliate-marketing` **adam-enfroy-affiliate-marketing** | 5 | `/affiliate-economics-engine`, `/omnichannel-growth-system`, `/platform-niche-matchmaker`, … | `/arsenal --family adam-enfroy-affiliate-marketing` |
| `/adam-sandler-second-brain-gtm` **adam-sandler-second-brain-gtm** | 8 | `/ve-audit-offer`, `/ve-client-ui-layer`, `/ve-department-wedge`, … | `/arsenal --family adam-sandler-second-brain-gtm` |
| — **ai-carousel-content-engine** | 6 | `/ai-carousel-article-to-carousel`, `/ai-carousel-carousel-copy-forge`, `/ai-carousel-carousel-design-prompt`, … | `/arsenal --family ai-carousel-content-engine` |
| — **ai-chris-lee-zero-testimonial-sales** | 3 | `/outcome-based-acquisition-engine`, `/proof-scaling-referral-flywheel`, `/zero-resistance-closing-system` | `/arsenal --family ai-chris-lee-zero-testimonial-sales` |
| `/alan-aragon-nutrition` **alan-aragon-nutrition** | 2 | `/alan-aragon-bust-nutrition-claim`, `/alan-aragon-rescue-stalled-progress` | `/arsenal --family alan-aragon-nutrition` |
| `/alen-sultanic-copywriting` **alen-sultanic-copywriting** | 6 | `/alen-sultanic-conversion-retention-system`, `/alen-sultanic-deep-psychology-avatar-mapping`, `/alen-sultanic-high-velocity-asset-engine`, … | `/arsenal --family alen-sultanic-copywriting` |
| `/alex-copper-creative-strategy` **alex-copper-creative-strategy** | 6 | `/alex-copper-ai-creative-department`, `/alex-copper-authority-agency-growth-engine`, `/alex-copper-organic-format-arbitrage`, … | `/arsenal --family alex-copper-creative-strategy` |
| `/alex-hormozi-business` **alex-hormozi-business** | 2 | `/alex-hormozi-architect-grand-slam-offer`, `/alex-hormozi-force-strategic-focus` | `/arsenal --family alex-hormozi-business` |
| — **alex-m-smith-natural-strategy** | 5 | `/smith-big-fat-thing`, `/smith-natural-strategist-audit`, `/smith-sacred-truth-inventory`, … | `/arsenal --family alex-m-smith-natural-strategy` |
| `/alex-myatt-creative-engine` **alex-myatt-creative-engine** | 12 | `/myatt-ai-augmented-ces`, `/myatt-andromeda-audit`, `/myatt-care-square`, … | `/arsenal --family alex-myatt-creative-engine` |
| `/alex-suzuki-digital-product-revenue-os` **alex-suzuki-digital-product-revenue-os** | 5 | `/alex-suzuki-audience-quality-router`, `/alex-suzuki-behavior-proof-lab`, `/alex-suzuki-comment-dm-conversion-system`, … | `/arsenal --family alex-suzuki-digital-product-revenue-os` |
| `/ali-abdaal-action-bias` **ali-abdaal-action-bias** | 2 | `/expertise-monetization-blueprint`, `/first-dollar-execution-roadmap` | `/arsenal --family ali-abdaal-action-bias` |
| `/alyssa-stalker-agent-content-playbook` **alyssa-stalker-agent-content-playbook** | 8 | `/alyssa-stalker-authority-as-story`, `/alyssa-stalker-comfort-content-engine`, `/alyssa-stalker-content-mix-planner`, … | `/arsenal --family alyssa-stalker-agent-content-playbook` |
| `/andrew-dun-vibe-consulting` **andrew-dun-vibe-consulting** | 14 | `/andrew-dun-advisory-retainer-builder`, `/andrew-dun-ai-readiness-scorecard`, `/andrew-dun-change-management-playbook`, … | `/arsenal --family andrew-dun-vibe-consulting` |
| `/andrew-lane-design-systems` **andrew-lane-design-systems** | 3 | `/andrew-lane-design-systems`, `/andrew-lane-extract-brand-layers`, `/andrew-lane-split-brand-decisions` | `/arsenal --family andrew-lane-design-systems` |
| — **andrew-sean-greer-novel-craft** | 12 | `/comedy-through-fire`, `/crossword-assemble`, `/echo-map`, … | `/arsenal --family andrew-sean-greer-novel-craft` |
| `/andrew-stanton-audience-engineering` **andrew-stanton-audience-engineering** | 21 | `/stanton-30sec-arc`, `/stanton-anticipation-uncertainty`, `/stanton-brain-trust`, … | `/arsenal --family andrew-stanton-audience-engineering` |
| `/andrew-wilkinson-ai-entrepreneurship` **andrew-wilkinson-ai-entrepreneurship** | 1 | `/ai-native-scaling-and-exit` | `/arsenal --family andrew-wilkinson-ai-entrepreneurship` |
| `/andy-galpin-training-intelligence` **andy-galpin-training-intelligence** | 3 | `/andy-galpin-holistic-program-consult`, `/andy-galpin-rehab-return-to-performance`, `/andy-galpin-strength-power-hypertrophy-program` | `/arsenal --family andy-galpin-training-intelligence` |
| `/andy-lo-premium-websites` **andy-lo-premium-websites** | 3 | `/headless-cms-automation`, `/premium-site-blueprints-sops`, `/production-website-assembly` | `/arsenal --family andy-lo-premium-websites` |
| `/april-dunford-positioning` **april-dunford-positioning** | 17 | `/deal-acceleration-champion-kit`, `/deal-acceleration-champion-toolkit`, `/dunford-b2b-vs-b2c`, … | `/arsenal --family april-dunford-positioning` |
| `/ash-maurya-lean-metrics` **ash-maurya-lean-metrics** | 2 | `/ash-maurya-design-unfair-advantage`, `/ash-maurya-validate-business-model` | `/arsenal --family ash-maurya-lean-metrics` |
| `/attention-hijack-hooks` **attention-hijack-hooks** | 4 | `/attention-hijack-content-bridge`, `/attention-hijack-four-format-hook-generator`, `/attention-hijack-hookable-elements-extractor`, … | `/arsenal --family attention-hijack-hooks` |
| `/authority-hacker-ai-social-media` **authority-hacker-ai-social-media** | 2 | `/paid-social-creative-suite`, `/social-os-optimization` | `/arsenal --family authority-hacker-ai-social-media` |
| — **banana-pro-director** | 2 | `/mode-2a-character-sheet`, `/mode-3-scene-plate` | `/arsenal --family banana-pro-director` |
| `/ben-watkins-storytelling` **ben-watkins-storytelling** | 18 | `/bw-anatomy-audit`, `/bw-audience-as-character`, `/bw-brand-world`, … | `/arsenal --family ben-watkins-storytelling` |
| `/benjamin-hardy-identity` **benjamin-hardy-identity** | 2 | `/benjamin-hardy-operate-from-future-self`, `/benjamin-hardy-raise-the-floor` | `/arsenal --family benjamin-hardy-identity` |
| `/benoit-vatere` **benoit-vatere** | 9 | `/bv-x-dara-stage-briefs`, `/bv-x-vince-measurement-stack`, `/channel-lever-audit`, … | `/arsenal --family benoit-vatere` |
| `/bilawal-sidhu` **bilawal-sidhu** | 2 | `/bilawal-sidhu-greybox-reskin-shot`, `/bilawal-sidhu-scene-first-blocking` | `/arsenal --family bilawal-sidhu` |
| `/bill-browder-high-stakes-narrative` **bill-browder-high-stakes-narrative** | 11 | `/browder-cause-campaign`, `/browder-cliffhang-spine`, `/browder-dig-below-surface`, … | `/arsenal --family bill-browder-high-stakes-narrative` |
| — **bitbranding-fashion-shopify** | 7 | `/bb-audit`, `/bb-collection-content`, `/bb-pdp-blueprint`, … | `/arsenal --family bitbranding-fashion-shopify` |
| `/bond-halbert-copywriting` **bond-halbert-copywriting** | 3 | `/omnipresent-authority-content-engine`, `/rapid-market-entry-offer-system`, `/velocity-optimized-sales-copy-asset` | `/arsenal --family bond-halbert-copywriting` |
| — **boris-claude-code** | 3 | `/agentic-product-engineering-validation`, `/exponential-capability-deep-learning`, `/ubiquitous-knowledge-asset-compounding` | `/arsenal --family boris-claude-code` |
| `/brad-bonanno-explainer-architecture` **brad-bonanno-explainer-architecture** | 3 | `/brad-bonanno-compound-cliffhanger-closer`, `/brad-bonanno-matrix-moment-architect`, `/brad-bonanno-trust-anchor-infographic-brief` | `/arsenal --family brad-bonanno-explainer-architecture` |
| `/brendan-kane-viral-strategy` **brendan-kane-viral-strategy** | 2 | `/brendan-kane-engineer-viral-story`, `/brendan-kane-generate-hook-driven-ideas` | `/arsenal --family brendan-kane-viral-strategy` |
| `/briar-cochran-content-science` **briar-cochran-content-science** | 12 | `/bc-arsenal-install`, `/bc-arsenal-week`, `/bc-contextualize`, … | `/arsenal --family briar-cochran-content-science` |
| `/brock-johnson-shareworthy-content` **brock-johnson-shareworthy-content** | 2 | `/shareworthy-content-factory`, `/viral-hook-distribution-optimizer` | `/arsenal --family brock-johnson-shareworthy-content` |
| — **business-intelligence-audit** | 2 | `/digital-operational-alignment-audit`, `/executive-growth-roadmap` | `/arsenal --family business-intelligence-audit` |
| `/caleb-ralston-personal-brand` **caleb-ralston-personal-brand** | 14 | `/authority-foundation-blueprint`, `/brand-resonance-sustainability-audit`, `/caleb-association-audit`, … | `/arsenal --family caleb-ralston-personal-brand` |
| `/cardinal-mason-ai-copywriting` **cardinal-mason-ai-copywriting** | 3 | `/cardinal-mason-high-conversion-sales-suite`, `/cardinal-mason-performance-optimization-proof`, `/cardinal-mason-strategic-foundation-dossier` | `/arsenal --family cardinal-mason-ai-copywriting` |
| `/chase-hughes-context-engineering` **chase-hughes-context-engineering** | 8 | `/ce-build`, `/ce-defend`, `/ce-design`, … | `/arsenal --family chase-hughes-context-engineering` |
| — **chief-of-staff-os** | 2 | `/cos-status`, `/cos-weekly` | `/arsenal --family chief-of-staff-os` |
| `/chris-cimorelli-copywriting` **chris-cimorelli-copywriting** | 2 | `/chris-cimorelli-back-end-promotion`, `/chris-cimorelli-copy-diagnostic` | `/arsenal --family chris-cimorelli-copywriting` |
| `/chris-do-design-business` **chris-do-design-business** | 2 | `/chris-do-build-personal-brand-engine`, `/chris-do-run-kind-sales-call` | `/arsenal --family chris-do-design-business` |
| — **cinema-worldbuilder-pro** | 4 | `/m2-studio-shot`, `/m3-action-shot`, `/m4-performance-shot`, … | `/arsenal --family cinema-worldbuilder-pro` |
| `/cinematic-documentary` **cinematic-documentary** | 12 | `/character-arc-series`, `/character-first-inversion`, `/cinematic-brand-story`, … | `/arsenal --family cinematic-documentary` |
| — **claim-safe-health-marketing** | 4 | `/claim-safe-claim-substantiation-map`, `/claim-safe-compliant-rewrite`, `/claim-safe-hooks`, … | `/arsenal --family claim-safe-health-marketing` |
| `/coaching-business-os` **coaching-business-os** | 1 | `/coaching-business-design-coaching-offer-stack` | `/arsenal --family coaching-business-os` |
| `/cody-schneider-signal-outbound` **cody-schneider-signal-outbound** | 10 | `/agent-or-automation`, `/creator-aperture`, `/engager-signal-audit`, … | `/arsenal --family cody-schneider-signal-outbound` |
| `/cognitive-engagement-optimizer` **cognitive-engagement-optimizer** | 2 | `/cognitive-engagement-engineer-engagement-drivers`, `/cognitive-engagement-optimize-performance-platform` | `/arsenal --family cognitive-engagement-optimizer` |
| `/context-profile-architect` **context-profile-architect** | 2 | `/context-profile-evolve-profile-version`, `/context-profile-excavate-psychological-layers` | `/arsenal --family context-profile-architect` |
| `/craig-clemens-copywriting` **craig-clemens-copywriting** | 5 | `/craig-clemens-architect-funnel-and-positioning`, `/craig-clemens-build-email-nurture-sequence`, `/craig-clemens-diagnose-market-stage-and-rewrite-plan`, … | `/arsenal --family craig-clemens-copywriting` |
| — **creative-campaign-strategy** | 6 | `/creative-campaign-strategy-lynch-character-test`, `/creative-campaign-strategy-lynch-copy-pass`, `/creative-campaign-strategy-lynch-price-architecture`, … | `/arsenal --family creative-campaign-strategy` |
| `/curious-refuge` **curious-refuge** | 3 | `/curious-refuge-preproduction-package`, `/curious-refuge-storyboard-to-plate`, `/curious-refuge-voice-and-performance-direction` | `/arsenal --family curious-refuge` |
| `/dai-media-consumer-posture` **dai-media-consumer-posture** | 2 | `/internal-world-content-engine`, `/premium-positioning-sales-architecture` | `/arsenal --family dai-media-consumer-posture` |
| — **dakota-content-design** | 2 | `/dakota-content-audit-carousel-performance`, `/dakota-content-write-standalone-slides` | `/arsenal --family dakota-content-design` |
| `/damon-cart-nlp` **damon-cart-nlp** | 2 | `/damon-cart-persuade-through-their-map`, `/damon-cart-transform-self-concept` | `/arsenal --family damon-cart-nlp` |
| `/dan-bolton-coaching-offers` **dan-bolton-coaching-offers** | 2 | `/dan-bolton-build-client-infrastructure`, `/dan-bolton-script-mini-vsl` | `/arsenal --family dan-bolton-coaching-offers` |
| `/dan-koe-ai-leverage` **dan-koe-ai-leverage** | 1 | `/dan-koe-gap-teaching-prompt-builder` | `/arsenal --family dan-koe-ai-leverage` |
| `/dan-koe-multipassionate-mastery` **dan-koe-multipassionate-mastery** | 5 | `/content-ecosystem-mcu`, `/creator-commerce-community`, `/dan-koe-linkedin-system`, … | `/arsenal --family dan-koe-multipassionate-mastery` |
| `/dan-martell-business-scaling` **dan-martell-business-scaling** | 9 | `/dan-martell-buyback-audit`, `/dan-martell-constraint-audit`, `/dan-martell-flywheel-designer`, … | `/arsenal --family dan-martell-business-scaling` |
| `/dan-wang-literary-analysis` **dan-wang-literary-analysis** | 11 | `/literary-cornerstone-sprint`, `/strategic-insight-synthesis`, `/wang-analytical-thread`, … | `/arsenal --family dan-wang-literary-analysis` |
| `/daniel-pink-writing-structure` **daniel-pink-writing-structure** | 2 | `/daniel-pink-engineer-reader-promise`, `/daniel-pink-test-book-idea` | `/arsenal --family daniel-pink-writing-structure` |
| `/daniel-priestley-oversubscribed` **daniel-priestley-oversubscribed** | 8 | `/asset-ecosystem-scale-path`, `/client-selection-waitlist-system`, `/demand-driven-content-engine`, … | `/arsenal --family daniel-priestley-oversubscribed` |
| `/daniel-priestley-sll-engine` **daniel-priestley-sll-engine** | 4 | `/sll-cadence-audit`, `/sll-lead-form`, `/sll-long-form-explainer`, … | `/arsenal --family daniel-priestley-sll-engine` |
| `/daniel-thrasher-affiliate` **daniel-thrasher-affiliate** | 2 | `/daniel-thrasher-build-campaign`, `/daniel-thrasher-optimize-and-scale` | `/arsenal --family daniel-thrasher-affiliate` |
| `/dara-denney-meta-ads` **dara-denney-meta-ads** | 31 | `/dara-big-idea-ecosystem`, `/dara-comparison-callout`, `/dara-comprehension-audit`, … | `/arsenal --family dara-denney-meta-ads` |
| `/darrel-wilson-ai-affiliate` **darrel-wilson-ai-affiliate** | 1 | `/offer-cycle-rotation` | `/arsenal --family darrel-wilson-ai-affiliate` |
| `/darrel-wilson-ai-monetization` **darrel-wilson-ai-monetization** | 3 | `/passive-utility-engine`, `/rapid-website-flip-factory`, `/revenue-stacking-expansion` | `/arsenal --family darrel-wilson-ai-monetization` |
| `/dave-clark` **dave-clark** | 3 | `/dave-clark-flat-to-cinematic-audit`, `/dave-clark-hybrid-pipeline-plan`, `/dave-clark-shot-list-to-generation-brief` | `/arsenal --family dave-clark` |
| `/david-baldacci-books-that-sell` **david-baldacci-books-that-sell** | 14 | `/baldacci-audience-downshift`, `/baldacci-author-economics`, `/baldacci-big-pop`, … | `/arsenal --family david-baldacci-books-that-sell` |
| `/david-bayer-elite-communication` **david-bayer-elite-communication** | 2 | `/high-stakes-interaction-power-mastery`, `/magnetic-authority-content-system` | `/arsenal --family david-bayer-elite-communication` |
| `/david-deutsch-copywriting` **david-deutsch-copywriting** | 4 | `/cinematic-narrative-storytelling`, `/cold-traffic-conversion-architecture`, `/viral-resonance-amplification-engine`, … | `/arsenal --family david-deutsch-copywriting` |
| `/david-mcraney-belief-change` **david-mcraney-belief-change** | 3 | `/high-resistance-intervention-protocol`, `/social-influence-norm-shift-strategy`, `/strategic-persuasion-campaign-blueprint` | `/arsenal --family david-mcraney-belief-change` |
| `/david-perell-writing` **david-perell-writing** | 13 | `/david-perell-60-20-10-bit-refinery`, `/david-perell-compress-to-memorable`, `/david-perell-current-fit-diagnostic`, … | `/arsenal --family david-perell-writing` |
| `/david-placek-naming` **david-placek-naming** | 4 | `/content-audit`, `/name-audit`, `/rename-evaluation`, … | `/arsenal --family david-placek-naming` |
| `/design-md` **design-md** | 3 | `/design-md-extract-from-codebase`, `/design-md-extract-from-url`, `/design-md-synthesize-from-brief` | `/arsenal --family design-md` |
| — **deya-business-systems** | 2 | `/deya-business-build-simple-funnel`, `/deya-business-engineer-remarkable-offer` | `/arsenal --family deya-business-systems` |
| `/dhar-mann-transformational-storytelling` **dhar-mann-transformational-storytelling** | 2 | `/dhar-mann`, `/dhar-transformational-content-factory` | `/arsenal --family dhar-mann-transformational-storytelling` |
| `/diandra-escobar-linkedin-growth` **diandra-escobar-linkedin-growth** | 11 | `/diandra-escobar-claude-project-builder`, `/diandra-escobar-content-calendar-architect`, `/diandra-escobar-content-market-fit-sprint`, … | `/arsenal --family diandra-escobar-linkedin-growth` |
| — **dom-iacovone-multi-company-operator** | 5 | `/dom-iacovone-delegate-elevate-operating-map`, `/dom-iacovone-financial-leak-audit`, `/dom-iacovone-launch-and-exit-readiness`, … | `/arsenal --family dom-iacovone-multi-company-operator` |
| `/donald-miller-business-growth` **donald-miller-business-growth** | 7 | `/business-on-a-mission`, `/cash-flow-accounts`, `/donald-miller-entry-offer-product-ladder`, … | `/arsenal --family donald-miller-business-growth` |
| `/donald-miller-cognitive-load` **donald-miller-cognitive-load** | 5 | `/donald-miller-commitment-incentive-designer`, `/donald-miller-enlightenment-collateral-generator`, `/donald-miller-friction-proof-copy-chain`, … | `/arsenal --family donald-miller-cognitive-load` |
| `/donald-miller-culture-turnaround` **donald-miller-culture-turnaround** | 3 | `/identity-messaging-playbook`, `/operational-execution-manual`, `/stakeholder-alignment-plan` | `/arsenal --family donald-miller-culture-turnaround` |
| `/donald-miller-messaging-evolution` **donald-miller-messaging-evolution** | 6 | `/bridge-word`, `/date-sequence`, `/lane-discipline`, … | `/arsenal --family donald-miller-messaging-evolution` |
| `/donald-miller-storybrand` **donald-miller-storybrand** | 5 | `/donald-miller-controlling-idea-cascade`, `/donald-miller-email-sequence-generator`, `/donald-miller-keynote-narrative-architect`, … | `/arsenal --family donald-miller-storybrand` |
| `/dr-k-consciousness` **dr-k-consciousness** | 13 | `/consciousness-to-action-bridge`, `/drk-detach`, `/drk-dharma`, … | `/arsenal --family dr-k-consciousness` |
| `/dr-kriukow-humanization` **dr-kriukow-humanization** | 1 | `/meaning-first-content-reconstruction` | `/arsenal --family dr-kriukow-humanization` |
| `/eli5` **eli5** | 1 | `/eli5` | `/arsenal --family eli5` |
| — **enrico-incarnati-instagram-realestate** | 12 | `/enrico-audit`, `/enrico-curb-appeal`, `/enrico-expand`, … | `/arsenal --family enrico-incarnati-instagram-realestate` |
| `/eric-roth-screenwriting-mastery` **eric-roth-screenwriting-mastery** | 4 | `/collaboration-marriage-protocol`, `/opening-scene-architect`, `/screenplay-architect.baseline`, … | `/arsenal --family eric-roth-screenwriting-mastery` |
| `/eric-roth-writing-mastery` **eric-roth-writing-mastery** | 7 | `/content-erosion-protocol`, `/fanciful-realism-for-brands`, `/memorable-hooks-forge`, … | `/arsenal --family eric-roth-writing-mastery` |
| `/erica-mallet-brand-magnetism` **erica-mallet-brand-magnetism** | 3 | `/addictive-content-production`, `/infinite-content-roadmap`, `/tribal-conversion-engine` | `/arsenal --family erica-mallet-brand-magnetism` |
| `/ethan-smith-aeo` **ethan-smith-aeo** | 2 | `/aeo-content-weaponization-plan`, `/aeo-experimental-validation-framework` | `/arsenal --family ethan-smith-aeo` |
| `/eugene-teo-training` **eugene-teo-training** | 2 | `/eugene-teo-calibrate-effort-and-progression`, `/eugene-teo-select-and-integrate-exercises` | `/arsenal --family eugene-teo-training` |
| `/extract-mastery` **extract-mastery** | 2 | `/extract-mastery-design-transcendence-path`, `/extract-mastery-forge-crown-jewel-prompts` | `/arsenal --family extract-mastery` |
| `/fantastic-posters` **fantastic-posters** | 13 | `/fantastic-art-direct`, `/fantastic-critique-refine`, `/fantastic-divergence`, … | `/arsenal --family fantastic-posters` |
| `/fareed-zakaria-writing-mastery` **fareed-zakaria-writing-mastery** | 4 | `/high-stakes-argument-architecture`, `/multi-medium-content-multiplication`, `/public-intellectual-voice-narrative`, … | `/arsenal --family fareed-zakaria-writing-mastery` |
| `/fashion-coupids` **fashion-coupids** | 2 | `/fashion-coupids-fashion-campaign-chain`, `/fashion-coupids-lookbook-shot-list` | `/arsenal --family fashion-coupids` |
| `/forge-os` **forge-os** | 5 | `/agent-forge`, `/plugin-forge`, `/prompt-forge`, … | `/arsenal --family forge-os` |
| `/fraser-cottrell-paid-ads` **fraser-cottrell-paid-ads** | 2 | `/fraser-cottrell-design-static-ad-set`, `/fraser-cottrell-diagnose-and-iterate` | `/arsenal --family fraser-cottrell-paid-ads` |
| — **fryderyk-wiatrowski-ai-employee-os** | 1 | `/ai-employee-os` | `/arsenal --family fryderyk-wiatrowski-ai-employee-os` |
| — **futurepedia-prompt-engineering** | 5 | `/custom-ai-solution-architect`, `/emotional-expert-panel-prompt-suite`, `/interactive-learning-ecosystem-design`, … | `/arsenal --family futurepedia-prompt-engineering` |
| `/gabe-novotny-fitness-content-business` **gabe-novotny-fitness-content-business** | 2 | `/gabe-novotny-build-cpr-content-engine`, `/gabe-novotny-convert-dms-to-clients` | `/arsenal --family gabe-novotny-fitness-content-business` |
| `/gary-vaynerchuk-attention` **gary-vaynerchuk-attention** | 2 | `/gary-vaynerchuk-amplify-organic-winners`, `/gary-vaynerchuk-run-content-engine` | `/arsenal --family gary-vaynerchuk-attention` |
| `/geoff-woods-ai-thought-partner` **geoff-woods-ai-thought-partner** | 17 | `/buyer-council`, `/gw-20-percent`, `/gw-ai-board`, … | `/arsenal --family geoff-woods-ai-thought-partner` |
| — **ghostwriting-voice-engine** | 1 | `/ghostwriting-voice-client-acquisition` | `/arsenal --family ghostwriting-voice-engine` |
| — **gpt-image-2-director** | 2 | `/format-b-cinematic-prose-scene`, `/format-c-meta-prompt-concept-poster` | `/arsenal --family gpt-image-2-director` |
| `/grace-andrews-media-company` **grace-andrews-media-company** | 5 | `/grace-andrews-brand-voice-districts`, `/grace-andrews-consistency-experimentation-engine`, `/grace-andrews-episodic-engine`, … | `/arsenal --family grace-andrews-media-company` |
| `/greg-hickman-service-scaling` **greg-hickman-service-scaling** | 2 | `/greg-hickman-land-first-five-clients`, `/greg-hickman-sequence-scale-levers` | `/arsenal --family greg-hickman-service-scaling` |
| `/greg-hoffman-brand-mastery` **greg-hoffman-brand-mastery** | 1 | `/greg-hoffman-campaign-architecture-engine-v2` | `/arsenal --family greg-hoffman-brand-mastery` |
| — **growth-blueprint-os** | 10 | `/gb-blueprint`, `/gb-bullseye`, `/gb-enrich`, … | `/arsenal --family growth-blueprint-os` |
| `/growth-ecosystems` **growth-ecosystems** | 11 | `/growth-ecosystems-conversion-mechanism-matcher`, `/growth-ecosystems-conviction-content-engine`, `/growth-ecosystems-ecosystem-content-architecture`, … | `/arsenal --family growth-ecosystems` |
| `/harry-dry-copywriting` **harry-dry-copywriting** | 2 | `/evidence-led-visual-campaign`, `/precision-copy-diagnostic-audit` | `/arsenal --family harry-dry-copywriting` |
| `/henrik-werdelin-portfolio-entrepreneurship` **henrik-werdelin-portfolio-entrepreneurship** | 2 | `/henrik-werdelin-audit-relationship-capital`, `/henrik-werdelin-design-venture-portfolio` | `/arsenal --family henrik-werdelin-portfolio-entrepreneurship` |
| `/henry-shukman-contemplative-writing` **henry-shukman-contemplative-writing** | 11 | `/shukman-contemplative-brand`, `/shukman-daily-tap`, `/shukman-distance-digestion`, … | `/arsenal --family henry-shukman-contemplative-writing` |
| — **heydominik-instagram-growth-os** | 10 | `/heydominik-instagram-compliance-guard`, `/heydominik-instagram-funnel-diagnostician`, `/heydominik-instagram-gap-matrix-builder`, … | `/arsenal --family heydominik-instagram-growth-os` |
| — **higgsfield-creative-studio** | 1 | `/guarded-generation-request` | `/arsenal --family higgsfield-creative-studio` |
| `/hilary-gridley` **hilary-gridley** | 13 | `/hg-ai-native-redesign`, `/hg-edit-pair-harvest`, `/hg-evaluator-fleet`, … | `/arsenal --family hilary-gridley` |
| — **jack-roberts-design-mastery** | 1 | `/design-gauntlet` | `/arsenal --family jack-roberts-design-mastery` |
| `/jasmin-alic-linkedin-growth` **jasmin-alic-linkedin-growth** | 3 | `/jasmin-alic-authority-to-revenue-conversion-engine`, `/rhythmic-conversion-polisher`, `/trapdoor-content-architecture` | `/arsenal --family jasmin-alic-linkedin-growth` |
| `/jason-fladlien-marketing` **jason-fladlien-marketing** | 37 | `/fladlien-audit`, `/fladlien-authority`, `/fladlien-best-90`, … | `/arsenal --family jason-fladlien-marketing` |
| `/jay-hiette-coaching-positioning` **jay-hiette-coaching-positioning** | 2 | `/jay-hiette-build-deal-flow`, `/jay-hiette-engineer-belief-shifts` | `/arsenal --family jay-hiette-coaching-positioning` |
| `/jen-engine` **jen-engine** | 1 | `/jen-full-pipeline` | `/arsenal --family jen-engine` |
| — **jen-santulan-listing-content** | 3 | `/buyer-education-story`, `/listing-package`, `/neighborhood-deep-dive-carousel` | `/arsenal --family jen-santulan-listing-content` |
| `/jenny-hoyos-shorts` **jenny-hoyos-shorts** | 14 | `/jenny-ai-brain`, `/jenny-anything-viral`, `/jenny-business-engine`, … | `/arsenal --family jenny-hoyos-shorts` |
| `/jeremy-haynes-cold-offer` **jeremy-haynes-cold-offer** | 14 | `/haynes-handshake-geoff-stakeholder`, `/jh-avatar-bridge`, `/jh-in-market-needs-convinced-audit`, … | `/arsenal --family jeremy-haynes-cold-offer` |
| `/jeremy-haynes-mindset-systems` **jeremy-haynes-mindset-systems** | 2 | `/high-octane-drive-system`, `/revenue-breakthrough-blueprint` | `/arsenal --family jeremy-haynes-mindset-systems` |
| `/jeremy-miner-identity-persuasion` **jeremy-miner-identity-persuasion** | 4 | `/identity-based-market-positioning`, `/identity-trigger-content-system`, `/npq-conversation-architect-v2-identity-cartography`, … | `/arsenal --family jeremy-miner-identity-persuasion` |
| `/jiang-xueqin-cognitive-autonomy` **jiang-xueqin-cognitive-autonomy** | 2 | `/jiang-xueqin-map-the-real-game`, `/jiang-xueqin-run-cognitive-autonomy-protocol` | `/arsenal --family jiang-xueqin-cognitive-autonomy` |
| `/jim-oshaughnessy-philosopher-financier` **jim-oshaughnessy-philosopher-financier** | 4 | `/archetypal-narrative-persuasion-playbook`, `/career-catalyst-strategic-roadmap`, `/deep-mastery-synthesis-report`, … | `/arsenal --family jim-oshaughnessy-philosopher-financier` |
| `/joanna-wiebe-persuasion-mastery` **joanna-wiebe-persuasion-mastery** | 12 | `/authority-craft-engine`, `/behavioral-friction-and-bias-optimization`, `/belief-community-architecture`, … | `/arsenal --family joanna-wiebe-persuasion-mastery` |
| `/joanna-wiebe-writing-careers` **joanna-wiebe-writing-careers** | 5 | `/joanna-wiebe-channel-audit-funnel-diagnostic`, `/joanna-wiebe-invisible-sales-page-engine`, `/joanna-wiebe-messaging-source-document-builder`, … | `/arsenal --family joanna-wiebe-writing-careers` |
| — **joey-cinema-os** | 12 | `/jcin-ad-world`, `/jcin-character-lock`, `/jcin-outfit-engine`, … | `/arsenal --family joey-cinema-os` |
| `/john-whiting-propaganda-machine` **john-whiting-propaganda-machine** | 19 | `/jw-big-domino`, `/jw-comfort-line-breaker`, `/jw-content-cadence-engine`, … | `/arsenal --family john-whiting-propaganda-machine` |
| `/jonah-berger-contagious` **jonah-berger-contagious** | 2 | `/jonah-berger-build-trojan-horse-story`, `/jonah-berger-remove-change-barriers` | `/arsenal --family jonah-berger-contagious` |
| `/jonathan-courtney-marketing` **jonathan-courtney-marketing** | 1 | `/high-velocity-campaign-sprint` | `/arsenal --family jonathan-courtney-marketing` |
| `/jonathan-franzen-storytelling` **jonathan-franzen-storytelling** | 3 | `/high-precision-narrative-assets`, `/minimalist-brand-voice-protocol`, `/psychological-market-excavation-map` | `/arsenal --family jonathan-franzen-storytelling` |
| `/jordan-crawford-gtm-intelligence` **jordan-crawford-gtm-intelligence** | 9 | `/compounding-gtm-unit`, `/cost-per-right-answer`, `/gtm-learning-loop`, … | `/arsenal --family jordan-crawford-gtm-intelligence` |
| `/josh-kaufman-business-fundamentals` **josh-kaufman-business-fundamentals** | 2 | `/josh-kaufman-acquire-skill-fast`, `/josh-kaufman-validate-before-building` | `/arsenal --family josh-kaufman-business-fundamentals` |
| `/jun-yuh-creator-vision` **jun-yuh-creator-vision** | 21 | `/expertise-to-story-content`, `/format-intelligence-lab`, `/jun-story-engine`, … | `/arsenal --family jun-yuh-creator-vision` |
| `/jun-yuh-personal-brand` **jun-yuh-personal-brand** | 3 | `/growth-intelligence-scaling-system`, `/monetization-funnel-conversion-kit`, `/viral-content-production-factory` | `/arsenal --family jun-yuh-personal-brand` |
| `/justin-welsh-solopreneur` **justin-welsh-solopreneur** | 2 | `/justin-welsh-architect-revenue-stack`, `/justin-welsh-discover-niche` | `/arsenal --family justin-welsh-solopreneur` |
| — **kallaway-addictive-storytelling** | 12 | `/addiction-copy-engine`, `/addiction-loop-architect`, `/addiction-loop-diagnostic`, … | `/arsenal --family kallaway-addictive-storytelling` |
| — **kallaway-ai-content-engine** | 4 | `/ai-content-ops`, `/ai-creative-reaction-sprint`, `/ai-hook-pattern-extractor`, … | `/arsenal --family kallaway-ai-content-engine` |
| — **kallaway-audience-obsession** | 12 | `/bankshot-suggestion-engine`, `/belief-shift-content`, `/five-input-content-gate`, … | `/arsenal --family kallaway-audience-obsession` |
| `/kallaway-content-psychology` **kallaway-content-psychology** | 8 | `/batched-content-testing`, `/creator-business-ladder`, `/multi-channel-monetization`, … | `/arsenal --family kallaway-content-psychology` |
| — **kallaway-hook-mastery** | 9 | `/hook-anything`, `/hook-landscape-scan`, `/hook-trust-stack`, … | `/arsenal --family kallaway-hook-mastery` |
| — **kallaway-illusion-of-novelty** | 3 | `/kallaway-x-dunford`, `/kallaway-x-jenny-hoyos`, `/kallaway-x-priestley-sll` | `/arsenal --family kallaway-illusion-of-novelty` |
| — **kallaway-social-commerce** | 4 | `/creator-brand-architect`, `/distribution-value-calculator`, `/instagram-shops-strategy`, … | `/arsenal --family kallaway-social-commerce` |
| `/kieran-flanagan-content-engine` **kieran-flanagan-content-engine** | 2 | `/kieran-flanagan-competitor-content-spy`, `/kieran-flanagan-content-series-plan` | `/arsenal --family kieran-flanagan-content-engine` |
| — **kittl-graphic-design** | 2 | `/ai-visual-asset-synthesis`, `/professional-layout-execution` | `/arsenal --family kittl-graphic-design` |
| `/kj-rainey-copywriting` **kj-rainey-copywriting** | 2 | `/kj-rainey-build-value-chain`, `/kj-rainey-write-pain-driven-copy` | `/arsenal --family kj-rainey-copywriting` |
| `/knowledge-architecture-studio` **knowledge-architecture-studio** | 2 | `/knowledge-architecture-architect-domain-agent`, `/knowledge-architecture-build-mastery-pathway` | `/arsenal --family knowledge-architecture-studio` |
| `/kunal-shah-consumer-psychology` **kunal-shah-consumer-psychology** | 2 | `/kunal-shah-audit-trust-status-dynamics`, `/kunal-shah-map-motivation-rivers` | `/arsenal --family kunal-shah-consumer-psychology` |
| `/lamott-craft` **lamott-craft** | 12 | `/lamott-abdce`, `/lamott-audit`, `/lamott-connelly`, … | `/arsenal --family lamott-craft` |
| `/lance-yichao-context-engineering` **lance-yichao-context-engineering** | 2 | `/context-management-efficiency-engine`, `/performance-discovery-optimization-protocol` | `/arsenal --family lance-yichao-context-engineering` |
| `/lara-acosta-content-system` **lara-acosta-content-system** | 1 | `/high-performance-content-studio` | `/arsenal --family lara-acosta-content-system` |
| `/lara-acosta-linkedin-growth` **lara-acosta-linkedin-growth** | 3 | `/authority-milestone-architect`, `/engagement-flywheel-engine`, `/signature-series-architect` | `/arsenal --family lara-acosta-linkedin-growth` |
| `/lara-acosta-linkedin-mastery` **lara-acosta-linkedin-mastery** | 3 | `/ghostwriting-voice-scaling-system`, `/revenue-authority-accelerator`, `/revenue-bridge-builder` | `/arsenal --family lara-acosta-linkedin-mastery` |
| `/liam-mley-ai-brain-builder` **liam-mley-ai-brain-builder** | 1 | `/ai-brain-substrate` | `/arsenal --family liam-mley-ai-brain-builder` |
| — **lindsay-ai-consulting** | 2 | `/lindsay-ai-multi-channel-outreach-engine`, `/lindsay-ai-sales-conversion-pipeline-system` | `/arsenal --family lindsay-ai-consulting` |
| — **linkedin-2026-format-arbitrage** | 1 | `/viral-lead-generation-funnel` | `/arsenal --family linkedin-2026-format-arbitrage` |
| `/logan-kilpatrick-ai-studio` **logan-kilpatrick-ai-studio** | 2 | `/continuous-iteration-stakeholder-delivery`, `/production-grade-system-engineering` | `/arsenal --family logan-kilpatrick-ai-studio` |
| `/lucas-alpay-storytelling` **lucas-alpay-storytelling** | 3 | `/cinematic-fiction-engine`, `/manuscript-architecture-suite`, `/narrative-asset-management` | `/arsenal --family lucas-alpay-storytelling` |
| `/luisa-zhou-coaching` **luisa-zhou-coaching** | 2 | `/luisa-zhou-build-content-engine`, `/luisa-zhou-deliver-first-session` | `/arsenal --family luisa-zhou-coaching` |
| `/luke-alexander-ai-business` **luke-alexander-ai-business** | 2 | `/luke-alexander-build-context-profile`, `/luke-alexander-structure-performance-deal` | `/arsenal --family luke-alexander-ai-business` |
| `/luke-iha-avatar-machine` **luke-iha-avatar-machine** | 13 | `/anti-hero-journey`, `/avatar-machine-orchestrator`, `/avatar-manifold`, … | `/arsenal --family luke-iha-avatar-machine` |
| `/luke-iha-copy-blocks` **luke-iha-copy-blocks** | 10 | `/conditions-stack`, `/constraint-dissolution`, `/copy-equation`, … | `/arsenal --family luke-iha-copy-blocks` |
| `/luke-iha-creative-strategy` **luke-iha-creative-strategy** | 3 | `/control-beating-review`, `/decision-stack-audit`, `/profit-finder-opportunity-scan` | `/arsenal --family luke-iha-creative-strategy` |
| `/luke-iha-insight-vectors` **luke-iha-insight-vectors** | 11 | `/archetype-build`, `/belief-gap-sprint`, `/insight-audit`, … | `/arsenal --family luke-iha-insight-vectors` |
| `/luke-iha-proof-ladder` **luke-iha-proof-ladder** | 1 | `/skepticism-profile-matching` | `/arsenal --family luke-iha-proof-ladder` |
| `/luke-iha-proof-mechanisms` **luke-iha-proof-mechanisms** | 3 | `/bulletproof-sales-asset-engine`, `/omnipresence-proof-ecosystem`, `/proof-cascade-sequencing` | `/arsenal --family luke-iha-proof-mechanisms` |
| `/luke-iha-vicious-hooks` **luke-iha-vicious-hooks** | 8 | `/anti-ad-disguise-engine`, `/consequence-first-flipper`, `/germanic-word-forge`, … | `/arsenal --family luke-iha-vicious-hooks` |
| — **lulu-cheng-meservey-communications** | 12 | `/cultural-positioning-differentiation`, `/founder-narrative-voice-architecture`, `/lulu-authenticity-engineering`, … | `/arsenal --family lulu-cheng-meservey-communications` |
| — **made-to-stick-messaging** | 3 | `/authority-experience-transformation-design`, `/high-stakes-sales-persuasion-engine`, `/success-content-architecture` | `/arsenal --family made-to-stick-messaging` |
| `/manus-ai-consulting` **manus-ai-consulting** | 3 | `/ai-consulting-ops-blueprint`, `/executive-deliverable-generation`, `/tactical-market-attack-plan` | `/arsenal --family manus-ai-consulting` |
| `/marc-andreessen-ai-thesis` **marc-andreessen-ai-thesis** | 2 | `/ai-native-org-blueprint`, `/workforce-resilience-roadmap` | `/arsenal --family marc-andreessen-ai-thesis` |
| `/maria-wendt-digital-products` **maria-wendt-digital-products** | 9 | `/business-optimization-profit-recovery`, `/high-conversion-checkout-system`, `/instagram-sales-content-engine`, … | `/arsenal --family maria-wendt-digital-products` |
| `/marisa-murgatroyd-course-design` **marisa-murgatroyd-course-design** | 2 | `/marisa-murgatroyd-craft-mission-statement`, `/marisa-murgatroyd-launch-mvo-from-zero` | `/arsenal --family marisa-murgatroyd-course-design` |
| `/mark-forsyth-rhetoric` **mark-forsyth-rhetoric** | 14 | `/mark-forsyth-announcer-map`, `/mark-forsyth-classify-the-job`, `/mark-forsyth-enchantment-audit`, … | `/arsenal --family mark-forsyth-rhetoric` |
| `/mark-kashef-agent-orchestration` **mark-kashef-agent-orchestration** | 3 | `/architected-technical-build-pipeline`, `/phase-gated-context-factory`, `/replicate-anything-capability-transfer` | `/arsenal --family mark-kashef-agent-orchestration` |
| `/mark-kashef-ai-councils` **mark-kashef-ai-councils** | 2 | `/mark-kashef-council-command-orchestration`, `/mark-kashef-ecosystem-audit-and-meta-control` | `/arsenal --family mark-kashef-ai-councils` |
| `/mark-kashef-banana-squad` **mark-kashef-banana-squad** | 2 | `/peer-value-lattice`, `/style-driven-visual-production` | `/arsenal --family mark-kashef-banana-squad` |
| `/mark-kashef-claude-claw` **mark-kashef-claude-claw** | 3 | `/context-yield-optimization`, `/interactive-setup-wizard-generator`, `/model-card-onboarding-prompt-factory` | `/arsenal --family mark-kashef-claude-claw` |
| `/mark-kashef-silver-platter-agentic-os` **mark-kashef-silver-platter-agentic-os** | 2 | `/audit-and-classify`, `/opportunities-and-handoff` | `/arsenal --family mark-kashef-silver-platter-agentic-os` |
| `/mark-kashef-wargame-os` **mark-kashef-wargame-os** | 10 | `/wargame-batch`, `/wargame-brief`, `/wargame-client`, … | `/arsenal --family mark-kashef-wargame-os` |
| `/mark-manson-values-psychology` **mark-manson-values-psychology** | 2 | `/mark-manson-architect-durable-wellbeing`, `/mark-manson-change-a-value` | `/arsenal --family mark-manson-values-psychology` |
| — **marketing-studio-director** | 8 | `/pro-virtual-try-on-prompt`, `/product-review-ad-prompt`, `/tutorial-ad-prompt`, … | `/arsenal --family marketing-studio-director` |
| `/matt-haig-reader-bridge` **matt-haig-reader-bridge** | 11 | `/haig-authentic-optimism`, `/haig-child-story-reset`, `/haig-feeling-carrier`, … | `/arsenal --family matt-haig-reader-bridge` |
| `/matt-mcgarry-newsletters` **matt-mcgarry-newsletters** | 2 | `/matt-mcgarry-monetize-audience`, `/matt-mcgarry-scale-growth-engine` | `/arsenal --family matt-mcgarry-newsletters` |
| `/matthew-lakajev-linkedin` **matthew-lakajev-linkedin** | 13 | `/ml-build-funnel`, `/ml-closed-lost`, `/ml-daily-rhythm`, … | `/arsenal --family matthew-lakajev-linkedin` |
| `/matthew-volkwyn-copywriting` **matthew-volkwyn-copywriting** | 2 | `/matthew-volkwyn-capture-voice`, `/matthew-volkwyn-engineer-hooks` | `/arsenal --family matthew-volkwyn-copywriting` |
| `/meg-heckman-buyer-trigger-os` **meg-heckman-buyer-trigger-os** | 5 | `/meg-community-voice`, `/meg-fan-flywheel`, `/meg-heckman-handshake-proof-ladder`, … | `/arsenal --family meg-heckman-buyer-trigger-os` |
| `/michael-bernoff-identity-engineering` **michael-bernoff-identity-engineering** | 3 | `/category-of-one-messaging-blueprint`, `/identity-shift-transformation-protocol`, `/neuro-identity-calibration-playbook` | `/arsenal --family michael-bernoff-identity-engineering` |
| `/michael-connelly-vivid-writing` **michael-connelly-vivid-writing** | 4 | `/connelly-brand-momentum`, `/connelly-content-slingshot`, `/connelly-ghostwrite-economy`, … | `/arsenal --family michael-connelly-vivid-writing` |
| `/michael-israetel-hypertrophy` **michael-israetel-hypertrophy** | 2 | `/michael-israetel-build-nutrition-plan`, `/michael-israetel-design-hypertrophy-mesocycle` | `/arsenal --family michael-israetel-hypertrophy` |
| `/michael-margolis-user-research` **michael-margolis-user-research** | 2 | `/michael-margolis-build-comparison-prototypes`, `/michael-margolis-run-research-sprint-day` | `/arsenal --family michael-margolis-user-research` |
| `/mickmumpitz` **mickmumpitz** | 3 | `/mickmumpitz-camera-blocking-previs`, `/mickmumpitz-character-lock-dataset`, `/mickmumpitz-controlled-shot-spec` | `/arsenal --family mickmumpitz` |
| `/mike-foutia-marketing-tools` **mike-foutia-marketing-tools** | 2 | `/brand-aligned-creative-pipeline`, `/marketing-automation-tool-architecture` | `/arsenal --family mike-foutia-marketing-tools` |
| `/mike-sherrard-realtor-branding` **mike-sherrard-realtor-branding** | 3 | `/mike-sherrard-audit-content-conversion`, `/mike-sherrard-build-lead-capture-workflow`, `/mike-sherrard-market-demand-carousel-system` | `/arsenal --family mike-sherrard-realtor-branding` |
| `/mike-taylor-synthetic-research` **mike-taylor-synthetic-research** | 7 | `/mt-concept-headline-triage`, `/mt-distribution-calibration-check`, `/mt-latent-demand-mining`, … | `/arsenal --family mike-taylor-synthetic-research` |
| `/mitch-albom-writing-mastery` **mitch-albom-writing-mastery** | 11 | `/albom-content-emotion`, `/albom-email-narrative`, `/albom-gravedigger-angle`, … | `/arsenal --family mitch-albom-writing-mastery` |
| `/monk-ai-offer-architecture` **monk-ai-offer-architecture** | 2 | `/client-ascension-framework`, `/sales-proposal-engine` | `/arsenal --family monk-ai-offer-architecture` |
| `/nate-b-jones-agent-deployment-strategy` **nate-b-jones-agent-deployment-strategy** | 1 | `/agentic-market-intelligence-briefing` | `/arsenal --family nate-b-jones-agent-deployment-strategy` |
| `/nate-b-jones-ai-taste-mastery` **nate-b-jones-ai-taste-mastery** | 2 | `/ai-quality-gatekeeping-protocol`, `/taste-driven-scaling-roadmap` | `/arsenal --family nate-b-jones-ai-taste-mastery` |
| `/nate-b-jones-auto-improvement-loops` **nate-b-jones-auto-improvement-loops** | 8 | `/nate-auto-architecture`, `/nate-auto-audit`, `/nate-auto-emergent`, … | `/arsenal --family nate-b-jones-auto-improvement-loops` |
| `/nate-b-jones-context-engineering` **nate-b-jones-context-engineering** | 6 | `/compression-sprint`, `/context-audit`, `/memory-architect`, … | `/arsenal --family nate-b-jones-context-engineering` |
| `/nate-b-jones-intent-engineering` **nate-b-jones-intent-engineering** | 3 | `/intent-centric-agent-architecture`, `/operational-safety-and-communication-design`, `/spec-first-delegation` | `/arsenal --family nate-b-jones-intent-engineering` |
| `/nate-b-jones-manager-loop` **nate-b-jones-manager-loop** | 6 | `/decision-packet`, `/job`, `/job-closeout`, … | `/arsenal --family nate-b-jones-manager-loop` |
| `/nate-b-jones-orchestration-intelligence` **nate-b-jones-orchestration-intelligence** | 6 | `/nate-b-bloat-to-depth-optimizer`, `/nate-b-domain-verifiability-mapper`, `/nate-b-harness-design-audit`, … | `/arsenal --family nate-b-jones-orchestration-intelligence` |
| `/nate-b-jones-trust-architecture` **nate-b-jones-trust-architecture** | 4 | `/adversarial-resilience-recovery`, `/cognitive-integrity-governance`, `/evidential-trust-calibration`, … | `/arsenal --family nate-b-jones-trust-architecture` |
| `/nathan-gotch-ai-seo` **nathan-gotch-ai-seo** | 13 | `/gotch-alternatives-ladder`, `/gotch-benchmark-scan`, `/gotch-category-sprint`, … | `/arsenal --family nathan-gotch-ai-seo` |
| `/nick-saraev-agentic-workflows` **nick-saraev-agentic-workflows** | 6 | `/agentic-system-architecture-and-design`, `/ai-agency-growth-and-content-engine`, `/offer-selection-and-premium-pricing`, … | `/arsenal --family nick-saraev-agentic-workflows` |
| `/nick-saraev-bottleneck-thinking` **nick-saraev-bottleneck-thinking** | 3 | `/nick-saraev-consulting-diagnostic-frameworks`, `/nick-saraev-flywheel-sprint-planner`, `/nick-saraev-revenue-tier-growth-playbook` | `/arsenal --family nick-saraev-bottleneck-thinking` |
| — **nick-st-pierre** | 3 | `/nick-st-additive-prompt-build`, `/nick-st-aesthetic-sweep`, `/nick-st-style-code-bank` | `/arsenal --family nick-st-pierre` |
| `/nicolas-cole-client-acquisition` **nicolas-cole-client-acquisition** | 2 | `/problem-education-sales-call`, `/service-menu-and-offer-design` | `/arsenal --family nicolas-cole-client-acquisition` |
| `/nicolas-cole-digital-products` **nicolas-cole-digital-products** | 2 | `/multi-tier-ecosystem-roadmap`, `/offer-stack` | `/arsenal --family nicolas-cole-digital-products` |
| `/nicolas-cole-first-dollar-system` **nicolas-cole-first-dollar-system** | 4 | `/nicolas-cole-congruence-supply-chain`, `/nicolas-cole-customer-improvement-loop`, `/nicolas-cole-information-advantage-audit`, … | `/arsenal --family nicolas-cole-first-dollar-system` |
| — **nicolas-cole-library-first-writing** | 1 | `/nicolas-cole-library-asset-multiplication` | `/arsenal --family nicolas-cole-library-first-writing` |
| `/nicolas-cole-niche-positioning` **nicolas-cole-niche-positioning** | 2 | `/nicolas-cole-category-of-one`, `/nicolas-cole-specificity-drill-v1-baseline` | `/arsenal --family nicolas-cole-niche-positioning` |
| `/nicolas-cole-sentence-craft` **nicolas-cole-sentence-craft** | 2 | `/audience-calibration-vocabulary-control`, `/terminal-power-rhythm-engineering` | `/arsenal --family nicolas-cole-sentence-craft` |
| `/nir-eyal-habit-design` **nir-eyal-habit-design** | 2 | `/nir-eyal-break-distraction-pattern`, `/nir-eyal-engineer-program-adherence` | `/arsenal --family nir-eyal-habit-design` |
| `/noah-hawley-storytelling-mastery` **noah-hawley-storytelling-mastery** | 21 | `/hawley-adapt-mode`, `/hawley-campaign-coherence`, `/hawley-coherence-cut`, … | `/arsenal --family noah-hawley-storytelling-mastery` |
| `/ocean-vuong-perceptual-writing` **ocean-vuong-perceptual-writing** | 13 | `/anti-homogenization-audit`, `/cliche-rescue-protocol`, `/haunted-copy`, … | `/arsenal --family ocean-vuong-perceptual-writing` |
| `/omar-eddaoudi` **omar-eddaoudi** | 3 | `/high-status-tension-conversion-system`, `/leo-sentiment-signal-optimization`, `/narrative-hegemony-positioning-strategy` | `/arsenal --family omar-eddaoudi` |
| `/omar-eddaoudi-premium-ads` **omar-eddaoudi-premium-ads** | 4 | `/omar-eddaoudi-authority-led-content-ecosystem`, `/omar-eddaoudi-category-domination-paid-traffic-suite`, `/omar-eddaoudi-high-conviction-creative-copy-system`, … | `/arsenal --family omar-eddaoudi-premium-ads` |
| `/omar-eddaoudi-scaling-ops` **omar-eddaoudi-scaling-ops** | 10 | `/omar-ad-teardown`, `/omar-avatar-trigger-map`, `/omar-kallaway-pattern-interrupt`, … | `/arsenal --family omar-eddaoudi-scaling-ops` |
| `/omar-eltakrori` **omar-eltakrori** | 2 | `/offer-packaging-engine`, `/what-people-buy` | `/arsenal --family omar-eltakrori` |
| — **oren-brand-archetypes** | 7 | `/archetype-diagnostic`, `/archetype-exemplar-library`, `/archetype-revenue-bridge`, … | `/arsenal --family oren-brand-archetypes` |
| — **oren-content-team-architecture** | 15 | `/oren-agentic-commerce`, `/oren-brand-media-blueprint`, `/oren-content-flywheel`, … | `/arsenal --family oren-content-team-architecture` |
| — **oren-dara-ad-psychology** | 10 | `/adpsy-armchair-investigation`, `/adpsy-comment-mine`, `/adpsy-credible-explainer`, … | `/arsenal --family oren-dara-ad-psychology` |
| — **oren-identity-brand-os** | 14 | `/aspiration-gap-split-test`, `/homie-lookbook-brief`, `/identity-brand-os`, … | `/arsenal --family oren-identity-brand-os` |
| — **oren-luxury-psychology** | 2 | `/aesthetic-positioning-world-builder`, `/luxury-offer-architecture-strategy` | `/arsenal --family oren-luxury-psychology` |
| — **oren-norton-world-building** | 10 | `/artifact-forge`, `/campaign-world`, `/fantasy-engine`, … | `/arsenal --family oren-norton-world-building` |
| — **oren-one-person-ai-marketer** | 13 | `/marketing-specialist`, `/oren-anti-slop-classifier`, `/oren-brand-voice-machine`, … | `/arsenal --family oren-one-person-ai-marketer` |
| — **oren-operational-systems** | 2 | `/creative-execution-pipeline`, `/team-operations-infrastructure` | `/arsenal --family oren-operational-systems` |
| `/oren-repositioning` **oren-repositioning** | 5 | `/brand-world-expansion`, `/personal-brand-creative-direction`, `/personal-brand-idea-room`, … | `/arsenal --family oren-repositioning` |
| `/oren-slop-era-creative-strategy` **oren-slop-era-creative-strategy** | 9 | `/ad-opinion-reps`, `/anti-slop-stack`, `/boring-to-exciting`, … | `/arsenal --family oren-slop-era-creative-strategy` |
| `/oren-taste-development` **oren-taste-development** | 4 | `/art-direction-toolkit`, `/creative-quality-audit-system`, `/moodboard-conversation-system`, … | `/arsenal --family oren-taste-development` |
| `/oscar-hoglund-sound-storytelling` **oscar-hoglund-sound-storytelling** | 3 | `/innovation-economic-translation`, `/self-proving-logic-positioning`, `/sonic-brand-identity-architect` | `/arsenal --family oscar-hoglund-sound-storytelling` |
| `/packy-mccormick-writing` **packy-mccormick-writing** | 2 | `/packy-mccormick-develop-writing-voice`, `/packy-mccormick-package-and-name-idea` | `/arsenal --family packy-mccormick-writing` |
| `/paddy-galloway-youtube-strategy` **paddy-galloway-youtube-strategy** | 15 | `/paddy-galloway`, `/pg-ccn-slate`, `/pg-channel-diagnosis`, … | `/arsenal --family paddy-galloway-youtube-strategy` |
| `/paolo-trivellato-lead-magnet-engine` **paolo-trivellato-lead-magnet-engine** | 11 | `/pt-boring-offer-audit`, `/pt-comment-capture`, `/pt-content-rotation`, … | `/arsenal --family paolo-trivellato-lead-magnet-engine` |
| `/pat-flynn-passive-income` **pat-flynn-passive-income** | 2 | `/pat-flynn-audit-affiliate-ethics`, `/pat-flynn-validate-with-one-person` | `/arsenal --family pat-flynn-passive-income` |
| `/patrick-dang-online-business` **patrick-dang-online-business** | 2 | `/patrick-dang-build-brand-engine`, `/patrick-dang-convert-followers-to-clients` | `/arsenal --family patrick-dang-online-business` |
| `/patrick-debois-cdlc` **patrick-debois-cdlc** | 4 | `/cdlc-audit`, `/context-evals`, `/context-library`, … | `/arsenal --family patrick-debois-cdlc` |
| `/paul-harding-lyric-prose` **paul-harding-lyric-prose** | 10 | `/harding-brand-sensory`, `/harding-cadence`, `/harding-counterpoint`, … | `/arsenal --family paul-harding-lyric-prose` |
| `/paul-james-ai-automation` **paul-james-ai-automation** | 3 | `/market-penetration-acquisition`, `/roi-driven-offer-engineering`, `/scale-retention-optimization` | `/arsenal --family paul-james-ai-automation` |
| `/pj-accetturo-ai-video` **pj-accetturo-ai-video** | 3 | `/cinematic-production-engine`, `/commercial-finishing-system`, `/viral-growth-and-commerce` | `/arsenal --family pj-accetturo-ai-video` |
| `/prediction-market-ai-event-analysis` **prediction-market-ai-event-analysis** | 2 | `/edge-validation-sizing`, `/multi-model-ensemble` | `/arsenal --family prediction-market-ai-event-analysis` |
| `/prediction-market-making` **prediction-market-making** | 2 | `/adverse-selection-defense`, `/reward-optimization` | `/arsenal --family prediction-market-making` |
| `/prediction-market-risk-management` **prediction-market-risk-management** | 2 | `/kill-switch-protocol`, `/portfolio-risk-audit` | `/arsenal --family prediction-market-risk-management` |
| `/prediction-market-weather-trading` **prediction-market-weather-trading** | 2 | `/calibration-review`, `/trade-execution-plan` | `/arsenal --family prediction-market-weather-trading` |
| — **product-design-build** | 2 | `/product-design-design-system-deploy`, `/product-design-page-build` | `/arsenal --family product-design-build` |
| `/prosperity-coach-system` **prosperity-coach-system** | 2 | `/prosperity-coach-run-30-day-journey`, `/prosperity-coach-stack-and-integrate-factors` | `/arsenal --family prosperity-coach-system` |
| `/rachel-woods-ai-operations` **rachel-woods-ai-operations** | 2 | `/ai-native-process-engineering`, `/ai-ops-governance-design` | `/arsenal --family rachel-woods-ai-operations` |
| `/ray-amjad-agentic-ladder` **ray-amjad-agentic-ladder** | 9 | `/ray-adoption-brief`, `/ray-chat-native-harness`, `/ray-fanout-mission`, … | `/arsenal --family ray-amjad-agentic-ladder` |
| `/reid-hoffman-ai-strategy` **reid-hoffman-ai-strategy** | 2 | `/reid-hoffman-design-agent-field`, `/reid-hoffman-stress-test-ai-bet` | `/arsenal --family reid-hoffman-ai-strategy` |
| `/riley-brown-marketing-automation` **riley-brown-marketing-automation** | 12 | `/riley-ad-spy`, `/riley-automations`, `/riley-brand-scrape`, … | `/arsenal --family riley-brown-marketing-automation` |
| `/robert-greene-power-mastery` **robert-greene-power-mastery** | 2 | `/robert-greene-design-mastery-path`, `/robert-greene-engineer-strategic-presence` | `/arsenal --family robert-greene-power-mastery` |
| `/robert-mack-comedy-writing` **robert-mack-comedy-writing** | 7 | `/authority-comedy-calibration`, `/comedic-punch-up-resonance-audit`, `/comedy-voice-layer`, … | `/arsenal --family robert-mack-comedy-writing` |
| `/rory-flynn` **rory-flynn** | 3 | `/moodboard-sweep`, `/photorealism-language`, `/style-code-library` | `/arsenal --family rory-flynn` |
| `/rory-sutherland-marketing` **rory-sutherland-marketing** | 10 | `/adoption-unit`, `/advertising-archaeology-lab`, `/behavioral-alchemy-router`, … | `/arsenal --family rory-sutherland-marketing` |
| `/ross-minchev-digital-products` **ross-minchev-digital-products** | 2 | `/ross-minchev-create-digital-product`, `/ross-minchev-monetize-and-launch` | `/arsenal --family ross-minchev-digital-products` |
| `/russell-brunson-funnels` **russell-brunson-funnels** | 2 | `/russell-brunson-engineer-identity-movement`, `/russell-brunson-extract-timeless-principles` | `/arsenal --family russell-brunson-funnels` |
| `/sabri-suby-ai-advertising` **sabri-suby-ai-advertising** | 3 | `/sabri-suby-competitive-intelligence-psychographics`, `/sabri-suby-creative-execution-scaling`, `/sabri-suby-offer-funnel-architecture` | `/arsenal --family sabri-suby-ai-advertising` |
| `/sabrina-ramonov-ai-monetization` **sabrina-ramonov-ai-monetization** | 2 | `/learn-in-public-brand-engine`, `/recurring-community-monetization` | `/arsenal --family sabrina-ramonov-ai-monetization` |
| `/sam-goddard-media-scaling` **sam-goddard-media-scaling** | 4 | `/sam-goddard-cross-platform-audience-compounding`, `/sam-goddard-high-retention-scripting-engine`, `/sam-goddard-media-operation-scaling-blueprint`, … | `/arsenal --family sam-goddard-media-scaling` |
| `/sam-parr-copywriting` **sam-parr-copywriting** | 10 | `/parr-ad-rewrite`, `/parr-niche`, `/parr-objection`, … | `/arsenal --family sam-parr-copywriting` |
| `/sam-parr-copywriting-mechanics` **sam-parr-copywriting-mechanics** | 13 | `/copywork-hour-sprint`, `/copywork-rule-extraction`, `/curiosity-gap-repair`, … | `/arsenal --family sam-parr-copywriting-mechanics` |
| `/sam-parr-taste-acquisition` **sam-parr-taste-acquisition** | 12 | `/taste-cev`, `/taste-copy`, `/taste-declare`, … | `/arsenal --family sam-parr-taste-acquisition` |
| `/sam-vander-wielen` **sam-vander-wielen** | 11 | `/sv-book-funnel-bridge`, `/sv-customer-personality-lock`, `/sv-launch-system`, … | `/arsenal --family sam-vander-wielen` |
| `/samuel-thompson-product-launch` **samuel-thompson-product-launch** | 3 | `/mvp-sales-engine-builder`, `/rigged-slot-machine-launch-plan`, `/shadow-market-validation-report` | `/arsenal --family samuel-thompson-product-launch` |
| `/sarah-levinger-ad-psychology` **sarah-levinger-ad-psychology** | 2 | `/sarah-levinger-match-avatar-structure`, `/sarah-levinger-optimize-product-placement` | `/arsenal --family sarah-levinger-ad-psychology` |
| `/satori-graphics` **satori-graphics** | 27 | `/satori-anti-ai-slop`, `/satori-brand-audit`, `/satori-color`, … | `/arsenal --family satori-graphics` |
| `/sean-dollwet-kdp-publishing` **sean-dollwet-kdp-publishing** | 11 | `/sean-dollwet-book-blueprint`, `/sean-dollwet-book-doctor`, `/sean-dollwet-book-one-pilot`, … | `/arsenal --family sean-dollwet-kdp-publishing` |
| `/sean-kochel-ai-business` **sean-kochel-ai-business** | 3 | `/conversion-onboarding-playbook`, `/messaging-mechanism-engine`, `/trust-architecture-blueprint` | `/arsenal --family sean-kochel-ai-business` |
| `/sean-kochel-design-first-build` **sean-kochel-design-first-build** | 1 | `/design-to-code-execution` | `/arsenal --family sean-kochel-design-first-build` |
| `/sean-macintyre-persuasion-philosophy` **sean-macintyre-persuasion-philosophy** | 17 | `/sean-adherence-protocol`, `/sean-armor-diagnose`, `/sean-armor-iha-proof`, … | `/arsenal --family sean-macintyre-persuasion-philosophy` |
| `/seena-rez-tiktok-commerce` **seena-rez-tiktok-commerce** | 2 | `/campaign-orchestration-optimization`, `/conversion-funnel-scaling-system` | `/arsenal --family seena-rez-tiktok-commerce` |
| `/seth-godin-brand` **seth-godin-brand** | 10 | `/godin-ai-permission`, `/godin-better-not-louder`, `/godin-brand-promise`, … | `/arsenal --family seth-godin-brand` |
...
| `/seth-godin-philosophy` **seth-godin-philosophy** | 5 | `/godin-ai-creative-practice`, `/seth-godin-audience-truth-audit`, `/seth-godin-decision-quality-audit`, … | `/arsenal --family seth-godin-philosophy` |
| `/shaan-puri-storytelling` **shaan-puri-storytelling** | 7 | `/brand-identity-emotional-blueprint`, `/narrative-script-optimization-audit`, `/shaan-story-deploy`, … | `/arsenal --family shaan-puri-storytelling` |
...
| — **simon-intellectual-library-os** | 15 | `/library-advisor-board`, `/library-advisor-build`, `/library-brain-ladder`, … | `/arsenal --family simon-intellectual-library-os` |
| `/sky-tan-format-engine` **sky-tan-format-engine** | 12 | `/sky-atomize-format`, `/sky-authority-hijack`, `/sky-conversion-gate`, … | `/arsenal --family sky-tan-format-engine` |
| — **soowei-consulting-leverage** | 11 | `/broad-to-buyer-script-funnel`, `/buyer-mirror-content-intelligence`, `/founder-leverage-exit-roadmap`, … | `/arsenal --family soowei-consulting-leverage` |
| — **stefan-georgi-dopamine-copy** | 1 | `/copy-thinker-judgment-loop` | `/arsenal --family stefan-georgi-dopamine-copy` |
| `/steven-kotler-flow-performance` **steven-kotler-flow-performance** | 2 | `/steven-kotler-diagnose-flow-blockers`, `/steven-kotler-engineer-motivation-stack` | `/arsenal --family steven-kotler-flow-performance` |
| `/steven-pressfield-narrative-mastery` **steven-pressfield-narrative-mastery** | 7 | `/steven-pressfield-brand-narrative-builder`, `/steven-pressfield-content-series-architecture`, `/steven-pressfield-five-aims-quality-gate`, … | `/arsenal --family steven-pressfield-narrative-mastery` |
| `/steven-young-consciousness` **steven-young-consciousness** | 2 | `/steven-young-engineer-oblique-intention`, `/steven-young-reveal-dream-day` | `/arsenal --family steven-young-consciousness` |
| `/stockton-walbeck-lead-magnets` **stockton-walbeck-lead-magnets** | 2 | `/lead-magnet-profitability-optimization`, `/multi-touch-lead-gen-architecture` | `/arsenal --family stockton-walbeck-lead-magnets` |
| — **story-bible-builder** | 3 | `/ensemble-and-engines`, `/production-rules-and-assembly`, `/spine-and-world-build` | `/arsenal --family story-bible-builder` |
| `/story-compass` **story-compass** | 13 | `/runia-anticipation`, `/runia-batch-compass`, `/runia-change-engineer`, … | `/arsenal --family story-compass` |
| `/strength-conditioning-os` **strength-conditioning-os** | 1 | `/strength-conditioning-build-integrated-program` | `/arsenal --family strength-conditioning-os` |
| `/sunny-lenarduzzi-youtube` **sunny-lenarduzzi-youtube** | 2 | `/sunny-lenarduzzi-build-authority-engine`, `/sunny-lenarduzzi-engineer-authority-channel` | `/arsenal --family sunny-lenarduzzi-youtube` |
| `/supercomputer` **supercomputer** | 4 | `/anchor-propagation-verification`, `/mission-completion-summary`, `/mission-pivot-replan`, … | `/arsenal --family supercomputer` |
| `/susan-orlean-narrative-nonfiction` **susan-orlean-narrative-nonfiction** | 10 | `/orlean-be-brutal-edit`, `/orlean-card-structure`, `/orlean-curiosity-content`, … | `/arsenal --family susan-orlean-narrative-nonfiction` |
| `/taki-moore-lifestyle-business` **taki-moore-lifestyle-business** | 5 | `/taki-moore-anti-scale-content-engine`, `/taki-moore-beginner-acceleration-system`, `/taki-moore-cohort-launch-engine`, … | `/arsenal --family taki-moore-lifestyle-business` |
| `/tao-prompts-ai-video` **tao-prompts-ai-video** | 1 | `/cinematic-architecture-and-performance` | `/arsenal --family tao-prompts-ai-video` |
| `/taylor-welch-wealthy-consultant` **taylor-welch-wealthy-consultant** | 2 | `/taylor-welch-architect-quantum-growth-plan`, `/taylor-welch-navigate-wealth-thresholds` | `/arsenal --family taylor-welch-wealthy-consultant` |
| `/tess-barclay-social-content` **tess-barclay-social-content** | 2 | `/tess-barclay-build-platform-ecosystem`, `/tess-barclay-produce-casual-polished-content` | `/arsenal --family tess-barclay-social-content` |
| — **thrivecart-digital-products** | 3 | `/digital-product-ecosystem-roadmap`, `/high-conversion-checkout-stack`, `/three-levers-performance-audit` | `/arsenal --family thrivecart-digital-products` |
| `/tim-danilov-niche-bending` **tim-danilov-niche-bending** | 1 | `/multi-platform-audience-growth` | `/arsenal --family tim-danilov-niche-bending` |
| `/tobi-lutke-business-leadership` **tobi-lutke-business-leadership** | 2 | `/tobi-lutke-audit-orthodoxy`, `/tobi-lutke-compress-the-change` | `/arsenal --family tobi-lutke-business-leadership` |
| `/tobias-allen-marketing-mastery` **tobias-allen-marketing-mastery** | 2 | `/backend-revenue-maximization-system`, `/direct-response-campaign-assembly` | `/arsenal --family tobias-allen-marketing-mastery` |
| `/tom-noske-content-creation` **tom-noske-content-creation** | 4 | `/content-debloat`, `/content-funnel`, `/origin-story-engine`, … | `/arsenal --family tom-noske-content-creation` |
| `/tom-noske-personal-brand` **tom-noske-personal-brand** | 3 | `/full-stack-launch-equity-flywheel`, `/high-ticket-monetization-architecture`, `/trust-velocity-content-engine` | `/arsenal --family tom-noske-personal-brand` |
| `/tom-segura-comedy-storytelling` **tom-segura-comedy-storytelling** | 12 | `/segura-antenna`, `/segura-arc`, `/segura-audit`, … | `/arsenal --family tom-segura-comedy-storytelling` |
| `/tommy-clark-linkedin-growth` **tommy-clark-linkedin-growth** | 5 | `/high-visibility-growth-engine`, `/tc-data-moat`, `/tc-physical-moat`, … | `/arsenal --family tommy-clark-linkedin-growth` |
| `/trigger-event-creative-strategy` **trigger-event-creative-strategy** | 3 | `/trigger-event-mine`, `/trigger-event-scale-matrix`, `/trigger-event-story-architect` | `/arsenal --family trigger-event-creative-strategy` |
| `/tyler-denk-audience-monetization` **tyler-denk-audience-monetization** | 1 | `/high-ticket-monetization-intimacy-stack` | `/arsenal --family tyler-denk-audience-monetization` |
| `/verticalize` **verticalize** | 4 | `/phase-0-2-foundation-capture`, `/phase-2-5-validation-gate`, `/phase-3-ground-truth-seed`, … | `/arsenal --family verticalize` |
| `/video-studio` **video-studio** | 5 | `/broll-ladder`, `/derive-shorts`, `/package-release`, … | `/arsenal --family video-studio` |
| `/vince-nijhof-dtc-operator-system` **vince-nijhof-dtc-operator-system** | 14 | `/vince-ai-native-team-design`, `/vince-blended-attribution-blueprint`, `/vince-creative-pod-architect`, … | `/arsenal --family vince-nijhof-dtc-operator-system` |
| `/voice-os` **voice-os** | 3 | `/card-recompile`, `/felt-verdict-capture`, `/verification-pass` | `/arsenal --family voice-os` |
| `/ward-farnsworth-rhetorical-mastery` **ward-farnsworth-rhetorical-mastery** | 12 | `/visceral-persuasion-bridge`, `/ward-antithesis`, `/ward-aphorism-forge`, … | `/arsenal --family ward-farnsworth-rhetorical-mastery` |
| — **wordsatscale-seo-ranking** | 3 | `/authority-driven-content-factory`, `/rank-validation-proof-engine`, `/rapid-deployment-indexing-system` | `/arsenal --family wordsatscale-seo-ranking` |
| `/wright-thompson-mastery` **wright-thompson-mastery** | 13 | `/emotional-pressure-map`, `/wright-complication`, `/wright-detail`, … | `/arsenal --family wright-thompson-mastery` |
| — **youtube-video-context-analysis** | 7 | `/youtube-video-context-audit`, `/youtube-video-creative-reference-breakdown`, `/youtube-video-frame-ledger`, … | `/arsenal --family youtube-video-context-analysis` |
| `/yuri-elkaim-health-coaching-business` **yuri-elkaim-health-coaching-business** | 2 | `/yuri-elkaim-launch-perfect-client-pipeline`, `/yuri-elkaim-run-30-day-authority-roadmap` | `/arsenal --family yuri-elkaim-health-coaching-business` |

### 🗂️ Standalone Workflows — A–Z (926)

Names only — run `/arsenal <task>` for what each one does.

**A** · `/aar` · `/ad-spy` · `/adam-enfroy` · `/adam-enfroy-affiliate-marketing` · `/adam-sandler` · `/adam-sandler-second-brain-gtm` · `/ai-carousel` · `/ai-chris` · `/ai-chris-lee` · `/ai-creative` · `/alan-aragon` · `/alan-aragon-nutrition` · `/alen-sultanic` · `/alen-sultanic-copywriting` · `/alex-content` · `/alex-content-science` · `/alex-copper` · `/alex-copper-creative-strategy` · `/alex-hormozi` · `/alex-hormozi-business` · `/alex-m` · `/alex-m-smith` · `/alex-myatt` · `/alex-myatt-creative-engine` · `/alex-suzuki` · `/alex-suzuki-digital-product-revenue-os` · `/alex-suzuki-revenue-architect` · `/algorithmic-art` · `/ali-abdaal` · `/ali-abdaal-action-bias` · `/alyssa-stalker` · `/alyssa-stalker-agent-content-playbook` · `/andreessen-horowitz` · `/andrew-dun` · `/andrew-dun-vibe-consulting` · `/andrew-lane` · `/andrew-sean` · `/andrew-sean-greer` · `/andrew-stanton` · `/andrew-stanton-audience-engineering` · `/andrew-wilkinson` · `/andrew-wilkinson-ai-entrepreneurship` · `/andy-galpin` · `/andy-galpin-training-intelligence` · `/andy-lo` · `/andy-lo-premium-websites` · `/anne-lamott` · `/anne-lamott-neal-allen` · `/anti-slop-audit` · `/april-dunford` · `/april-dunford-positioning` · `/arsenal` · `/artifact-router` · `/ash-maurya` · `/ash-maurya-founder-systems` · `/ash-maurya-lean-metrics` · `/assemble` · `/asset-generator` · `/asset_generator` · `/assets-board` · `/attention-hijack` · `/authority-hacker` · `/authority-hacker-ai-social-media` · `/autopilot` · `/avatar-machine`

**B** · `/banana-pro` · `/bayer-mirror` · `/ben-watkins` · `/ben-watkins-storytelling` · `/benjamin-hardy` · `/benjamin-hardy-identity` · `/benoit-vatere` · `/bilawal-sidhu` · `/bill-browder` · `/bill-browder-high-stakes-narrative` · `/bitbranding` · `/bitbranding-fashion` · `/bond-halbert` · `/bond-halbert-copywriting` · `/boris` · `/boris-claude` · `/brad-bonanno` · `/brad-bonanno-explainer-architecture` · `/brad-compound-close` · `/brad-matrix-moment` · `/brad-pause-test-audit` · `/brad-trust-anchor` · `/brand-asset-scrape` · `/brand-dna-extraction` · `/brand-guidelines` · `/brand-in-a-box` · `/brand-operating` · `/branded-deliverable-package` · `/brandon-jacoby` · `/brendan-kane` · `/brendan-kane-viral-strategy` · `/briar-cochran` · `/briar-cochran-content-science` · `/briefing-room` · `/briefs` · `/brock-johnson` · `/brock-johnson-shareworthy-content` · `/business-intelligence`

**C** · `/caleb-ralston` · `/caleb-ralston-personal-brand` · `/campaign` · `/canvas` · `/canvas-design` · `/cardinal-mason` · `/cardinal-mason-ai-copywriting` · `/catalog` · `/chase-hughes` · `/chase-hughes-context-engineering` · `/chase-hughes-conversational-influence` · `/cheri-tree` · `/chief-of` · `/chris-cimorelli` · `/chris-cimorelli-copywriting` · `/chris-do` · `/chris-do-design-business` · `/cinema-worldbuilder` · `/cinematic-documentary` · `/claim-safe` · `/coaching-business` · `/coaching-business-os` · `/cody-schneider` · `/cody-schneider-signal-outbound` · `/cognitive-engagement` · `/cognitive-engagement-optimizer` · `/compile-knowledge` · `/consumer-posture` · `/content-brand-forge` · `/context-profile` · `/context-profile-architect` · `/convene` · `/cooz-flywheel` · `/cooz-flywheel-v5` · `/corey-mcclain` · `/corey-mcclain-persona-engineering` · `/craig-clemens` · `/craig-clemens-copywriting` · `/create` · `/creative-assembly` · `/creative-campaign` · `/creative-direction` · `/creative-director` · `/creative-from-winners` · `/ctm-clean` · `/ctm-deepen` · `/ctm-gaps` · `/ctm-gather` · `/ctm-jobs` · `/ctm-map` · `/ctm-refresh` · `/ctm-scope` · `/ctm-to-content` · `/ctm-to-copy` · `/ctm-to-offer` · `/ctm-triangulate` · `/curious-refuge` · `/customer-truth` · `/customer-truth-map`

**D** · `/dai-media` · `/dai-media-consumer-posture` · `/daily-zeitgeist-brief` · `/dakota-content` · `/dakota-thiefofboredom` · `/damon-cart` · `/damon-cart-nlp` · `/dan-bolton` · `/dan-bolton-coaching-offers` · `/dan-koe` · `/dan-koe-ai-leverage` · `/dan-koe-multipassionate-mastery` · `/dan-martell` · `/dan-martell-business-scaling` · `/dan-wang` · `/dan-wang-literary-analysis` · `/daniel-pink` · `/daniel-pink-writing-structure` · `/daniel-priestley` · `/daniel-priestley-24-assets-os` · `/daniel-priestley-oversubscribed` · `/daniel-priestley-sll-engine` · `/daniel-thrasher` · `/daniel-thrasher-affiliate` · `/danny-yeung` · `/dara-denney-meta-ads` · `/daring-disobedience` · `/darrel-wilson` · `/darrel-wilson-ai-affiliate` · `/darrel-wilson-ai-monetization` · `/dave-clark` · `/david-baldacci` · `/david-baldacci-books-that-sell` · `/david-bayer` · `/david-bayer-elite-communication` · `/david-deutsch` · `/david-deutsch-copywriting` · `/david-gelb` · `/david-mcraney` · `/david-mcraney-belief-change` · `/david-perell` · `/david-perell-writing` · `/david-placek` · `/david-placek-naming` · `/deck-build` · `/deep-research-gemini` · `/deep-research-os` · `/deliberate` · `/deploy-council` · `/design-iteration-loop` · `/design-library-import` · `/design-md` · `/design-philosophy-architect` · `/design-skill-enshrine` · `/design-system-forge` · `/deya` · `/deya-business` · `/dhar-mann-transformational-storytelling` · `/diandra-escobar` · `/diandra-escobar-linkedin-growth` · `/diandra-escobar-linkedin-mastery` · `/doc-coauthoring` · `/docx` · `/dom-iacovone` · `/donald-miller` · `/donald-miller-business-growth` · `/donald-miller-cognitive-load` · `/donald-miller-culture-turnaround` · `/donald-miller-messaging-evolution` · `/donald-miller-storybrand` · `/dr-k` · `/dr-k-consciousness` · `/dr-kriukow` · `/dr-kriukow-humanization` · `/dream-local` · `/drk-belief-dissolve` · `/drk-content-sattva` · `/drk-creative-unblock` · `/drk-mind-garden-content` · `/drk-proof-clarity` · `/drk-purpose-position`

**E** · `/enchant` · `/enrico-incarnati` · `/eric-roth` · `/eric-roth-screenwriting-mastery` · `/eric-roth-writing-mastery` · `/erica-mallet` · `/erica-mallet-brand-magnetism` · `/ethan-smith` · `/ethan-smith-aeo` · `/etymology-engine` · `/eugene-teo` · `/eugene-teo-training` · `/evan-spiegel` · `/evan-spiegel-distribution-architecture` · `/expert-assembly` · `/expert-practice` · `/extract-amplify` · `/extract-approach` · `/extract-mastery` · `/extract-vision`

**F** · `/fantastic-posters` · `/fareed-zakaria` · `/fareed-zakaria-writing-mastery` · `/fashion-coupids` · `/find-skill` · `/first-10k` · `/forge-os` · `/fraser-cottrell` · `/fraser-cottrell-paid-ads` · `/fresh-pen` · `/fresh-voice` · `/frontend-design` · `/fryderyk-wiatrowski` · `/futurepedia` · `/futurepedia-prompt`

**G** · `/gabe-novotny` · `/gabe-novotny-fitness-content-business` · `/gary-vaynerchuk` · `/gary-vaynerchuk-attention` · `/gemini-api` · `/generate` · `/generate-design` · `/geoff-woods` · `/geoff-woods-ai-thought-partner` · `/ghostwriting-voice` · `/go` · `/gpt-image` · `/gpt-image-2` · `/grace-andrews` · `/grace-andrews-media-company` · `/grace-leung` · `/grace-liu` · `/greg-hickman` · `/greg-hickman-service-scaling` · `/greg-hoffman` · `/greg-hoffman-brand-mastery` · `/growth-blueprint` · `/growth-ecosystems`

**H** · `/handoff` · `/harry-dry` · `/harry-dry-copywriting` · `/haunt` · `/haunt-audit` · `/haunt-copy` · `/haunt-social` · `/haunt-story` · `/heath-brothers` · `/henrik-werdelin` · `/henrik-werdelin-portfolio-entrepreneurship` · `/henry-shukman` · `/henry-shukman-contemplative-writing` · `/heydominik-instagram` · `/hidden-secondary-market-finder` · `/higgsfield-content` · `/higgsfield-creative` · `/hilary-gridley` · `/homebase` · `/how-i` · `/how-i-write-os` · `/hughes-archetype-prime` · `/hughes-camera-angle` · `/hughes-empathy-ladder` · `/hughes-feel-clever` · `/hughes-influence-audit` · `/hughes-two-ideas-detector`

**I** · `/ideate` · `/inbox-drafts` · `/insight-vectors` · `/instagram-growth-os` · `/internal-comms`

**J** · `/jack-roberts` · `/jake-thornhill` · `/jam` · `/james-i` · `/jasmin-alic` · `/jasmin-alic-linkedin-growth` · `/jason-fladlien` · `/jason-fladlien-marketing` · `/jay-hiette` · `/jay-hiette-coaching-positioning` · `/jay-sun` · `/jcc-deploy` · `/jcc-pulse` · `/jcc-refine` · `/jcc-upgrade` · `/jen-engine` · `/jen-property-video` · `/jen-santulan` · `/jen-shortform` · `/jenny-hoyos` · `/jenny-hoyos-shorts` · `/jensen-acosta-growth` · `/jensen-advocacy` · `/jensen-ai-gate` · `/jensen-algorithm-audit` · `/jensen-b2b-creative` · `/jensen-brand-physics` · `/jensen-clark-advocacy` · `/jensen-dunford-long-game` · `/jensen-gotch-retrieval` · `/jensen-llm-cite` · `/jensen-platform-intel` · `/jensen-song-sheet` · `/jeremy-haynes` · `/jeremy-haynes-cold-offer` · `/jeremy-haynes-mindset-systems` · `/jeremy-miner` · `/jeremy-miner-identity-persuasion` · `/jessica-jensen` · `/jessica-jensen-platform-intelligence` · `/jiang-xueqin` · `/jiang-xueqin-cognitive-autonomy` · `/jim-oshaughnessy` · `/jim-oshaughnessy-philosopher-financier` · `/jimmy-conover` · `/joanna-wiebe` · `/joanna-wiebe-persuasion-mastery` · `/joanna-wiebe-writing-careers` · `/joey-cinema` · `/joey-noisy-group` · `/john-whiting` · `/john-whiting-propaganda-machine` · `/jonah-berger` · `/jonah-berger-contagious` · `/jonathan-courtney` · `/jonathan-courtney-marketing` · `/jonathan-franzen` · `/jonathan-franzen-storytelling` · `/jordan-crawford` · `/jordan-crawford-gtm-intelligence` · `/joscha-bach` · `/joscha-bach-consciousness` · `/josh-kaufman` · `/josh-kaufman-business-fundamentals` · `/josh-sanders` · `/josh-sanders-linkedin-growth` · `/joshua-smith` · `/joshua-smith-real-estate` · `/jun-yuh` · `/jun-yuh-creator-vision` · `/jun-yuh-personal-brand` · `/justin-welsh` · `/justin-welsh-solopreneur`

**K** · `/kallaway` · `/kallaway-addictive` · `/kallaway-ai` · `/kallaway-audience` · `/kallaway-content` · `/kallaway-content-operating-system` · `/kallaway-content-psychology` · `/kallaway-content-system` · `/kallaway-hook` · `/kallaway-social` · `/kallaway-word` · `/kdp-engine` · `/kieran-content-domain-arsenal` · `/kieran-content-intelligence-system` · `/kieran-flanagan` · `/kieran-flanagan-agentic-ops` · `/kieran-flanagan-audience-intelligence` · `/kieran-flanagan-content-engine` · `/kieran-flanagan-content-intelligence` · `/kieran-flanagan-content-ops` · `/kittl` · `/kittl-graphic` · `/kj-rainey` · `/kj-rainey-copywriting` · `/knowledge-architecture` · `/knowledge-architecture-studio` · `/kobi-brown` · `/kobi-brown-educational-virality` · `/kunal-shah` · `/kunal-shah-consumer-psychology` · `/kyle-milligan`

**L** · `/lamott-allen` · `/lamott-allen-really-real-writing` · `/lamott-craft` · `/lance-yichao` · `/lance-yichao-context-engineering` · `/lara-acosta` · `/lara-acosta-content-system` · `/lara-acosta-linkedin-growth` · `/lara-acosta-linkedin-mastery` · `/liam-mley` · `/liam-mley-ai-brain-builder` · `/liam-ottley` · `/lindsay` · `/lindsay-ai` · `/linkedin-2026` · `/literary-edging` · `/logan-kilpatrick` · `/logan-kilpatrick-ai-studio` · `/lucas-alpay` · `/lucas-alpay-storytelling` · `/luisa-zhou` · `/luisa-zhou-coaching` · `/luke-alexander` · `/luke-alexander-ai-business` · `/luke-iha` · `/luke-iha-avatar-machine` · `/luke-iha-client-mastery` · `/luke-iha-copy-blocks` · `/luke-iha-creative-strategy` · `/luke-iha-cross-domain` · `/luke-iha-insight-vectors` · `/luke-iha-million-dollar-mechanisms` · `/luke-iha-proof-ladder` · `/luke-iha-proof-mechanisms` · `/luke-iha-unaware-ads` · `/luke-iha-vicious-hooks` · `/luke-iha-vsl-leads` · `/lulu-cheng` · `/lulu-cheng-meservey` · `/lynch-brief-audit` · `/lynch-campaign-ecosystem` · `/lynch-character-test` · `/lynch-copy-pass` · `/lynch-counter-identity` · `/lynch-creative-brief` · `/lynch-customer-media` · `/lynch-customer-voice-mine` · `/lynch-deal-structure` · `/lynch-discovery-protocol` · `/lynch-drtv-vsl` · `/lynch-identity-campaign` · `/lynch-identity-posture` · `/lynch-media-match` · `/lynch-modular-script` · `/lynch-perception-identity` · `/lynch-price-architecture` · `/lynch-product-prequalify` · `/lynch-receive-the-draft` · `/lynch-strategist-career` · `/lynch-testimonial-relay` · `/lynch-transformation-sell` · `/lynch-umbrella-map`

**M** · `/made-to` · `/manus-ai` · `/manus-ai-consulting` · `/marc-andreessen` · `/marc-andreessen-ai-thesis` · `/maria-wendt` · `/maria-wendt-digital-products` · `/marisa-murgatroyd` · `/marisa-murgatroyd-course-design` · `/mark-forsyth` · `/mark-forsyth-rhetoric` · `/mark-kashef` · `/mark-kashef-agent-orchestration` · `/mark-kashef-ai-councils` · `/mark-kashef-banana-squad` · `/mark-kashef-claude-claw` · `/mark-kashef-silver-platter-agentic-os` · `/mark-kashef-visual-design` · `/mark-kashef-wargame-os` · `/mark-manson` · `/mark-manson-values-psychology` · `/market-intelligence` · `/market-pulse` · `/market_intelligence` · `/matt-haig` · `/matt-haig-reader-bridge` · `/matt-mcgarry` · `/matt-mcgarry-newsletters` · `/matthew-lakajev` · `/matthew-lakajev-linkedin` · `/matthew-volkwyn` · `/matthew-volkwyn-copywriting` · `/mcclain-agent-assemble` · `/mcclain-agent-evolve` · `/mcclain-agent-stress-test` · `/mcclain-backstory-engine` · `/mcclain-dai-audience-persona` · `/mcclain-expertise-distill` · `/mcclain-identity-excavate` · `/mcclain-llmp-architect` · `/mcclain-makoshi-capture` · `/mcclain-nate-full-agent` · `/mcclain-oren-taste-persona` · `/mcclain-persona-audit` · `/mcclain-persona-forge` · `/mcclain-persona-from-source` · `/mcclain-skill-architect` · `/mcclain-source-to-agent` · `/mcclain-steady-state-install` · `/mcclain-transistory-install` · `/mcclain-voice-texture` · `/mcclain-worldview-container` · `/mcp-builder` · `/meg-heckman` · `/meg-heckman-buyer-trigger-os` · `/mes-3` · `/michael-bernoff` · `/michael-bernoff-identity-engineering` · `/michael-connelly` · `/michael-connelly-vivid-writing` · `/michael-israetel` · `/michael-israetel-hypertrophy` · `/michael-margolis` · `/michael-margolis-user-research` · `/mickmumpitz` · `/mike-foutia` · `/mike-foutia-marketing-tools` · `/mike-sherrard` · `/mike-sherrard-realtor-branding` · `/mike-taylor` · `/mike-taylor-synthetic-research` · `/mission-control` · `/missions` · `/mitch-albom` · `/mitch-albom-writing-mastery` · `/monk-ai` · `/monk-ai-offer-architecture` · `/multi-format-deploy`

**N** · `/nate-b-jones` · `/nate-b-jones-agent-deployment-strategy` · `/nate-b-jones-ai-taste-mastery` · `/nate-b-jones-auto-improvement-loops` · `/nate-b-jones-context-engineering` · `/nate-b-jones-intent-engineering` · `/nate-b-jones-manager-loop` · `/nate-b-jones-orchestration-intelligence` · `/nate-b-jones-trust-architecture` · `/nate-herk` · `/nate-herk-client-acquisition` · `/nathan-gotch` · `/nathan-gotch-ai-seo` · `/nba-betting` · `/new-media-kingmaker` · `/nichebend-mastery` · `/nick-saraev` · `/nick-saraev-agentic-workflows` · `/nick-saraev-bottleneck-thinking` · `/nick-st` · `/nicolas-cole` · `/nicolas-cole-client-acquisition` · `/nicolas-cole-digital-products` · `/nicolas-cole-edan-writing-mechanics` · `/nicolas-cole-first-dollar` · `/nicolas-cole-first-dollar-system` · `/nicolas-cole-newsletter-flywheel` · `/nicolas-cole-niche-positioning` · `/nicolas-cole-nonfiction-value-architecture` · `/nicolas-cole-sales-education-messaging` · `/nicolas-cole-sentence-craft` · `/nir-eyal` · `/nir-eyal-habit-design` · `/noah-hawley` · `/noah-hawley-storytelling-mastery`

**O** · `/ocean-vuong` · `/ocean-vuong-perceptual-writing` · `/offer-redteam` · `/omar-eddaoudi` · `/omar-eddaoudi-premium-ads` · `/omar-eddaoudi-scaling-ops` · `/omar-eltakrori` · `/operator-autopilot` · `/operator-guide-sync` · `/operator-school` · `/oracle-board` · `/oren-archetype-diagnostic` · `/oren-archetype-pitch-deck` · `/oren-archetype-revenue-bridge` · `/oren-archetype-workshop` · `/oren-boring-industry-excavation` · `/oren-brand` · `/oren-brand-architect-pipeline` · `/oren-catalyst-architect` · `/oren-catalyst-helper-architect` · `/oren-content` · `/oren-dara` · `/oren-exemplar-library` · `/oren-helper-architect` · `/oren-identity` · `/oren-luxury` · `/oren-marketing` · `/oren-norton` · `/oren-one` · `/oren-operational` · `/oren-oracle-architect` · `/oren-performer-architect` · `/oren-repositioning` · `/oren-resource-audit` · `/oren-slop-era-creative-strategy` · `/oren-taste` · `/oren-taste-development` · `/oren-two-account-architect` · `/oren-world-builder-architect` · `/oscar-hoglund` · `/oscar-hoglund-sound-storytelling`

**P** · `/packy-mccormick` · `/packy-mccormick-writing` · `/paddy-galloway-youtube-strategy` · `/panel-sync` · `/paolo-trivellato` · `/paolo-trivellato-lead-magnet-engine` · `/park` · `/pat-flynn` · `/pat-flynn-passive-income` · `/patrick-dang` · `/patrick-dang-online-business` · `/patrick-debois` · `/patrick-debois-cdlc` · `/paul-harding` · `/paul-harding-lyric-prose` · `/paul-james` · `/paul-james-ai-automation` · `/pdf` · `/perception-lab` · `/persuasion-story` · `/phil-m` · `/pj-accetturo` · `/pj-accetturo-ai-video` · `/platform-pulse` · `/post-scheduler` · `/pptx` · `/prediction-market-ai-event-analysis` · `/prediction-market-making` · `/prediction-market-risk-management` · `/prediction-market-strategist` · `/prediction-market-weather-trading` · `/presentation-build` · `/product-design` · `/prompt-library` · `/prompt-system` · `/prosperity-coach` · `/prosperity-coach-system` · `/publishable-copy-gate` · `/pulse-board`

**R** · `/rachel-woods` · `/rachel-woods-ai-operations` · `/rafa-conde-fourth-wall-experience-os` · `/rafa-conde-memorable-product-design` · `/ray-amjad` · `/ray-amjad-agentic-ladder` · `/re-compliance` · `/react-components` · `/receipts-post` · `/reference-collection-sprint` · `/reference-led` · `/reference-led-creative-system` · `/reid-hoffman` · `/reid-hoffman-ai-strategy` · `/remotion` · `/remotion-video` · `/research-intelligence-agent` · `/revenue-offer-agent` · `/riley-brown` · `/riley-brown-marketing-automation` · `/robert-greene` · `/robert-greene-power-mastery` · `/robert-mac` · `/robert-mack` · `/robert-mack-comedy-writing` · `/ron-lynch` · `/rory-flynn` · `/rory-sutherland` · `/rory-sutherland-marketing` · `/ross-mckay` · `/ross-mckay-premium-at-scale` · `/ross-minchev` · `/ross-minchev-digital-products` · `/roundtable-live` · `/russell-brunson` · `/russell-brunson-funnels`

**S** · `/sabri-suby` · `/sabri-suby-ai-advertising` · `/sabrina-ramonov` · `/sabrina-ramonov-ai-monetization` · `/sam-goddard` · `/sam-goddard-media-scaling` · `/sam-parr` · `/sam-parr-copywriting` · `/sam-parr-taste-acquisition` · `/sam-vander-wielen` · `/samuel-thompson` · `/samuel-thompson-product-launch` · `/sarah-levinger` · `/sarah-levinger-ad-psychology` · `/satori-graphics` · `/scheduling-links` · `/scott-norton` · `/scrape-creator` · `/scrapes` · `/sean-dollwet` · `/sean-dollwet-kdp-publishing` · `/sean-kochel` · `/sean-kochel-ai-business` · `/sean-kochel-design-first-build` · `/sean-mabry` · `/sean-macintyre` · `/sean-macintyre-persuasion-philosophy` · `/search-content-mastery` · `/seena-rez` · `/seena-rez-tiktok-commerce` · `/self-evolving` · `/self-heal` · `/semantic-document` · `/service-first-productization` · `/seth-godin` · `/seth-godin-brand` · `/seth-godin-ideavirus` · `/seth-godin-marketing-mind` · `/seth-godin-philosophy` · `/shaan-puri` · `/shaan-puri-storytelling` · `/shan-hanif` · `/shan-hanif-audience-monetization` · `/sharran-srivatsaa` · `/sherwin-wu` · `/sherwin-wu-ai-engineering` · `/simon-better-creating` · `/simon-intellectual` · `/sinem-50-notes-extract` · `/sinem-about-page` · `/sinem-audit` · `/sinem-bestseller-campaign` · `/sinem-collaboration-outreach` · `/sinem-gunel` · `/sinem-multimedia-accelerator` · `/sinem-notes-discovery` · `/sinem-paid-tier-design` · `/sinem-publication-setup` · `/sinem-quarterly-review` · `/sinem-retention-engine` · `/sinem-revenue-architect` · `/sinem-substack` · `/skill-creator` · `/sky-tan` · `/sky-tan-format-engine` · `/slack-gif` · `/social-carousel` · `/social-content-studio` · `/social-listen` · `/social-post` · `/social-repurpose` · `/social-to-notion` · `/solo` · `/soowei` · `/soowei-consulting` · `/spiegel-agents` · `/spiegel-bottleneck` · `/spiegel-close-friends` · `/spiegel-distribution` · `/spiegel-dual-org` · `/spiegel-ecosystem` · `/spiegel-empathy` · `/spiegel-evolution` · `/spiegel-innovation` · `/spiegel-launch` · `/spiegel-moat` · `/spiegel-offer` · `/spiegel-workaround` · `/stefan-georgi` · `/steven-kotler` · `/steven-kotler-flow-performance` · `/steven-pressfield` · `/steven-pressfield-narrative-mastery` · `/steven-young` · `/steven-young-consciousness` · `/stitch-loop` · `/stockton-walbeck` · `/stockton-walbeck-lead-magnets` · `/story-bible` · `/story-compass` · `/strength-conditioning` · `/strength-conditioning-os` · `/strike` · `/strike-native` · `/sunny-lenarduzzi` · `/sunny-lenarduzzi-youtube` · `/supercomputer` · `/susan-orlean` · `/susan-orlean-narrative-nonfiction` · `/swarm-commander` · `/swarm-critique` · `/sweat-equity` · `/sweep` · `/system-hygiene`

**T** · `/taki-moore` · `/taki-moore-lifestyle-business` · `/tao-prompts` · `/tao-prompts-ai-video` · `/taylor-welch` · `/taylor-welch-wealthy-consultant` · `/teardown` · `/tess-barclay` · `/tess-barclay-social-content` · `/texture-over` · `/theme-factory` · `/thrivecart` · `/thrivecart-digital` · `/tim-danilov` · `/tim-danilov-niche-bending` · `/tim-runia` · `/tobi-lutke` · `/tobi-lutke-business-leadership` · `/tobias-allen` · `/tobias-allen-marketing-mastery` · `/tom-noske` · `/tom-noske-content-creation` · `/tom-noske-personal-brand` · `/tom-segura` · `/tom-segura-comedy-storytelling` · `/tommy-clark` · `/tommy-clark-linkedin-growth` · `/trigger-event-creative-strategy` · `/two-axis-verify` · `/tyler-denk` · `/tyler-denk-audience-monetization`

**V** · `/velocity-access-product` · `/velocity-audit` · `/velocity-cac-ltv` · `/velocity-constraint` · `/velocity-creative-cash` · `/velocity-creative-factory` · `/velocity-digital-access` · `/velocity-digital-launch` · `/velocity-founder-brand` · `/velocity-identity-partnership` · `/velocity-loss-leader` · `/velocity-operating-rhythm` · `/velocity-partnership` · `/velocity-pivot` · `/velocity-raise` · `/velocity-retention-story` · `/velocity-scaling` · `/velocity-to-content` · `/velocity-to-launch` · `/verticalize` · `/vibe-tax-brief` · `/vibe-tax-deploy` · `/vibe-tax-result-writer` · `/video-studio` · `/video-to-ebook` · `/video-to-shorts` · `/vince-nijhof` · `/vince-nijhof-dtc-operator-system` · `/vincent-hu` · `/virtuoso` · `/visual-proposal-build` · `/voice-compile` · `/voice-os` · `/voice-over` · `/voice-ratchet`

**W** · `/ward-farnsworth` · `/ward-farnsworth-rhetorical-mastery` · `/wayfinder-work` · `/web-artifacts` · `/webapp-testing` · `/website-build` · `/weekly-closeout` · `/wordsatscale` · `/wordsatscale-seo` · `/wright-thompson` · `/wright-thompson-mastery` · `/writing-depth`

**X** · `/xlsx`

**Y** · `/yann-martel` · `/youtube-video` · `/yuri-elkaim` · `/yuri-elkaim-health-coaching-business`
