...
| Jen Santulan work | `cd _active/clients/jen-listings/` then work | Client CLAUDE.md auto-loads |
| Andrea / Resonance work | `cd _active/clients/andrea-dj/` then work | Client CLAUDE.md auto-loads |
