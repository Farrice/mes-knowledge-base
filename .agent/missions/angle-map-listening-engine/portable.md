...
- **Mode**: auto
- **Serves**: revenue-5k-incumbency (target match: content, health, performance) · **Tier**: T1 auto
...
- **Center**: The /first-10k outcome, with proof and handoff included.
...
- **Approval needed**: Approve the named risk gate before execution: paid/budget
- **First safe action**: /first-10k Build the Angle Map industry listening engine: fuse health-performance-geo-daily-brief + insight-brief into one scheduled daily automation (local launchd 05:30) running real social listening (Apify-first, Perplexity fallback) that delivers a morning brief — daily 3-min core (buyer tension, promises-not-kept receipts, content thesis, post seed) + rotating deep focus (Mon audience, Tue ICP, Wed promises, Thu category patterns, Fri synthesis, Sat winners, Sun education) — compounding into living docs (07-AUDIENCE-PROFILE, 03-ICP-TRUTH-MAP, promises-not-kept ledger) and delivered to COS brief + disk + Google Drive, all centered on the locked Angle Map offer.
- **Operator run prompt**: /first-10k Build the Angle Map industry listening engine: fuse health-performance-geo-daily-brief + insight-brief into one scheduled daily automation (local launchd 05:30) running real social listening (Apify-first, Perplexity fallback) that delivers a morning brief — daily 3-min core (buyer tension, promises-not-kept receipts, content thesis, post seed) + rotating deep focus (Mon audience, Tue ICP, Wed promises, Thu category patterns, Fri synthesis, Sat winners, Sun education) — compounding into living docs (07-AUDIENCE-PROFILE, 03-ICP-TRUTH-MAP, promises-not-kept ledger) and delivered to COS brief + disk + Google Drive, all centered on the locked Angle Map offer.
