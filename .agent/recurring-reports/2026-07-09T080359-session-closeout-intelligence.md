...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-09 (chain_runner finalize for _active/health-performance-ip-library/AUTOMATION_PROMPT.md) (count: 597)
    • quality_gate.md: 2026-07-09 (chain_runner finalize for _active/health-performance-ip-library/AUTOMATION_PROMPT.md) (count: 585)
