...
| Sovereign Memory | ACTIVE | — | 5273 | Healthy |

## Sovereign Memory

- **Total memories**: 5273 (91 pinned, 5239 embedded — 99.4% coverage)
- **By tier**: episodic=5042, procedural=107, semantic=124
- **By workspace**: (global)=1662, claude-export=3611
- **Notion mirror**: 874 pages, last mirrored 22.46h ago (OK)
- **Latest backup**: 21.46h ago (OK)
