...
| Sovereign Memory | ACTIVE | — | 5422 | Healthy |

## Sovereign Memory

- **Total memories**: 5422 (91 pinned, 5385 embedded — 99.3% coverage)
- **By tier**: episodic=5181, procedural=107, semantic=134
- **By workspace**: (global)=1811, claude-export=3611
- **Notion mirror**: 941 pages, last mirrored 16.18h ago (OK)
- **Latest backup**: 15.18h ago (OK)
