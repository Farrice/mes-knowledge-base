...
| Session State | ACTIVE | Today (2026-07-21 13:49) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 557 | Healthy |
| Gap Log | ACTIVE | — | 3 | Healthy |
| Sovereign Memory | ACTIVE | — | 5400 | Healthy |

## Sovereign Memory

- **Total memories**: 5400 (91 pinned, 5385 embedded — 99.7% coverage)
- **By tier**: episodic=5163, procedural=107, semantic=130
- **By workspace**: (global)=1789, claude-export=3611
- **Notion mirror**: 941 pages, last mirrored 11.83h ago (OK)
- **Latest backup**: 10.84h ago (OK)
...
- **Would-blocks last 7d**: 325
- ⚠ 325 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ACTIVE RECENT (3):
    - feedback-ratchet.md: 2026-07-21 (chain_runner finalize for leadership-cli) (count: 714)
    - session-state-protocol.md: 2026-07-21 (chain_runner session checkpoint) (count: 702)
    - quality_gate.md: 2026-07-21 (chain_runner finalize for leadership-cli) (count: 702)
...
- Committed local performance entries: 82
