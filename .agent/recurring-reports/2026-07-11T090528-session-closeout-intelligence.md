...
| Sovereign Memory | ACTIVE | — | 5055 | Healthy |

## Sovereign Memory

- **Total memories**: 5055 (88 pinned, 5054 embedded — 100.0% coverage)
- **By tier**: episodic=4831, procedural=107, semantic=117
- **By workspace**: (global)=1444, claude-export=3611
- **Notion mirror**: 758 pages, last mirrored 31.09h ago (OK)
- **Latest backup**: 5.99h ago (OK)
...
- **Would-blocks last 7d**: 93
- ⚠ 93 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
