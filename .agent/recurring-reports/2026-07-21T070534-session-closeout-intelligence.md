...
| Session State | ACTIVE | Today (2026-07-21 06:44) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 539 | Healthy |
| Gap Log | ACTIVE | — | 3 | Healthy |
| Sovereign Memory | ACTIVE | — | 5379 | Healthy |

## Sovereign Memory

- **Total memories**: 5379 (91 pinned, 5361 embedded — 99.7% coverage)
- **By tier**: episodic=5143, procedural=107, semantic=129
- **By workspace**: (global)=1768, claude-export=3611
- **Notion mirror**: 941 pages, last mirrored 5.09h ago (OK)
- **Latest backup**: 4.09h ago (OK)
- **⚠ Flagged for review**: 5 pending — run `python3 execution/memory_review.py list`
...
- **Would-blocks last 7d**: 319
- ⚠ 319 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
2. **REVIEW**: 5 distilled memories awaiting human approval. Run `python3 execution/memory_review.py list`.
```
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-21 (chain_runner finalize for deep-research-os) (count: 707)
    • quality_gate.md: 2026-07-21 (chain_runner finalize for deep-research-os) (count: 695)
    • session-state-protocol.md: 2026-07-21 (chain_runner session checkpoint) (count: 695)
...
- Committed local performance entries: 75
