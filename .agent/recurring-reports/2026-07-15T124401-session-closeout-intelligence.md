...
| Routing Intelligence | ACTIVE | — | 350 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5162 | Healthy |

## Sovereign Memory

- **Total memories**: 5162 (88 pinned, 5133 embedded — 99.4% coverage)
- **By tier**: episodic=4934, procedural=107, semantic=121
- **By workspace**: (global)=1551, claude-export=3611
- **Notion mirror**: 796 pages, last mirrored 10.73h ago (OK)
- **Latest backup**: 9.73h ago (OK)
...
- **Would-blocks last 7d**: 140
- ⚠ 140 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
