...
| Session State | ACTIVE | Today (2026-07-21 13:58) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 562 | Healthy |
| Gap Log | ACTIVE | — | 3 | Healthy |
| Sovereign Memory | ACTIVE | — | 5405 | Healthy |

## Sovereign Memory

- **Total memories**: 5405 (91 pinned, 5385 embedded — 99.6% coverage)
- **By tier**: episodic=5168, procedural=107, semantic=130
- **By workspace**: (global)=1794, claude-export=3611
- **Notion mirror**: 941 pages, last mirrored 12.13h ago (OK)
- **Latest backup**: 11.13h ago (OK)
...
- **Would-blocks last 7d**: 327
- ⚠ 327 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ACTIVE RECENT (3):
    - feedback-ratchet.md: 2026-07-21 (chain_runner finalize for meg-heckman-buyer-trigger-os) (count: 716)
    - session-state-protocol.md: 2026-07-21 (chain_runner session checkpoint) (count: 704)
    - quality_gate.md: 2026-07-21 (chain_runner finalize for meg-heckman-buyer-trigger-os) (count: 704)
...
- Committed local performance entries: 84
