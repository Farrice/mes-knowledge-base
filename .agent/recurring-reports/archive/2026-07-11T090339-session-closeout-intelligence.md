...
| Routing Intelligence | ACTIVE | — | 257 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5054 | Healthy |

## Sovereign Memory

- **Total memories**: 5054 (88 pinned, 5054 embedded — 100.0% coverage)
- **By tier**: episodic=4830, procedural=107, semantic=117
- **By workspace**: (global)=1443, claude-export=3611
- **Notion mirror**: 758 pages, last mirrored 31.06h ago (OK)
- **Latest backup**: 5.96h ago (OK)
