...
| Session State | ACTIVE | 1 days ago (2026-07-11 13:17) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 240 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5083 | Healthy |

## Sovereign Memory

- **Total memories**: 5083 (88 pinned, 5083 embedded — 100.0% coverage)
- **By tier**: episodic=4858, procedural=107, semantic=118
- **By workspace**: (global)=1472, claude-export=3611
- **Notion mirror**: 772 pages, last mirrored 6.46h ago (OK)
- **Latest backup**: 5.46h ago (OK)
...
- **Would-blocks last 7d**: 80
- ⚠ 80 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
ready=0 watchlist=322 blocked=58 top=maria-wendt-digital-products (watchlist)
```
