...
| Session State | ACTIVE | Today (2026-07-17 15:01) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 409 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5225 | Healthy |

## Sovereign Memory

- **Total memories**: 5225 (91 pinned, 5213 embedded — 99.8% coverage)
- **By tier**: episodic=4994, procedural=107, semantic=124
- **By workspace**: (global)=1614, claude-export=3611
- **Notion mirror**: 858 pages, last mirrored 17.63h ago (OK)
- **Latest backup**: 16.63h ago (OK)
...
- **Would-blocks last 7d**: 181
- ⚠ 181 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-17 (chain_runner finalize for orchestration-doctrine) (count: 655)
    • quality_gate.md: 2026-07-17 (chain_runner finalize for orchestration-doctrine) (count: 643)
    • session-state-protocol.md: 2026-07-17 (chain_runner session checkpoint) (count: 643)
...
- Committed local performance entries: 27
