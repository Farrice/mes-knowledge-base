...
| Session State | ACTIVE | Today (2026-07-09 06:38) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 213 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5022 | Healthy |

## Sovereign Memory

- **Total memories**: 5022 (88 pinned, 5021 embedded — 100.0% coverage)
- **By tier**: episodic=4802, procedural=107, semantic=113
- **By workspace**: (global)=1411, claude-export=3611
- **Notion mirror**: 748 pages, last mirrored 8.09h ago (OK)
- **Latest backup**: 7.09h ago (OK)
- **⚠ Flagged for review**: 12 pending — run `python3 execution/memory_review.py list`
...
- **Would-blocks last 7d**: 110
- ⚠ 110 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
2. **REVIEW**: 12 distilled memories awaiting human approval. Run `python3 execution/memory_review.py list`.
```
...
ready=0 watchlist=322 blocked=68 top=maria-wendt-digital-products (watchlist)
```
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-09 (chain_runner finalize for _active/knowledge/health-performance-ip-library/AUTOMATION_PROMPT.md) (count: 597)
    • quality_gate.md: 2026-07-09 (chain_runner finalize for _active/knowledge/health-performance-ip-library/AUTOMATION_PROMPT.md) (count: 585)
    • session-state-protocol.md: 2026-07-09 (chain_runner session checkpoint) (count: 585)
