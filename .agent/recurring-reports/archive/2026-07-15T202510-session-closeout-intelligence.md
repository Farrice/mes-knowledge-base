...
| Sovereign Memory | ACTIVE | — | 5164 | Healthy |

## Sovereign Memory

- **Total memories**: 5164 (88 pinned, 5133 embedded — 99.4% coverage)
- **By tier**: episodic=4936, procedural=107, semantic=121
- **By workspace**: (global)=1553, claude-export=3611
- **Notion mirror**: 796 pages, last mirrored 18.42h ago (OK)
- **Latest backup**: 17.42h ago (OK)
...
- **Would-blocks last 7d**: 142
- ⚠ 142 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
