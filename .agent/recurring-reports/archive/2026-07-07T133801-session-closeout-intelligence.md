...
| Session State | ACTIVE | Today (2026-07-07 12:25) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 145 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 4949 | Healthy |

## Sovereign Memory

- **Total memories**: 4949 (88 pinned, 4914 embedded — 99.3% coverage)
- **By tier**: episodic=4734, procedural=107, semantic=108
- **By workspace**: (global)=1338, claude-export=3611
- **Notion mirror**: 680 pages, last mirrored 11.63h ago (OK)
- **Latest backup**: 10.63h ago (OK)
...
- **Would-blocks last 7d**: 154
- ⚠ 154 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
ready=0 watchlist=322 blocked=65 top=maria-wendt-digital-products (watchlist)
```
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-07 (chain_runner finalize for mark-kashef-wargame-os) (count: 572)
    • quality_gate.md: 2026-07-07 (chain_runner finalize for mark-kashef-wargame-os) (count: 560)
    • session-state-protocol.md: 2026-07-07 (chain_runner session checkpoint) (count: 560)
