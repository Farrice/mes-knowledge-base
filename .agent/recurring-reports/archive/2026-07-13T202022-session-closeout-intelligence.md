...
| Routing Intelligence | ACTIVE | — | 285 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5109 | Healthy |

## Sovereign Memory

- **Total memories**: 5109 (88 pinned, 5083 embedded — 99.5% coverage)
- **By tier**: episodic=4882, procedural=107, semantic=120
- **By workspace**: (global)=1498, claude-export=3611
- **Notion mirror**: 772 pages, last mirrored 18.22h ago (OK)
- **Latest backup**: 17.22h ago (OK)
...
- **Would-blocks last 7d**: 117
- ⚠ 117 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
