...
| Session State | ACTIVE | Today (2026-07-10 11:19) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 259 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5056 | Healthy |

## Sovereign Memory

- **Total memories**: 5056 (88 pinned, 5054 embedded — 100.0% coverage)
- **By tier**: episodic=4832, procedural=107, semantic=117
- **By workspace**: (global)=1445, claude-export=3611
- **Notion mirror**: 758 pages, last mirrored 31.13h ago (OK)
- **Latest backup**: 6.04h ago (OK)
- **⚠ Flagged for review**: 14 pending — run `python3 execution/memory_review.py list`
...
- **Would-blocks last 7d**: 95
- ⚠ 95 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
2. **REVIEW**: 14 distilled memories awaiting human approval. Run `python3 execution/memory_review.py list`.
```
...
ready=0 watchlist=322 blocked=63 top=maria-wendt-digital-products (watchlist)
```
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-10 (chain_runner finalize for operator-guide-sync) (count: 607)
    • quality_gate.md: 2026-07-10 (chain_runner finalize for operator-guide-sync) (count: 595)
    • session-state-protocol.md: 2026-07-10 (chain_runner session checkpoint) (count: 595)
