...
| Sovereign Memory | ACTIVE | — | 5110 | Healthy |

## Sovereign Memory

- **Total memories**: 5110 (88 pinned, 5083 embedded — 99.5% coverage)
- **By tier**: episodic=4883, procedural=107, semantic=120
- **By workspace**: (global)=1499, claude-export=3611
- **Notion mirror**: 772 pages, last mirrored 18.27h ago (OK)
- **Latest backup**: 17.27h ago (OK)
