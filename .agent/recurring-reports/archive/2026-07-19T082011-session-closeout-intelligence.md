...
| Session State | ACTIVE | Today (2026-07-19 08:11) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 487 | Healthy |
| Gap Log | ACTIVE | — | 3 | Healthy |
| Sovereign Memory | ACTIVE | — | 5318 | Healthy |

## Sovereign Memory

- **Total memories**: 5318 (91 pinned, 5311 embedded — 99.9% coverage)
- **By tier**: episodic=5087, procedural=107, semantic=124
- **By workspace**: (global)=1707, claude-export=3611
- **Notion mirror**: 900 pages, last mirrored 6.33h ago (OK)
- **Latest backup**: 5.33h ago (OK)
...
- **Would-blocks last 7d**: 384
- ⚠ 384 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-19 (chain_runner finalize for oren-dara-ad-psychology) (count: 681)
    • quality_gate.md: 2026-07-19 (chain_runner finalize for oren-dara-ad-psychology) (count: 669)
    • session-state-protocol.md: 2026-07-19 (chain_runner session checkpoint) (count: 669)
...
- Committed local performance entries: 50
