...
| Session State | ACTIVE | Today (2026-07-10 06:57) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 233 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5045 | Healthy |

## Sovereign Memory

- **Total memories**: 5045 (88 pinned, 5045 embedded — 100.0% coverage)
- **By tier**: episodic=4821, procedural=107, semantic=117
- **By workspace**: (global)=1434, claude-export=3611
- **Notion mirror**: 758 pages, last mirrored 5.83h ago (OK)
- **Latest backup**: 4.83h ago (OK)
- **⚠ Flagged for review**: 13 pending — run `python3 execution/memory_review.py list`
...
- **Would-blocks last 7d**: 88
- ⚠ 88 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
2. **REVIEW**: 13 distilled memories awaiting human approval. Run `python3 execution/memory_review.py list`.
```
