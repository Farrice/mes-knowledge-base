...
| Session State | ACTIVE | Today (2026-07-18 20:06) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 447 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5258 | Healthy |

## Sovereign Memory

- **Total memories**: 5258 (91 pinned, 5239 embedded — 99.6% coverage)
- **By tier**: episodic=5027, procedural=107, semantic=124
- **By workspace**: (global)=1647, claude-export=3611
- **Notion mirror**: 874 pages, last mirrored 18.16h ago (OK)
- **Latest backup**: 17.16h ago (OK)
- **⚠ Flagged for review**: 2 pending — run `python3 execution/memory_review.py list`
...
- **Would-blocks last 7d**: 376
- ⚠ 376 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
2. **REVIEW**: 2 distilled memories awaiting human approval. Run `python3 execution/memory_review.py list`.
```
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-18 (chain_runner finalize for claim-safe-health-marketing) (count: 668)
    • quality_gate.md: 2026-07-18 (chain_runner finalize for claim-safe-health-marketing) (count: 656)
    • session-state-protocol.md: 2026-07-18 (chain_runner session checkpoint) (count: 656)
...
- Committed local performance entries: 37
