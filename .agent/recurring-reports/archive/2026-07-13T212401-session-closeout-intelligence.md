...
| Sovereign Memory | ACTIVE | — | 5112 | Healthy |

## Sovereign Memory

- **Total memories**: 5112 (88 pinned, 5083 embedded — 99.4% coverage)
- **By tier**: episodic=4885, procedural=107, semantic=120
- **By workspace**: (global)=1501, claude-export=3611
- **Notion mirror**: 772 pages, last mirrored 19.28h ago (OK)
- **Latest backup**: 18.28h ago (OK)
