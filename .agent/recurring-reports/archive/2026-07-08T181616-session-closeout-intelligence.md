...
| Session State | ACTIVE | Today (2026-07-08 11:26) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 182 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 4995 | Healthy |

## Sovereign Memory

- **Total memories**: 4995 (88 pinned, 4985 embedded — 99.8% coverage)
- **By tier**: episodic=4777, procedural=107, semantic=111
- **By workspace**: (global)=1384, claude-export=3611
- **Notion mirror**: 732 pages, last mirrored 16.27h ago (OK)
- **Latest backup**: 15.27h ago (OK)
- **⚠ Flagged for review**: 11 pending — run `python3 execution/memory_review.py list`
...
- **Would-blocks last 7d**: 129
- ⚠ 129 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
2. **REVIEW**: 11 distilled memories awaiting human approval. Run `python3 execution/memory_review.py list`.
```
...
ready=0 watchlist=322 blocked=64 top=maria-wendt-digital-products (watchlist)
```
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-08 (chain_runner finalize for _active/knowledge/health-performance-ip-library) (count: 588)
    • quality_gate.md: 2026-07-08 (chain_runner finalize for _active/knowledge/health-performance-ip-library) (count: 576)
    • session-state-protocol.md: 2026-07-08 (chain_runner session checkpoint) (count: 576)
