...
| Session State | ACTIVE | Today (2026-07-21 07:23) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 542 | Healthy |
| Gap Log | ACTIVE | — | 3 | Healthy |
| Sovereign Memory | ACTIVE | — | 5385 | Healthy |

## Sovereign Memory

- **Total memories**: 5385 (91 pinned, 5385 embedded — 100.0% coverage)
- **By tier**: episodic=5148, procedural=107, semantic=130
- **By workspace**: (global)=1774, claude-export=3611
- **Notion mirror**: 941 pages, last mirrored 5.74h ago (OK)
- **Latest backup**: 4.75h ago (OK)
...
- **Would-blocks last 7d**: 322
- ⚠ 322 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-21 (chain_runner finalize for ray-amjad-agentic-ladder) (count: 709)
    • quality_gate.md: 2026-07-21 (chain_runner finalize for ray-amjad-agentic-ladder) (count: 697)
    • session-state-protocol.md: 2026-07-21 (chain_runner session checkpoint) (count: 697)
...
- Committed local performance entries: 77
