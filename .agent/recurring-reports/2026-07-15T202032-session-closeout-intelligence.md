...
| Session State | ACTIVE | Today (2026-07-15 11:58) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 351 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5163 | Healthy |

## Sovereign Memory

- **Total memories**: 5163 (88 pinned, 5133 embedded — 99.4% coverage)
- **By tier**: episodic=4935, procedural=107, semantic=121
- **By workspace**: (global)=1552, claude-export=3611
- **Notion mirror**: 796 pages, last mirrored 18.34h ago (OK)
- **Latest backup**: 17.34h ago (OK)
...
- **Would-blocks last 7d**: 141
- ⚠ 141 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-15 (chain_runner finalize for system) (count: 631)
    • quality_gate.md: 2026-07-15 (chain_runner finalize for system) (count: 619)
    • session-state-protocol.md: 2026-07-15 (chain_runner session checkpoint) (count: 619)
...
- Committed local performance entries: 3
