...
| Session State | ACTIVE | Today (2026-07-13 19:46) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 289 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5111 | Healthy |

## Sovereign Memory

- **Total memories**: 5111 (88 pinned, 5083 embedded — 99.5% coverage)
- **By tier**: episodic=4884, procedural=107, semantic=120
- **By workspace**: (global)=1500, claude-export=3611
- **Notion mirror**: 772 pages, last mirrored 19.06h ago (OK)
- **Latest backup**: 18.06h ago (OK)
...
- **Would-blocks last 7d**: 123
- ⚠ 123 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-13 (chain_runner finalize for joey-cinema-os) (count: 610)
    • quality_gate.md: 2026-07-13 (chain_runner finalize for joey-cinema-os) (count: 598)
    • session-state-protocol.md: 2026-07-13 (chain_runner session checkpoint) (count: 598)
