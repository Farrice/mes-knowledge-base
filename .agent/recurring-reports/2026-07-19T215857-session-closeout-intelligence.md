...
| Session State | ACTIVE | Today (2026-07-19 13:00) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 517 | Healthy |
| Gap Log | ACTIVE | — | 3 | Healthy |
| Sovereign Memory | ACTIVE | — | 5359 | Healthy |

## Sovereign Memory

- **Total memories**: 5359 (91 pinned, 5311 embedded — 99.1% coverage)
- **By tier**: episodic=5128, procedural=107, semantic=124
- **By workspace**: (global)=1748, claude-export=3611
- **Notion mirror**: 900 pages, last mirrored 19.98h ago (OK)
- **Latest backup**: 18.98h ago (OK)
...
- **Would-blocks last 7d**: 399
- ⚠ 399 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-19 (chain_runner finalize for jason-fladlien-marketing) (count: 699)
    • quality_gate.md: 2026-07-19 (chain_runner finalize for jason-fladlien-marketing) (count: 687)
    • session-state-protocol.md: 2026-07-19 (chain_runner session checkpoint) (count: 687)
...
- Committed local performance entries: 68
