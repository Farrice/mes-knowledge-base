...
| Routing Intelligence | ACTIVE | — | 574 | Healthy |
| Gap Log | ACTIVE | — | 3 | Healthy |
| Sovereign Memory | ACTIVE | — | 5421 | Healthy |

## Sovereign Memory

- **Total memories**: 5421 (91 pinned, 5385 embedded — 99.3% coverage)
- **By tier**: episodic=5180, procedural=107, semantic=134
- **By workspace**: (global)=1810, claude-export=3611
- **Notion mirror**: 941 pages, last mirrored 16.13h ago (OK)
- **Latest backup**: 15.13h ago (OK)
...
- **Would-blocks last 7d**: 336
- ⚠ 336 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
