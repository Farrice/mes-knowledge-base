...
| Session State | ACTIVE | Today (2026-07-21 09:33) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 553 | Healthy |
| Gap Log | ACTIVE | — | 3 | Healthy |
| Sovereign Memory | ACTIVE | — | 5397 | Healthy |

## Sovereign Memory

- **Total memories**: 5397 (91 pinned, 5385 embedded — 99.8% coverage)
- **By tier**: episodic=5160, procedural=107, semantic=130
- **By workspace**: (global)=1786, claude-export=3611
- **Notion mirror**: 941 pages, last mirrored 11.58h ago (OK)
- **Latest backup**: 10.58h ago (OK)
...
- **Would-blocks last 7d**: 324
- ⚠ 324 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ACTIVE RECENT (3):
    - feedback-ratchet.md: 2026-07-21 (chain_runner finalize for ray-amjad-agentic-ladder) (count: 713)
    - session-state-protocol.md: 2026-07-21 (chain_runner session checkpoint) (count: 701)
    - quality_gate.md: 2026-07-21 (chain_runner finalize for ray-amjad-agentic-ladder) (count: 701)
...
- Committed local performance entries: 81
