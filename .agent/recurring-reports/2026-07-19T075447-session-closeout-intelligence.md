...
| Session State | ACTIVE | Today (2026-07-19 07:54) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 483 | Healthy |
| Gap Log | ACTIVE | — | 3 | Healthy |
| Sovereign Memory | ACTIVE | — | 5313 | Healthy |

## Sovereign Memory

- **Total memories**: 5313 (91 pinned, 5311 embedded — 100.0% coverage)
- **By tier**: episodic=5082, procedural=107, semantic=124
- **By workspace**: (global)=1702, claude-export=3611
- **Notion mirror**: 900 pages, last mirrored 5.91h ago (OK)
- **Latest backup**: 4.91h ago (OK)
- **⚠ Flagged for review**: 4 pending — run `python3 execution/memory_review.py list`
...
- **Would-blocks last 7d**: 382
- ⚠ 382 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
2. **REVIEW**: 4 distilled memories awaiting human approval. Run `python3 execution/memory_review.py list`.
```
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-19 (chain_runner finalize for david-baldacci-books-that-sell) (count: 679)
    • quality_gate.md: 2026-07-19 (chain_runner finalize for david-baldacci-books-that-sell) (count: 667)
    • session-state-protocol.md: 2026-07-19 (chain_runner session checkpoint) (count: 667)
...
- Committed local performance entries: 48
