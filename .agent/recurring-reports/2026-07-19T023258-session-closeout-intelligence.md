...
| Routing Intelligence | ACTIVE | — | 469 | Healthy |
| Gap Log | ACTIVE | — | 3 | Healthy |
| Sovereign Memory | ACTIVE | — | 5278 | Healthy |

## Sovereign Memory

- **Total memories**: 5278 (91 pinned, 5239 embedded — 99.3% coverage)
- **By tier**: episodic=5047, procedural=107, semantic=124
- **By workspace**: (global)=1667, claude-export=3611
- **Notion mirror**: 900 pages, last mirrored 0.55h ago (OK)
- **Latest backup**: 23.55h ago (OK)
