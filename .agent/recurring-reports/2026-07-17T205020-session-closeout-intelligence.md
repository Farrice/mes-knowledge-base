...
| Session State | ACTIVE | Today (2026-07-17 20:19) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 417 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5230 | Healthy |

## Sovereign Memory

- **Total memories**: 5230 (91 pinned, 5213 embedded — 99.7% coverage)
- **By tier**: episodic=4999, procedural=107, semantic=124
- **By workspace**: (global)=1619, claude-export=3611
- **Notion mirror**: 858 pages, last mirrored 18.84h ago (OK)
- **Latest backup**: 17.84h ago (OK)
...
- **Would-blocks last 7d**: 198
- ⚠ 198 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-17 (chain_runner finalize for orchestration-doctrine) (count: 657)
    • quality_gate.md: 2026-07-17 (chain_runner finalize for orchestration-doctrine) (count: 645)
    • session-state-protocol.md: 2026-07-17 (chain_runner session checkpoint) (count: 645)
...
- Committed local performance entries: 29
