...
| Routing Intelligence | ACTIVE | — | 571 | Healthy |
| Gap Log | ACTIVE | — | 3 | Healthy |
| Sovereign Memory | ACTIVE | — | 5420 | Healthy |

## Sovereign Memory

- **Total memories**: 5420 (91 pinned, 5385 embedded — 99.4% coverage)
- **By tier**: episodic=5179, procedural=107, semantic=134
- **By workspace**: (global)=1809, claude-export=3611
- **Notion mirror**: 941 pages, last mirrored 16.05h ago (OK)
- **Latest backup**: 15.05h ago (OK)
...
- **Would-blocks last 7d**: 335
- ⚠ 335 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
