...
| Session State | ACTIVE | Today (2026-07-09 17:57) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 227 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5033 | Healthy |

## Sovereign Memory

- **Total memories**: 5033 (88 pinned, 5021 embedded — 99.8% coverage)
- **By tier**: episodic=4813, procedural=107, semantic=113
- **By workspace**: (global)=1422, claude-export=3611
- **Notion mirror**: 748 pages, last mirrored 16.94h ago (OK)
- **Latest backup**: 15.94h ago (OK)
...
- **Would-blocks last 7d**: 92
- ⚠ 92 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-09 (chain_runner finalize for system-audit) (count: 601)
    • quality_gate.md: 2026-07-09 (chain_runner finalize for system-audit) (count: 589)
    • session-state-protocol.md: 2026-07-09 (chain_runner session checkpoint) (count: 589)
