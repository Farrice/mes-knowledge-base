...
| Session State | ACTIVE | Today (2026-07-13 18:30) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 279 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5105 | Healthy |

## Sovereign Memory

- **Total memories**: 5105 (88 pinned, 5083 embedded — 99.6% coverage)
- **By tier**: episodic=4878, procedural=107, semantic=120
- **By workspace**: (global)=1494, claude-export=3611
- **Notion mirror**: 772 pages, last mirrored 16.42h ago (OK)
- **Latest backup**: 15.42h ago (OK)
...
- **Would-blocks last 7d**: 107
- ⚠ 107 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-13 (chain_runner finalize for system-audit) (count: 609)
    • quality_gate.md: 2026-07-13 (chain_runner finalize for system-audit) (count: 597)
    • session-state-protocol.md: 2026-07-13 (chain_runner session checkpoint) (count: 597)
