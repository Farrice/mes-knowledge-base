...
| Session State | ACTIVE | Today (2026-07-13 22:30) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 297 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5114 | Healthy |

## Sovereign Memory

- **Total memories**: 5114 (88 pinned, 5083 embedded — 99.4% coverage)
- **By tier**: episodic=4887, procedural=107, semantic=120
- **By workspace**: (global)=1503, claude-export=3611
- **Notion mirror**: 772 pages, last mirrored 20.81h ago (OK)
- **Latest backup**: 19.81h ago (OK)
...
- **Would-blocks last 7d**: 143
- ⚠ 143 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
ready=0 watchlist=323 blocked=59 top=maria-wendt-digital-products (watchlist)
```
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-13 (chain_runner finalize for sean-dollwet-kdp-publishing) (count: 611)
    • quality_gate.md: 2026-07-13 (chain_runner finalize for sean-dollwet-kdp-publishing) (count: 599)
    • session-state-protocol.md: 2026-07-13 (chain_runner session checkpoint) (count: 599)
