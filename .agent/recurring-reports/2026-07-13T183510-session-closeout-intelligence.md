...
| Sovereign Memory | ACTIVE | — | 5106 | Healthy |

## Sovereign Memory

- **Total memories**: 5106 (88 pinned, 5083 embedded — 99.5% coverage)
- **By tier**: episodic=4879, procedural=107, semantic=120
- **By workspace**: (global)=1495, claude-export=3611
- **Notion mirror**: 772 pages, last mirrored 16.46h ago (OK)
- **Latest backup**: 15.46h ago (OK)
