...
| Session State | ACTIVE | Today (2026-07-17 08:30) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 396 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5218 | Healthy |

## Sovereign Memory

- **Total memories**: 5218 (91 pinned, 5213 embedded — 99.9% coverage)
- **By tier**: episodic=4987, procedural=107, semantic=124
- **By workspace**: (global)=1607, claude-export=3611
- **Notion mirror**: 858 pages, last mirrored 7.44h ago (OK)
- **Latest backup**: 6.44h ago (OK)
...
- **Would-blocks last 7d**: 152
- ⚠ 152 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-17 (chain_runner finalize for none) (count: 652)
    • quality_gate.md: 2026-07-17 (chain_runner finalize for none) (count: 640)
    • session-state-protocol.md: 2026-07-17 (chain_runner session checkpoint) (count: 640)
...
- Committed local performance entries: 24
