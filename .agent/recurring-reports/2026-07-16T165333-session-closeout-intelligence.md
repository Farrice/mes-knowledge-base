...
| Session State | ACTIVE | Today (2026-07-16 16:01) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 376 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5199 | Healthy |

## Sovereign Memory

- **Total memories**: 5199 (91 pinned, 5165 embedded — 99.3% coverage)
- **By tier**: episodic=4968, procedural=107, semantic=124
- **By workspace**: (global)=1588, claude-export=3611
- **Notion mirror**: 822 pages, last mirrored 14.89h ago (OK)
- **Latest backup**: 13.89h ago (OK)
...
- **Would-blocks last 7d**: 162
- ⚠ 162 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-16 (chain_runner finalize for geoff-woods-ai-thought-partner) (count: 643)
    • quality_gate.md: 2026-07-16 (chain_runner finalize for geoff-woods-ai-thought-partner) (count: 631)
    • session-state-protocol.md: 2026-07-16 (chain_runner session checkpoint) (count: 631)
...
- Committed local performance entries: 15
