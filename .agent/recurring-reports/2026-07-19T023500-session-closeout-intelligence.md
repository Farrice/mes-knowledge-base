...
| Routing Intelligence | ACTIVE | — | 471 | Healthy |
| Gap Log | ACTIVE | — | 3 | Healthy |
| Sovereign Memory | ACTIVE | — | 5282 | Healthy |

## Sovereign Memory

- **Total memories**: 5282 (91 pinned, 5239 embedded — 99.2% coverage)
- **By tier**: episodic=5051, procedural=107, semantic=124
- **By workspace**: (global)=1671, claude-export=3611
- **Notion mirror**: 900 pages, last mirrored 0.58h ago (OK)
- **Latest backup**: 23.58h ago (OK)
