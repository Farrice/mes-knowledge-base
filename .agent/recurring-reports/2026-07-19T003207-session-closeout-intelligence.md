...
| Session State | ACTIVE | Today (2026-07-19 00:26) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 461 | Healthy |
| Gap Log | ACTIVE | — | 3 | Healthy |
| Sovereign Memory | ACTIVE | — | 5274 | Healthy |

## Sovereign Memory

- **Total memories**: 5274 (91 pinned, 5239 embedded — 99.3% coverage)
- **By tier**: episodic=5043, procedural=107, semantic=124
- **By workspace**: (global)=1663, claude-export=3611
- **Notion mirror**: 874 pages, last mirrored 22.53h ago (OK)
- **Latest backup**: 21.53h ago (OK)
...
- **Would-blocks last 7d**: 381
- ⚠ 381 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-19 (chain_runner finalize for creative-campaign-strategy) (count: 675)
    • quality_gate.md: 2026-07-19 (chain_runner finalize for creative-campaign-strategy) (count: 663)
    • session-state-protocol.md: 2026-07-19 (chain_runner session checkpoint) (count: 663)
...
- Committed local performance entries: 44
