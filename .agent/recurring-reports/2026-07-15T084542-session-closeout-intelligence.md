...
| Session State | ACTIVE | Today (2026-07-15 08:42) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 319 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5137 | Healthy |

## Sovereign Memory

- **Total memories**: 5137 (88 pinned, 5133 embedded — 99.9% coverage)
- **By tier**: episodic=4909, procedural=107, semantic=121
- **By workspace**: (global)=1526, claude-export=3611
- **Notion mirror**: 796 pages, last mirrored 6.76h ago (OK)
- **Latest backup**: 5.76h ago (OK)
...
- **Would-blocks last 7d**: 126
- ⚠ 126 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
------------------------------------------------------------
  ...
  ✅ ACTIVE (8):
    • feedback-ratchet.md: 2026-07-15 (chain_runner finalize for jeremy-haynes-cold-offer) (count: 621)
    • quality_gate.md: 2026-07-15 (chain_runner finalize for jeremy-haynes-cold-offer) (count: 609)
    • session-state-protocol.md: 2026-07-15 (chain_runner session checkpoint) (count: 609)
