...
| Routing Intelligence | ACTIVE | — | 448 | Healthy |
| Gap Log | ACTIVE | — | 2 | Healthy |
| Sovereign Memory | ACTIVE | — | 5259 | Healthy |

## Sovereign Memory

- **Total memories**: 5259 (91 pinned, 5239 embedded — 99.6% coverage)
- **By tier**: episodic=5028, procedural=107, semantic=124
- **By workspace**: (global)=1648, claude-export=3611
- **Notion mirror**: 874 pages, last mirrored 19.41h ago (OK)
- **Latest backup**: 18.41h ago (OK)
