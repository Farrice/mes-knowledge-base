...
| Session State | ACTIVE | Today (2026-07-02 22:17) | — | Healthy |
| Routing Intelligence | ACTIVE | — | 39 | Healthy |
| Gap Log | ACTIVE | — | 1 | Healthy |
| Sovereign Memory | ACTIVE | — | 4766 | Healthy |

## Sovereign Memory

- **Total memories**: 4766 (88 pinned, 4656 embedded — 97.7% coverage)
- **By tier**: episodic=4565, procedural=107, semantic=94
- **By workspace**: (global)=1154, claude-export=3612
- **Notion mirror**: 579 pages, last mirrored 20.87h ago (OK)
- **Latest backup**: 19.87h ago (OK)
...
- **Would-blocks last 7d**: 108
- ⚠ 108 unenforced finalize debts this week — revisit the observe-mode decision if this stays high
...
**Generated**: 2026-07-03 05:52 UTC
