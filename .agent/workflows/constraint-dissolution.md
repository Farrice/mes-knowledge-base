---
description: Map the Resonance Hierarchy and dissolve constraints via AWE
---

# constraint-dissolution (Luke Iha — Copy Blocks)
...
3. /Users/farricecain/Google Antigravity/skills/luke-iha-copy-blocks/workflows/constraint-dissolution.md

## PHASE 2: EXECUTION
Follow the workflow in `constraint-dissolution.md`. Honor its Pre-Flight Gate and Quality Gate. User provides the copy/offer/market.
