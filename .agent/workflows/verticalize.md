...
**Goal**: Generate the inheritance contract per the template established by `projects/andrea-dj/CLAUDE.md`, `_active/jen-listings/CLAUDE.md`, and `_active/farrice-brand/CLAUDE.md`.
