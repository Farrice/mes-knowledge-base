...
**Expert**: Luke Iha (Cross-Domain — Unaware Ads + Proof + Strategy)
**Skills**: All 3 Luke Iha skills

### Steps

1. Read the skill files for all three domains:
   - `skills/luke-iha-unaware-ads/genius.md`
   - `skills/luke-iha-unaware-ads/references/genius-patterns.md`
   - `skills/luke-iha-proof-mechanisms/genius.md`
