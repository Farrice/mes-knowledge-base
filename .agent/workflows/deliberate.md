...
The executable runbook for the deliberate skill. Read `skills/deliberate/SKILL.md` for the full philosophy. This workflow is the step-by-step runner.
...
**Discipline:** the "strongest argument against" is non-optional. If you can't articulate one, the deliberation is degraded — you're entering Step 3 with false confidence. Take 30 seconds to find a real counter before producing the take.
