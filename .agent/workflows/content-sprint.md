...
- Voice captures loaded at `_active/linkedin/04-deliverables/content-os/voice-captures/` for tone reference
- ICP context: `_active/linkedin/02-offer/service-architecture.md`
...
2. **ICP pain point cross-reference** — Load:
   - `_active/linkedin/02-offer/service-architecture.md` (ICP profile + pain points)
   - `_active/linkedin/04-deliverables/content-os/mini-briefs/concept-dossier.md` (13 validated concept seeds)

3. **Gap check** — Scan `_active/linkedin/04-deliverables/content-os/arcs/` to avoid repeating recent topics.
...
4. **Reference voice captures** from `_active/linkedin/04-deliverables/content-os/voice-captures/` — match his actual speaking patterns, not a template voice
...
1. Save post to `_active/linkedin/04-deliverables/content-os/arcs/[appropriate-arc]/[post-name].md`
2. Save lead magnet concept to `_active/linkedin/lead-magnets/[name].md`
...
- Current arc files from `_active/linkedin/04-deliverables/content-os/arcs/[current-arc]/`
