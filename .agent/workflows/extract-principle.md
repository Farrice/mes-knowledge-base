...
3. Execute the Principle Extraction Engine with completed breakdown(s)
4. Deliver:
...
5. Quality gate: every principle passes zero-reference test, 3+ score 4+ on all dimensions
