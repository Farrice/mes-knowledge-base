...
- `_active/linkedin-launch/04-content-os/arcs/` (check for active arcs — avoid theme collisions)
...
#### 3. Save Output
Create directory: `_active/linkedin-launch/04-content-os/arcs/[NN]-[arc-slug]/`
Save arc plan to: `_active/linkedin-launch/04-content-os/arcs/[NN]-[arc-slug]/arc-plan.md`
...
- `skills/fresh-voice-system/SKILL.md` (voice DNA)
- The arc plan: `_active/linkedin-launch/04-content-os/arcs/[arc-name]/arc-plan.md`
...
#### 5. Save Output
Save each chapter to: `_active/linkedin-launch/04-content-os/arcs/[arc-name]/ch[NN]-[slug].md`
...
#### 1. Scan Active Arcs
Read `_active/linkedin-launch/04-content-os/arcs/` directory.
