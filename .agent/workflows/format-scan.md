...
3. Execute with user's niche, platform, and stale format complaints
4. Deliver:
...
5. Quality gate: 5+ niches scanned, 10+ formats found, 3+ survive translation, no formats traceable to source
