...
**Full path:** .agent/handoffs/2026-07-26-research-depth-fix.md  
**Date:** 2026-07-26 (today)  
**Status:** ready  
**Title:** Research Depth Fix — Shallow Work Made Physically Impossible + Offer Re-Derivation

> Not auto-loaded. Run `/resume` to choose any thread, or `/resume research-depth-fix` for this one.
