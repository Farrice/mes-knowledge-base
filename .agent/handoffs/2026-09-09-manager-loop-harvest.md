---
thread: manager-loop-harvest
status: mid-build
resume_hint: python3 execution/job_board.py resume manager-loop-harvest
unfinished: T6b, T7
branch: worktree-manager-loop-harvest
pin: false
---

# JOB PACKET — manager-loop-harvest · for codex · generated 2026-09-09T19:56:21-07:00 on codex (branch worktree-manager-loop-harvest)

## Resume
- `python3 execution/job_board.py resume manager-loop-harvest` then follow `skills/nate-b-jones-manager-loop/workflows/manager-loop-run.md`
- end the turn only when `python3 execution/job_board.py next manager-loop-harvest` prints MAY END
...
|---|---|---|---|---|---|---|
| T1 | complete | claude | — | recipe-card-forge | directives/recipe-card-standard.md |  |
| T2 | complete | claude | — | build | execution/job_board.py |  |
| T3 | complete | claude | T2 | build | execution/hooks/steering_loop_hook.py |  |
| T4 | complete | claude | T3 | verify | execution/verify_job_handoff.py |  |
| T5 | complete | claude | — | extract | skills/nate-b-jones-manager-loop/SKILL.md |  |
| T6 | complete | claude | T5 | build | .agent/workflows/job.md |  |
| T6b | active | codex | T2,T6 | build |  |  |
| T7 | planned | claude | T3,T4,T5,T6,T6b | job-closeout |  |  |
runnable: T6b · waiting on deps: T7 · blocked on Farrice: none · done: T1, T2, T3, T4, T5, T6
