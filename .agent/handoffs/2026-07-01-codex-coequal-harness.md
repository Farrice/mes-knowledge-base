...
2. **Control plane restored:** 125 execution scripts + 27 primitives + `CODEX.md` + operator-autopilot agent promoted from `_active/harness/codex-harvest-2026-06-11/` (the 2026-06-11 harvest had only half-installed them).
