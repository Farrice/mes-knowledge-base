...
2. **Post-ready content package** → `_active/linkedin/04-deliverables/content-os/ai-boom-content-package.md`
...
3. **The recipe, documented** → `_active/linkedin/04-deliverables/content-os/CONTENT-QUALITY-BENCHMARK-AND-RECIPE.md`
