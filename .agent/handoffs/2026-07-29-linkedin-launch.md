...
status: active
resume_hint: Linkedin Launch — Campaign
branch: main
pin: true
---
...
- Previous handoff on this thread: `.agent/handoffs/2026-07-28-linkedin-launch.md` — everything it lists as shipped is EXTEND-ONLY.
