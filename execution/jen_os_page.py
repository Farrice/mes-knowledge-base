...
POSTS = [
 ("week-of-2026-09-07", "Week 1 · in Drive 04 · wed the specimen, thu just breathe, sat the code-words post · comps and Bothwell on HOLD", [
   ...
   ("01-attract-what-850k-buys", "attract", "reel · 25.5 s", "SUPERSEDED by week 2's tuesday post (same grammar, sept 9 comps); do not post", "you keep saving the finished ones.", "01-attract-what-850k-buys", ["sunlight-through-window-floor-00","valley-street-01","california-bungalow-00","suburban-neighborhood-aerial-02","front-door-house-00","jen-porch-vannuys"], "a number → saved reply 3 · an address → saved reply 1 · 'same' → her words"),
 ...
 ("week-of-2026-09-14", "Week 2 · the tuesday reel: on-screen line is your pick (hook room round 2); caption and render await your verdict; no Drive folder until then", [
   ("11-broll-which-agent-to-trust", "attract", "reel · 10.5 s · her photos · the line is pair F9 from hook room round 2 (an overheard buyer sentence + her reply); the caption is the Wilmington walk-away, told as our clients", "tue sept 15 · 6:30pm · LINE PASSED 9/11 · CAPTION + RENDER PENDING", "“how do i know which agent to trust?” / trust the one who tells you to walk away from the house you loved.", "11-broll-which-agent-to-trust", ["listing-02-living (hers)","listing-01-exterior (hers)"], "a listing link or address → saved reply 1 (what i'd ask first) · 'how did you know to walk' → 'the inspection told us. i just said it out loud.' · 'same' or a screenshot → 'send it. we can start there.'"),
