...
POSTS = [
 ...
 ("week-of-2026-09-14", "Week 2 · the new tuesday reel awaits your verdict; no Drive folder until then", [
   ("11-broll-kitchens-at-midnight", "attract", "reel · 10.5 s · her photos · take 2, built on Card 1 of the CA-five study (WINNERS #12, the taste callout); absorbs post 01", "tue sept 15 · 6:30pm · TAKE 2 · VERDICT PENDING", "if you keep screenshotting kitchens at midnight… / you’re buying an $850K house in tarzana. i’ll send you the three i’d go see.", "11-broll-kitchens-at-midnight", ["listing-04-kitchen (hers)","listing-01-exterior (hers)"], "a number → saved reply 3, then the three addresses in her DM · an address → saved reply 1 · 'same' or a screenshot → 'send me the number and i'll make the folder real'"),
