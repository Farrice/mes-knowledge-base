...
def main() -> int:
    ...
    results.append(check("skill registration", all(token in skill for token in ('version: "4.1"', "workflows: 27", "/dara-denney-creative-format-intelligence", "creative-format-intelligence.md")), "version, count, route, and reference wired"))
