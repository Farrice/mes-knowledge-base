...
def classify_prose(text: str) -> Dict[str, Any]:
    ...
    if ai_score < 2:
        ...
        for s in signals:
            ...
            elif s["type"] == "mascot_reveal":
                fixes.append("Cut the mascot reveal ('this is really just...', 'I'm no expert but') — commit to the frame")
            elif s["type"] == "town_crier_register":
                fixes.append("Lower the register — whisper the secret, don't shout the billboard")
