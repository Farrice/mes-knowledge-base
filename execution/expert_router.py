...
EXPERTS = {
    ...
    "kobi-brown":       {"domain": "content-strategy", "owns": "educational-virality", "use": "AstroKobi-style educational virality: curiosity, clarity, legitimacy, visual explanation, accuracy restraint, and short-to-long authority loops", "signals": ["educational virality", "education content", "educational content", "educator content", "coach content", "consultant content", "knowledge work content", "scroll-stopping education", "make education entertaining", "edutainment", "true education", "legitimacy ladder", "accuracy without clickbait", "curiosity clarity", "visual explanation", "science communication", "astrokobi", "kobi brown"]},
    ...
    "bitbranding":      {"domain": "design", "owns": "fashion-shopify", "use": "Shopify apparel collection pages, product cards, evidence-led PDP blueprints, duplicated-draft builds, visual review, and rollback", "signals": ["shopify apparel", "shopify fashion", "shopify clothing brand", "shopify product page", "fashion product page", "product page rebuild", "apparel pdp", "fashion pdp", "horizon theme", "product card", "duplicate draft theme", "duplicated draft theme"]},
