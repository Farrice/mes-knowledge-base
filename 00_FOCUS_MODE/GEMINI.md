...
5. **Read** `skills/[skill-name]/references/genius-patterns.md` for expert patterns
...
These 6 protocols govern all work. **Read the full directive when the protocol fires.**
...
| **Token Efficiency** | `directives/token-efficiency-protocol.md` | Every workflow — handoff summaries, invocation cards, push-to-scripts |
...
| Sales/positioning | Jeremy Miner Identity Persuasion, Jason Fladlien High-Status Marketing |
| Identity/mindset work | Michael Bernoff Identity Engineering, Jeremy Haynes Mindset Systems |
| Copywriting | Harry Dry, Cardinal Mason, Mitch Albom, Luke Iha, Jason Fladlien, Ward Farnsworth |
...
## The Virtuoso Density Mandate (Anti-Bloat & Anti-Pattern Lock)
...
**You must actively resist pattern lock.** When given examples or expert rules, extract the *mechanics* and *physics* of why the approach works, but discard the skin. Do not lazily recycle the example's specific scenario or voice unless it perfectly matches the prompt. Demonstrate true creative intuition and taste. The methodology is the floor; your creative application is the ceiling.
