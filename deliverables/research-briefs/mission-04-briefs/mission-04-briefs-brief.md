...
```
python3 execution/handoff_store.py resume 04-briefs
```
   touches: .agent/handoffs/2026-06-30-04-briefs.md
   receipt: The stored handoff prints with drift since it was written.

## how it got here
- 2026-08-06 · **Finalized · briefs** — Readout OS: research-brief system re-skinned to Farrice Cain Premium Minimal (Ink+Steel Blue report dialect), enriched with playbook/assets/timeline/flow/stats/matrix/related section kinds + auto agent context packs + Br
- 2026-08-05 · **Finalized · briefs** — Research-brief system (template+renderer+board shelf+/briefs) + universal scraping expansion (5 Apify actors schema-verified live, $5/run cap) + Monid wired on Claude Code/Codex with cost-gate governance

## swings to
- [HANDOFF] Stored handoff (source of resume) — .agent/handoffs/2026-06-30-04-briefs.md
...
- `.agent/handoffs/2026-06-30-04-briefs.md` — playbook · Resume here
