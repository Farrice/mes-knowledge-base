...
> MISSION · THREAD · window: last 14 days · lens: claude · sources: 1 sessions · 0 files · 0 assets · compiled: aug 19, 2026
...
1. **Decide: resume or park** — No recorded activity in 12 days while the handoff is still active.
...
```
python3 execution/pulse_actions.py done teardown-1-fresh --outcome "<one line>"
```
