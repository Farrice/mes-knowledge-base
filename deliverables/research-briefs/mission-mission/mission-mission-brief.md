...
3. **Decide: resume, park, or kill** — No recorded activity in 16 days while the handoff is still active. Park keeps it resumable and quiet; kill hides it for good (ledger-recoverable).
...
```
python3 execution/handoff_store.py resume mission
```
   touches: .agent/handoffs/2026-07-03-mission.md
...
```
python3 execution/pulse_actions.py park mission --reason "<one line>"
```
...
```
python3 execution/pulse_actions.py kill mission --reason "<one line>"
```
...
BRIEF: /Users/farricecain/Google Antigravity/.claude/worktrees/mailroom/deliverables/research-briefs/mission-mission/mission-mission-brief.md
HANDOFF: /Users/farricecain/Google Antigravity/.claude/worktrees/mailroom/.agent/handoffs/2026-07-03-mission.md
...
## how it got here
- 2026-08-12 · **codex session** — System: Portable Agent Mission - Teardown
...
- **Research and rank an evidence-backed digital-product opportunity map for Farrice's zero-ca** [VERIFIED] — TRIAGE 2026-07-29 (Farrice: execute all): superseded: offer canon locked (missions.jsonl · done)

## swings to
- [HANDOFF] Stored handoff (source of resume) — .agent/handoffs/2026-07-03-mission.md
