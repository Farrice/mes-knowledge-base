...
> MISSION BOARD · ALL THREADS · window: last 14 days · lens: claude · codex · sources: 169 sessions swept · compiled: aug 27, 2026
...
218 more threads cleared the bar but sit below the 12-card ceiling and were not carded: extract virtuoso mastery, deliverables, angle map listening engine v4 1, guides, teardown 1 fresh, global org sweep, god agent offer, readout os, dunford handshake haynes, godin marketing mind, codex parity, novelty campaign.

215 keys were seen but never declared a thread (no live handoff, no open mission, no finalized deliverable) — activity alone does not mint a mission.
