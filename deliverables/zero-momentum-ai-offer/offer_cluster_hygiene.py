...
def main() -> int:
    ...
    checks = [
        ...
        check("proof_disclosure", "new offer without client results or testimonials" in landing and "UNTESTED" in readme, "Market proof is not represented as exact-offer validation."),
        check("no_revenue_guarantee", "No revenue guarantee" in canon and "does not guarantee revenue or sales" in landing, "Offer promise is behavior-bounded."),
