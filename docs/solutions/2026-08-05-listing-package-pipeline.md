...
4. **Register ladder before generation** — tier → register (`_active/jen-listings/CLAUDE.md`): <$1.5M warm FTHB (FTHB-Permission hook mandatory) / ≥$2M Quiet Flex authority-POV (FTHB hook forbidden). Three hook species with fixed roles: authority-POV leads luxury hooks; fact-in-tension mines bodies/cover text; warm anticipation retired as opener.
