...
1. **Audit by evidence on BOTH arms**: for each loop record (a) input signal, (b) where learning lands, (c) proof later behavior changed — file mtimes, log tails, launchd state, git. Verdict COMPOUNDING / OPEN / DEAD. (Full method: `_active/loop-engineering-integration/research/2026-07-24-loop-inventory-audit.md`.)
...
Decision record: `_active/loop-engineering-integration/04-deliverables/LOOP-ENGINEERING-INTEGRATION-BRIEF.md` (12 candidates, all shipped 2026-07-24).
